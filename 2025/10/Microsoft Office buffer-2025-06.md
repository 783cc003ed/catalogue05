...
* https://chrismenardtraining.com/post/outlook-buffer-time

<blockquote>
 OutlookAddbuffertimebetweenappointmentsmeeting
</blockquote>
<blockquote>
Outlook 2016 for O365 users allows you to add buffer time or extra time between appointments/meetings. This allows you to get ready for your next meeting.
</blockquote>
...
<blockquote>
 CleartheOfficecacheOfficeAddinsMicrosoftLearn
</blockquote>
<blockquote>
The Office cache stores resources and data used by Office Add-ins. By accessing stored resources, an add-in's performance is improved as it avoids redownloading these resources when needed. You should clear the Office cache in the following scenarios. When you want to remove an add-in that you've previously sideloaded on Windows, Mac, or iOS.
</blockquote>
...
* https://answers.microsoft.com/en-us/msoffice/forum/all/ms-bookings-incorrectly-showing-buffer-time/7823b69d-5db6-48b5-90ec-f6fac65189cd

<blockquote>
 MSBookingsincorrectlyshowingbuffertimeMicrosoftCommunity
</blockquote>
<blockquote>
When a client books a meeting with me on MS Bookings, the 15 minute buffer time that I've added (in settings) before and after the meeting shows up on the client's calendar (and mine) as meeting time.
</blockquote>
...
* https://techcommunity.microsoft.com/discussions/microsoftbookings/buffer-time-included-in-meeting-time/4045195

<blockquote>
 BuffertimeincludedinmeetingtimeMicrosoftCommunityHub
</blockquote>
<blockquote>
Yes I am creating this event in the Bookings app via MS office web version. It then shows in my outlook desktop app and online app as the extra buffer time included as part of the meeting.
</blockquote>
...
* https://www.middlebury.edu/information-technology-services/news/tech-tip-adding-buffer-time-between-meetings-outlook

<blockquote>
 TechTipAddingBuffertimeBetweenMeetingsinOutlook
</blockquote>
<blockquote>
Middlebury Offices and Services Information Technology Services News Tech Tip: Adding Buffer time Between Meetings in Outlook April 21, 2021 | by Cynthia &quot;Pij&quot; Slater For MiddPoints, For Faculty, For Staff
</blockquote>
...
* https://answers.microsoft.com/en-us/msoffice/forum/all/buffer-time-added-to-meetings-causing-confusion/2c50afa1-7b7f-484a-95ec-d0c470468cfe

<blockquote>
 BuffertimeaddedtomeetingscausingconfusionMicrosoftCommunity
</blockquote>
<blockquote>
Based on your post regarding &quot;Buffer time added to meetings causing confusion&quot;. Unfortunately, Outlook doesn't have a built-in feature to hide buffer times from calendar invites created through Bookings.
</blockquote>
...
* https://answers.microsoft.com/en-us/msoffice/forum/all/microsoft-bookings-how-do-you-add-buffer-time/542f7da3-245a-480f-b6bb-325e159af6a7

<blockquote>
 MicrosoftBookingsHowdoyouaddbuffertimewithoutaffectingthe
</blockquote>
<blockquote>
In Microsoft Bookings, buffer time is designed to be included in the appointment's calendar event. This means the buffer is added to the meeting duration on your calendar.
</blockquote>
...
<blockquote>
We are excited to announce that soon, the Microsoft 365 and Office forum will be available exclusively Microsoft Q&amp;A. This change will help us provide a more streamlined and efficient experience for all your questions and discussions. ... But they are all sub-optimal solutions to what could be a simple software fix at Microsoft where Buffer ...
</blockquote>
...
* https://www.ameeba.com/blog/cve-2025-32717-heap-based-buffer-overflow-in-microsoft-office-word-leading-to-unauthorized-code-execution/
...
* https://securityvulnerability.io/vulnerability/CVE-2025-27752

<blockquote>
 HeapBasedBufferOverflowinMicrosoftOfficeExcel
</blockquote>
<blockquote>
A heap-based buffer overflow vulnerability in Microsoft Office Excel can be exploited by an unauthorized attacker. This issue allows for local code execution, potentially enabling the attacker to take control of affected systems.
</blockquote>
...
* https://zeropath.com/blog/excel-cve-2025-32704-buffer-over-read

<blockquote>
 ExcelUnderSiegeDissectingCVE202532704sBufferOverRead
</blockquote>
<blockquote>
...
<blockquote>
This patch fixes a heap-based buffer overflow vulnerability in Word that can execute code on a computer. Affects: ... for 64-bit and 32-bit systems; Microsoft's details page. Other Office security fixes for June 2025. CVE-2025-47162: Microsoft Office Remote Code Execution Vulnerability: Critical: CVE-2025-47953: Microsoft Office Remote Code ...
</blockquote>
...
<blockquote>
CVE-2025-47162 is a heap-based buffer overflow in Microsoft Office and the CVE-2025-47167 is a &quot;type confusion&quot; vulnerability which is triggered when Microsoft Office interprets a block of memory as the wrong data type. An unauthorized attacker exploits these vulnerabilities and executes arbitrary code on the victim's machine.
</blockquote>
...
<blockquote>
In the Microsoft Edge DevTools window, select the Network tab. Select and hold (or right-click) anywhere in the Requests table. Then, select Clear browser cache. Use the Microsoft Edge developer tools on Windows 10. To clear the Office cache on Windows 10 when the add-in is running in Microsoft Edge, use the Microsoft Edge DevTools.
</blockquote>
...
<blockquote>
 DeleteyourOfficeDocumentCacheMicrosoftSupport
</blockquote>
<blockquote>
To open the Office Upload Center, do one of the following, depending on your version of Windows: In Windows 10, click the Windows button, type Microsoft Upload Center in the Search box, and then double-click the Microsoft Upload Center app in the search results (it may say 2010 or 2013, depending on your Office version).. In Windows 11: Click the Start button, type Microsoft Upload Center in ...
</blockquote>
...
* https://www.thewindowsclub.com/how-to-clear-office-word-excel-powerpoint-cache

<blockquote>
 HowtoclearOfficeWordExcelPowerPointcacheTheWindowsClub
</blockquote>
<blockquote>
Open Word, Excel, or PowerPoint. Click on the File menu. Click on the Options. Switch to the Trust Center tab. Click on the Trust Center Settings button. Go to the Trusted Add-in Catalogs tab ...
</blockquote>
...
<blockquote>
Buffer over-read in Microsoft Office Excel allows an unauthorized attacker to execute code locally. Published 2025-05-13 17:16:03 Updated 2025-05-19 18:30:17 Source Microsoft Corporation. View at NVD, CVE.org. Vulnerability category: Execute code. Products affected by CVE-2025-32704.
</blockquote>
...
* https://securityvulnerability.io/vulnerability/CVE-2025-47162

<blockquote>
 HeapBasedBufferOverflowinMicrosoftOfficebyMicrosoft
</blockquote>
<blockquote>
A vulnerability exists in Microsoft Office that presents a heap-based buffer overflow issue, which can be exploited by unauthorized attackers to execute arbitrary code locally. This security weakness could potentially allow an attacker to compromise affected systems by leveraging the flaw, making it crucial for users to ensure their Office ...
</blockquote>
...
<blockquote>
CVE-2023-38545 is a heap buffer overflow vulnerability affecting Microsoft Office applications. The vulnerability arises from curl 8.4.0's implementation within Microsoft Office. If exploited, this vulnerability can allow unauthorized access and control of systems.
</blockquote>
...
<blockquote>
CVE-2025-29979 : Heap-based buffer overflow in Microsoft Office Excel allows an unauthorized attacker to execute code locally. ... A heap overflow condition is a buffer overflow, where the buffer that can be overwritten is allocated in the heap portion of memory, generally meaning that the buffer was allocated using a routine such as malloc(). ...
</blockquote>
...
<blockquote>
Heap-based buffer overflow in Microsoft Office that allows an unauthorized attacker to execute code locally. Impact. An attacker could potentially exploit this vulnerability to execute arbitrary code on the targeted system with the same privileges as the current user. The local attack vector requires user interaction, meaning a victim would ...
</blockquote>
...
<blockquote>
Among Microsoft's June security bug fixes there are some that directly affect Microsoft Office users. These three caught our eye. Two are rated as High risk w June brings important Office security fixes. ... This patch fixes a heap-based buffer overflow vulnerability in Word that can execute code on a computer. Affects:
</blockquote>
...
<blockquote>
 TroubleshootOfficeScriptsOfficeScriptsMicrosoftLearn
</blockquote>
<blockquote>
Help resources Stack Overflow is a community of developers willing to help with coding problems. Often, you'll be able to find the solution to your problem through a quick Stack Overflow search. If not, ask your question and tag it with the &quot;office-scripts&quot; tag. Be sure to mention you're creating an Office Script, not an Office Add-in.
</blockquote>
...
<blockquote>
The recent disclosure of CVE-2025-30376—a heap-based buffer overflow vulnerability within Microsoft Office Excel—underscores the critical need for vigilance in both users and system administrators.
</blockquote>
...
* https://answers.microsoft.com/en-us/msoffice/forum/all/buffer-overflow-in-ms-word/106094b2-3702-45ba-9ddd-04204c51cba0

<blockquote>
 BufferOverflowinMSWordMicrosoftCommunity
</blockquote>
<blockquote>
Buffer Overflow in MS Word MS Office 2000 Word will not open. My security sotware closes it down after a second or two. The subsequent pop up cites, &quot;Prevented buffer overflow&quot;. Security advises it is a fault in MS Word. Have found nothing in MS fixes. What next?
</blockquote>
...
<blockquote>
Top 10 Riskiest Microsoft Office Vulnerabilities Based on the current exploit probability, these Microsoft Office vulnerabilities are on CISA's Known Exploited vulnerabilities list (KEV) and are ranked by the current EPSS exploit probability.
</blockquote>
...
<blockquote>
CVE-2025-32704 : Buffer over-read in Microsoft Office Excel allows an unauthorized attacker to execute code locally.
</blockquote>
...
* https://windowsforum.com/threads/critical-cve-2025-47162-vulnerability-in-microsoft-office-protect-your-systems-now.369768/

<blockquote>
 CriticalCVE202547162VulnerabilityinMicrosoftOfficeProtectYour
</blockquote>
<blockquote>
...
<blockquote>
June brings important Office security fixes. Learn about critical vulnerabilities and how they impact Microsoft Office applications.
</blockquote>
...
<blockquote>
 CVE202547162HeapBasedBufferOverflowinMicrosoftOfficeby
</blockquote>
<blockquote>
Discover how a heap-based buffer overflow in Microsoft Office can allow unauthorized code execution. Learn more about CVE-2025-47162.
</blockquote>
...
<blockquote>
This security update resolves a Microsoft Excel remote code execution vulnerability. To learn more about the vulnerability, see Microsoft Common Vulnerabilities and Exposures CVE-2025-47165.
</blockquote>
...
* https://www.ameeba.com/blog/cve-2025-47162-high-risk-buffer-overflow-vulnerability-in-microsoft-office/

<blockquote>
 CVE202547162HighRiskBufferOverflowVulnerabilityinMicrosoftOffice
</blockquote>
<blockquote>
...
<blockquote>
MS Office 2000 Word will not open. My security sotware closes it down after a second or two. The subsequent pop up cites, &quot;Prevented buffer overflow&quot;. Security advises it is a fault in MS Word. Have
</blockquote>
...
* https://answers.microsoft.com/en-us/msoffice/forum/all/copy-buffer/3b314c78-fa78-4211-96b3-4f0efe4a27eb

<blockquote>
 CopybufferMicrosoftCommunity
</blockquote>
<blockquote>
Author of &quot;OOXML Hacking - Unlocking Microsoft Office's Secrets&quot;, ebook now out John Korchok, Production Manager production@brandwares.com. ... Even if I clear the empty the buffer then I could also be preventing some other copy and paste operation that a user might be doing.
</blockquote>
...
* https://answers.microsoft.com/en-us/msoffice/forum/all/word-is-buffering/7fc1ec11-4a89-4b83-b342-1e87b9c1d4d9

<blockquote>
 WordisbufferingMicrosoftCommunity
</blockquote>
<blockquote>
Word is CONSTANTLY &quot;buffering&quot;. It contains a large number of buffers, and it fills and empties them many times a second while it is running.
</blockquote>
...
<blockquote>
Heap-based buffer overflow in Microsoft Office Word... High severity Unreviewed Published 3 days ago to the GitHub Advisory Database • Updated 3 days ago
</blockquote>
...
* https://securityvulnerability.io/vulnerability/CVE-2025-30376

<blockquote>
 HeapbasedBufferOverflowinMicrosoftOfficeExcelbyMicrosoft
</blockquote>
<blockquote>
Learn about a heap-based buffer overflow in Microsoft Office Excel that allows local code execution. Details on CVE-2025-30376.
</blockquote>
...
* https://answers.microsoft.com/en-us/msoffice/forum/all/excelbuffer-overflow-fix/3636f2b9-2ca4-4028-8dec-028fec7e306c

<blockquote>
 ExcelBufferOverflowFixMicrosoftCommunity
</blockquote>
<blockquote>
Excel suddenly began kicking me out when I start entering a formula into a cell...McAfee message appears about buffer_overflow. What is the fix?
</blockquote>
...
* https://windowsforum.com/threads/cve-2025-26642-major-microsoft-office-vulnerability-exposes-local-code-execution-risks.360000/

<blockquote>
 CVE202526642MajorMicrosoftOfficeVulnerabilityExposesLocalCode
</blockquote>
<blockquote>
Buffer Allocation: Microsoft Office allocates a specific buffer in memory to hold incoming data from documents. Faulty Read Operation: ... CVE-2025-26642 is an out-of-bounds read vulnerability in Microsoft Office, with the potential to allow unauthorized local code execution.
</blockquote>
...
<blockquote>
Microsoft Office contains a buffer overflow vulnerability which allows remote attackers to execute code via crafted PNG data in an Office document. CVE-2013-1331 Exploit Probability: 86.6%: June 8, 2022: Microsoft Office Uninitialized Memory Use Vulnerability: Microsoft Office allows remote attackers to execute arbitrary code via a crafted ...
</blockquote>
...
<blockquote>
A heap-based buffer overflow vulnerability in Microsoft Office Excel can be exploited by an unauthorized attacker. This issue allows for local code execution, potentially enabling the attacker to take control of affected systems. Users are advised to apply the latest security updates to mitigate the risk associated with this vulnerability.
</blockquote>
...
<blockquote>
Vulnerability Details : CVE-2025-32717 Heap-based buffer overflow in Microsoft Office Word allows an unauthorized attacker to execute code locally. Published 2025-06-10 23:15:25
</blockquote>
...
<blockquote>
If I set my meeting time for 30 minutes and my buffer time for 30 minutes at the beginning and end, once the session is booked it appears to be 1.5 hours long in my calendar. The knock-on effect of this, is the Bookings tool sees this as an 1.5 hour appointment in my calendar so then adds ANOTHER 30 minutes buffer either side of the appointment.
</blockquote>
...
* https://answers.microsoft.com/en-us/msoffice/forum/all/booking-with-me-buffer-issue/bd0229e9-7909-4d36-9a30-2c39d7c15179

<blockquote>
 BookingwithmebufferissueMicrosoftCommunity
</blockquote>
<blockquote>
Hi there, I'm using the 'Bookings with me' feature in O365 to set up 20-minute appointments without any buffer time. However, when I try to create these appointments, it automatically adds a 5-minute buffer before the meeting, even though I've set the buffer time to 0 minutes.
</blockquote>
...
* https://answers.microsoft.com/en-us/outlook_com/forum/all/is-there-a-way-in-outlook-to-automatically-add/9cd469dd-f1fc-4f3f-9423-99da1e5b25a4

<blockquote>
 IsthereawayinOutlooktoautomaticallyaddbuffertimebeforeor
</blockquote>
<blockquote>
Good day! Thank you for posting in the Microsoft Community. We will be happy to help you. Yes, Outlook offers a feature to automatically add buffer time before or after meetings to help prevent back-to-back bookings. This can be done by shortening the duration of your meetings. Here's how you can set it up For Outlook Desktop Client:
</blockquote>
...
<blockquote>
The persistent discovery of buffer overflow vulnerabilities in Office applications—despite decades of cumulative security research—highlights the ongoing challenge of balancing feature-rich software with robust safety. ... Microsoft Excel's buffer overflow vulnerability stands as both a warning and a call to action—underscoring the ...
</blockquote>
...
<blockquote>
Heap-based buffer overflow in Microsoft Office allows an unauthorized attacker to execute code locally. Metrics CVSS Version 4.0 CVSS Version 3.x CVSS Version 2.0 NVD enrichment efforts reference publicly available information to associate vector strings. ... Heap-based Buffer Overflow: Microsoft Corporation ...
</blockquote>
...
<blockquote>
Microsoft Office contains a heap-based buffer overflow flaw that could allow an unauthenticated attacker to achieve remote code execution. CVE-2025-47953 &amp; CVE-2025-47164: Microsoft Office Remote Code Execution Vulnerability. Microsoft Office contains a use-after-free flaw that could allow an unauthenticated attacker to achieve remote code ...
</blockquote>
...
<blockquote>
The recent disclosure of CVE-2025-30376—a heap-based buffer overflow vulnerability within Microsoft Office Excel—underscores the critical need for vigilance in both users and system administrators. ... The persistent discovery of buffer overflow vulnerabilities in Office applications—despite decades of cumulative security research ...
</blockquote>
...
<blockquote>
The vulnerabilities CVE-2025-47164 and CVE-2025-47953 are &quot;use after free&quot; (UAF) vulnerabilities that occur when Microsoft Office tries to access memory that has already been freed. CVE-2025-47162 is a heap-based buffer overflow in Microsoft Office and the CVE-2025-47167 is a &quot;type confusion&quot; vulnerability which is triggered when Microsoft ...
</blockquote>
...
<blockquote>
 ManagingOfficedocumentcachesizeMicrosoftSupport
</blockquote>
<blockquote>
You can configure Group policies to delete files from the Office Document Cache on document close. This means you may see artifacts in the OfficeFileCache folder created for an open document, which will then be deleted once the document is closed. Office ADMX references: HKCU\software\policies\microsoft\office\16.0\common\fileio ...
</blockquote>
...
<blockquote>
Firstly, we suggest you update your Office applications to the latest version 16.23 (190309) (as you mentioned Office 365 Home in your category), because Word version you're using is far behind the latest update. After updating your Office applications, check whether the issue you provided in description is resolved or not.
</blockquote>
...
* https://www.ameeba.com/blog/cve-2025-32704-buffer-over-read-vulnerability-in-microsoft-office-excel/

<blockquote>
 CVE202532704BufferOverreadVulnerabilityinMicrosoftOffice
</blockquote>
<blockquote>
Overview The vulnerability CVE-2025-32704 is a critical issue that affects Microsoft Office Excel, a widely used spreadsheet program. This security flaw, classified as a buffer over-read vulnerability, can potentially allow an unauthorized attacker to execute arbitrary code on the victim's system. As such, the severity and potential impact of this vulnerability cannot be overstated.
</blockquote>
...
<blockquote>
A heap-based buffer overflow vulnerability in Microsoft Office Word allows unauthorized attackers to execute arbitrary code on affected systems. By crafting a malicious document file, an attacker could exploit this vulnerability, potentially leading to full system compromise.
</blockquote>
...
<blockquote>
Heap-based buffer overflow in Microsoft Office Excel allows an unauthorized attacker to execute code locally. Metrics CVSS Version 4.0 CVSS Version 3.x CVSS Version 2.0 NVD enrichment efforts reference publicly available information to associate vector strings. ... Heap-based Buffer Overflow: Microsoft Corporation ...
</blockquote>
...
<blockquote>
A problem with McAfee, try an Office repair. Restart the PC, once fully loaded, repair Office,&gt; Apps &amp; Features&gt;Select Office your version&gt;Modify/Repair, once the repair completes re-test If still no joy, hold the ctrl key when starting Excel/The doc to force safe mode and see if the problem is replicated, if its now ok, see McAfee support to see if they have any updates, as its their program ...
</blockquote>
...
<blockquote>
Heap-based buffer overflow in Microsoft Office allows an unauthorized attacker to execute code locally. Published 2025-06-10 17:02:24 Updated 2025-06-12 16:06:39 Source Microsoft Corporation. View at NVD, CVE.org. Vulnerability category: Overflow Execute code.
</blockquote>
...
<blockquote>
Using Windows 10 and Microsoft Office 365, in Excel in a blank spreadsheet typing any operator such as &#61;, +, etc followed by any alpha character crashes excel and causes a McAfee &quot;Intrusion Blocked&quot; alert indicating Buffer_Overflow.
</blockquote>
...
<blockquote>
Learn about a heap-based buffer overflow in Microsoft Office Excel that allows local code execution. Details on CVE-2025-30376. ... A vulnerability exists in Microsoft Office Excel that allows an unauthorized attacker to exploit a heap-based buffer overflow. This weakness permits the attacker to execute arbitrary code on the affected system ...
</blockquote>
...
<blockquote>
Heap-based buffer overflow vulnerability in Microsoft Office Word that allows an unauthorized attacker to execute arbitrary code locally through maliciously crafted RTF files. The vulnerability can be triggered via Preview Pane rendering without requiring user interaction.
</blockquote>
...
<blockquote>
Buffer over-read in Microsoft Office Excel allows an unauthorized attacker to execute code locally. Published 2025-05-13 17:16:03 Updated 2025-05-19 18:30:17
</blockquote>
...
* https://securityvulnerability.io/vulnerability/CVE-2025-24057

<blockquote>
 HeapbasedBufferOverflowinMicrosoftOfficeAffectsUsers
</blockquote>
<blockquote>
A heap-based buffer overflow vulnerability in Microsoft Office could allow an unauthorized attacker to execute arbitrary code on the targeted system. This type of vulnerability typically arises when the application improperly handles memory allocation, allowing the attacker to manipulate program execution flow.
</blockquote>
...
<blockquote>
A critical vulnerability, identified as CVE-2025-47162, has been discovered in Microsoft Office, posing significant security risks to users worldwide. This flaw is a heap-based buffer overflow that allows unauthorized attackers to execute arbitrary code on affected systems.
</blockquote>
...
* https://www.avesnetsec.com/vulnerabilities/cve-2025-27752

<blockquote>
 CVE202527752VulnerabilityReportforMicrosoftOffice2019
</blockquote>
<blockquote>
CVE-2025-27752 is a critical vulnerability associated with Microsoft Office 2019, specifically characterized by a heap-based buffer overflow. This type of flaw occurs when a program writes more data to a buffer located on the heap than it can hold, potentially leading to arbitrary code execution and significant security risks.
</blockquote>
...
<blockquote>
A freshly disclosed vulnerability in Microsoft Office has caught the attention of the cybersecurity community. Tagged CVE-2025-24057, this issue arises from a heap-based buffer overflow—a classic memory management blunder—that could allow an unauthorized attacker to execute code locally on an affected system.
</blockquote>
...
<blockquote>
And the most important take-away…Changing this setting doesn't &quot;make it so.&quot; As the meeting scheduler it's up to you to wrap up your session in less time!. Interested in giving this a try? Here's how:
</blockquote>
...
* https://www.microsoft.com/en-us/microsoft-365/blog/2017/03/20/new-reasons-to-make-microsoft-bookings-the-go-to-scheduling-software-for-your-business/

<blockquote>
 NewreasonstomakeMicrosoftBookingsthegotoschedulingsoftware
</blockquote>
<blockquote>
Add your Office 365 calendar to Bookings—Connect your Office 365 calendar to Bookings, so that the times you are busy will automatically be blocked in your public Booking page. Add buffer time before and after your appointments—Do you need prep time before or after an appointment? Adding buffer time to a service automatically blocks that ...
</blockquote>
...
<blockquote>
Each meeting has a buffer time of 15 minutes prior and 15 minutes after. Once booked, this shows a 75 minute block for a 45 minute meeting. When clicking on the event, it correctly displays that the meeting time is 45 minutes and the buffer time is 15 minutes either side but it is very confusing as it looks like the meeting starts when the ...
</blockquote>
...
<blockquote>
Thank you for posting to the Microsoft Community. We are glad to assist. Based on your post regarding &quot;Buffer time added to meetings causing confusion&quot;.Unfortunately, Outlook doesn't have a built-in feature to hide buffer times from calendar invites created through Bookings. However, Please try the following:
</blockquote>
...
<blockquote>
 bufferBekijkallebestsellers
</blockquote>
<blockquote>
Profiteer van aanbiedingen van buffer op Amazon. Mobiele telefoons verkrijgbaar bij Amazon. Bestel eenvoudig en snel online.
</blockquote>
...
* https://support.microsoft.com/en-us/office/make-all-your-events-shorter-automatically-8fa0fdcb-5eee-4e12-9452-8d59ee33f70a

<blockquote>
 MakeallyoureventsshorterautomaticallyMicrosoftSupport
</blockquote>
<blockquote>
In classic Outlook, select File &gt; Options &gt; Calendar &gt; Calendar options. Check the Shorten appointments and meetings checkbox and in the dropdown box choose End early or Start late .
</blockquote>
...
<blockquote>
Now it books the entire buffer and meeting time as one big meeting so the client thinks they now have 1.5 hours with me instead of 30 minutes with a buffer of 30 minutes on either side of the meeting. Problematic because it changed fundamentally how the bookings work with buffer times.
</blockquote>

---

# GitHub search -> Microsoft Office buffer
# TOP
