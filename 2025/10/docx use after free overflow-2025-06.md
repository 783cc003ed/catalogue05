...
* https://cycookery.com/article/can-i-bake-2-cake-mixes-in-a-9x13-pan

<blockquote>
 BakingTwoCakeMixesInOnePanIsItPossibleCyCookery
</blockquote>
<blockquote>
...
<blockquote>
 ThetoddlersintroductiontoHeapexploitationUseAfterFree
</blockquote>
<blockquote>
The Use-After-Free vulnerability class, leverages a behaviour of ptmalloc's allocator according to which, malloc will return the address of the first chunk that matches a memory requirement.
</blockquote>
...
* https://stackoverflow.com/questions/1677850/use-after-free-error

<blockquote>
 cUseafterfreeerrorStackOverflow
</blockquote>
<blockquote>
Use after free error? Asked 15 years, 7 months ago Modified 1 year, 4 months ago Viewed 11k times
</blockquote>
...
* https://zhuanlan.zhihu.com/p/1917678683046548562

<blockquote>
 鸿蒙50APP性能优化实战使用Asan检测内存错误知乎
</blockquote>
<blockquote>
开启ASan检测后，触发demo中的函数，应用闪退报ASan，显示reason为AddressSanitizer:heap-use-after-free 定位思路 如果有工程代码，直接开启ASan检测，debug模式运行后复现该错误，可以触发ASan，直接点击堆栈中的超链接定位到代码行，能看到错误代码的位置。
</blockquote>
...
* https://cvefeed.io/vuln/detail/CVE-2025-27748

<blockquote>
 CVE202527748MicrosoftOfficeUseAfterFreeBufferOverflow
</blockquote>
<blockquote>
...
* https://windowsforum.com/threads/cve-2025-24079-understanding-microsoft-words-use-after-free-vulnerability.356240/

<blockquote>
 CVE202524079UnderstandingMicrosoftWordsUseAfterFree
</blockquote>
<blockquote>
CVE-2025-24079—an exploit rooted in a use-after-free flaw—underscores the critical need for vigilant patch management and robust system defenses among Windows users. Understanding the Vulnerability What Is a Use-After-Free Vulnerability?
</blockquote>
...
* https://joelwisdom.github.io/vuln-manual/uaf.html

<blockquote>
 UseAfterFreeUAFVulnManual
</blockquote>
<blockquote>
This unintended access occurs after the memory has been marked as available for reuse, leading to potential security risks and unpredictable behaviour. This vulnerability arises from improper memory management practices. When a program allocates memory using functions like malloc or calloc, it gains exclusive use of that memory block.
</blockquote>
...
<blockquote>
Base level weaknesses typically describe issues in terms of 2 or 3 of the following dimensions: behavior, property, technology, language, and resource. 120 Buffer Copy without Checking Size of Input ('Classic Buffer Overflow') CanPrecede
</blockquote>
...
* https://github.com/topics/use-after-free

<blockquote>
 useafterfreeGitHubTopicsGitHub
</blockquote>
<blockquote>
...
* https://stackoverflow.com/questions/60743686/python-created-word-files-are-set-to-read-only-when-opened-through-win-explorer

<blockquote>
 PythoncreatedWordfilesaresettoreadonlywhenStackOverflow
</blockquote>
<blockquote>
To save you some future frustration, you should know that you're not really creating a .docx file the right way. The file specification is more complicated than simply writing out with the &quot;w&quot; option. To create a new empty Word file with docx (after installing the python-docx library, and importing docx), use doc &#61; docx.Document().
</blockquote>
...
* https://1library.net/article/use-after-free-bugs-and-vulnerabilities.qovjopmz

<blockquote>
 UseAfterFreeBugsandVulnerabilities1Library
</blockquote>
<blockquote>
Use-After-Free - Bugs and VulnerabilitiesDue to the popularity of buffer overflow exploits, awareness for this bug has increased and researchers proposed many effective mitigation techniques, which we introduce in Chap- ter 2.3. Due to these steps, the security community has noticed a decrease in buffer overflow exploits. Instead, attackers now often target use-after-free vulnerabilities ...
</blockquote>
...
* https://nordvpn.com/cybersecurity/glossary/use-after-free/

<blockquote>
 UseafterfreedefinitionGlossaryNordVPN
</blockquote>
<blockquote>
Attackers commonly exploit use-after-free vulnerabilities to compromise systems and execute malicious code. See also: bootkit, BIOS rootkit, buffer overflow attack. Use-after-free examples. Double free: When a program attempts to free a memory block that has already been freed, it can cause memory corruption, leading to unpredictable behavior.
</blockquote>
...
<blockquote>
memory-safety hardening buffer-overflow use-after-free binary-hardening. Updated Jun 10, 2025; C; mar-ket-vector / VXpp. Star 16. Code ... Add a description, image, and links to the use-after-free topic page so that developers can more easily learn about it. Curate this topic Add this topic to your repo ...
</blockquote>
...
<blockquote>
buffer-overflow-attack stack-overflow rop-exploitation control-flow-integrity format-string-attack global-offset-table use-after-free heap-overflow double-free-bug procedure-linkage-table ebp-overwrite partial-overwrite ... To associate your repository with the use-after-free topic, visit your repo's landing page and select &quot;manage topics ...
</blockquote>
...
<blockquote>
In 2013, use-after-free exploits ac- counted for almost 50% of exploited Microsoft CVEs, while only about 25% were buffer overflows [10]. Underlying Problem. In essence, a use-after-free vulnerability is caused by a programming bug where an object that has been freed at time t is accessed after t.
</blockquote>
...
<blockquote>
To create a new empty Word file with docx (after installing the python-docx library, and importing docx), use doc &#61; docx.Document(). Then use doc.save(&lt;new file path&gt;) to write the file. python-docx obviously isn't the only library that will write a .docx file, it's just the one that I used the one time I needed to write a Word file.
</blockquote>
...
* https://securityonline.info/chrome-update-alert-two-high-severity-flaws-cve-2025-6191-cve-2025-6192-patched/

<blockquote>
 ChromeUpdateAlertTwoHighSeverityFlawsCVE20256191CVE2025
</blockquote>
<blockquote>
A use-after-free vulnerability occurs when a program continues to use a memory location after it has already been freed. In Chrome, such issues can result in memory corruption or exploitable crashes, potentially allowing an attacker to execute malicious code in the browser's context.
</blockquote>
...
<blockquote>
 WhatisUseAfterFreeVulnerabilityAutomox
</blockquote>
<blockquote>
Impact of use after free vulnerability Bad actors have been known to employ a wide range of UAF impact scenarios. The list below is far from exhaustive but provides a range of typical techniques reported recently for UAF-based vulnerabilities in large software applications. Causing memory overflow issues and crashes
</blockquote>

---

# GitHub search -> docx use after free overflow
# MortenSchenkb
