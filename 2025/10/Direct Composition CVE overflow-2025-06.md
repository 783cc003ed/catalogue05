## DuckDuckgo search -> Direct Composition CVE overflow
`2025-06-23`
...
<blockquote>
CVE 2019 1065 This is a vulnerability in DirectComposition, which is a user-mode graphics component but is managed by win32kbase; so commands are sent to win32kbase.sys through syscalls and then delegated to user-mode dwm.exe through ALPC.
</blockquote>
...
* https://medium.com/@muhammedgalal66/analyzing-cve-2024-38063-examples-of-overflow-vulnerabilities-in-32-bit-os-08bf1888d136

<blockquote>
 AnalyzingCVE202438063ExamplesofOverflowMedium
</blockquote>
<blockquote>
Let's Go While I was checking the CVE released for Windows, which is CVE-2024-38063, I found in its weakness a very simple code that causes an overflow on 32-bit Windows operating systems.
</blockquote>
...
<blockquote>
Explore this analysis and functional proof of concept of CVE-2024-30051, which allows an unprivileged attacker to execute code as a DWM user with Integrity System privileges.
</blockquote>
...
<blockquote>
 ApublicsecretResearchontheCVE202430051privilegeescalation
</blockquote>
<blockquote>
A public secret : Research on the CVE-2024-30051 privilege escalation vulnerability in the wild 2024-09-05 By 红雨滴团队 | 漏洞通告 Overview CVE-2024-30051 vulnerability was first discovered by Kaspersky, but what Kaspersky discovered initially was not a wild sample, but a simple analysis report of the vulnerability that was uploaded ...
</blockquote>
...
<blockquote>
While I was checking the CVE released for Windows, which is CVE-2024-38063, I found in its weakness a very simple code that causes an overflow on 32-bit Windows operating systems. So, I brought ...
</blockquote>
...
<blockquote>
A presentation on finding vulnerabilities in DirectComposition was given by @360Vulcan at CanSecWest 2017 - Win32k Dark Composition [PDF]. DirectComposition can be accessed via win32k system calls that begin with NtDComposition. Before Windows 10 RS1, the caller makes a separate system call for each action, such as creating or releasing a ...
</blockquote>
...
<blockquote>
Contribute to fortra/CVE-2024-30051 development by creating an account on GitHub. ... This example proves that there is a heap overflow. It's copying more bytes than allocated, and the size is controllable. ... Hunting Windows Desktop Window Manager Bugs&quot; and dove into the world of Direct Composition. This helped me to create my first PoC.
</blockquote>
...
<blockquote>
Explore this analysis and functional proof of concept of CVE-2024-30051, ... This example proves that there is a heap overflow. It's copying more bytes than allocated, and the size is controllable. ... Hunting Windows Desktop Window Manager Bugs to dive into the world of Direct Composition. This helped me to create my first PoC.
</blockquote>
...
<blockquote>
However, the call of dcomp.dll to dwm is not direct, but cross-kernel. The process is simply user-&gt;dcomp.dll-&gt;win32kbase (kernel)-&gt;dwm.exe (user layer). ... which will cause a memory overflow of 8f length. Allocate memory of size 0x1b0 . Due to the previous spray operation, the allocated space of 0x1b0 will be directly allocated to the hole in ...
</blockquote>
...
<blockquote>
Stack Overflow for Teams Where developers &amp; technologists share private knowledge with coworkers; ... Using direct composition I was able to apply the blur effect, ... c++; windows-10; directx; win32gui; direct-composition; trickymind. 897; asked Jan 14, 2021 at 6:42. 3 votes. 1 answer.
</blockquote>

---

# GitHub search -> Direct Composition CVE overflow
# MortenSchenkb
