...
* https://www.vicarius.io/research-center/vulnerability/cve-2018-14010-id222337

<blockquote>
 CVE201814010Vicarius
</blockquote>
<blockquote>
...
* https://nvd.nist.gov/vuln/detail/CVE-2023-26315

<blockquote>
 Cve202326315Nvd
</blockquote>
<blockquote>
The Xiaomi router AX9000 has a post-authentication command injection vulnerability. This vulnerability is caused by the lack of input filtering, allowing an attacker to exploit it to obtain root access to the device. ... Improper Neutralization of Special Elements used in an OS Command ('OS Command Injection') Xiaomi Technology Co., Ltd. ...
</blockquote>
...
<blockquote>
In the IPS tab, click Protections and find the Xiaomi Miwifi Command Injection (CVE-2018-16130) protection using the Search tool and Edit the protection's settings.
</blockquote>
...
<blockquote>
A vulnerability classified as critical was found in Xiaomi Router (Router Operating System) (version now known). Affected by this vulnerability is some unknown processing of the component External Interface. The manipulation with an unknown input leads to a command injection vulnerability. The CWE definition for the vulnerability is CWE-77.
</blockquote>
...
* https://cyber.vumetric.com/vulns/CVE-2023-26317/command-injection-vulnerability-in-mi-xiaomi-router-firmware/

<blockquote>
 CVE202326317CommandInjectionvulnerabilityinMIXiaomiRouter
</blockquote>
<blockquote>
...
* https://vuldb.com/?id.121476

<blockquote>
 XiaomiR3PR3CR3DJSONDatacgibinlucioscommandinjectionVulDB
</blockquote>
<blockquote>
A vulnerability, which was classified as critical, was found in Xiaomi R3P, R3C and R3D (unknown version). Affected is an unknown code block of the file /cgi-bin/luci of the component JSON Data Handler. The manipulation with an unknown input leads to a os command injection vulnerability. CWE is classifying the issue as CWE-78. The product ...
</blockquote>
...
<blockquote>
A command injection vulnerability exists in Miwifi OS. Successful exploitation of this vulnerability could allow a remote attacker to execute arbitrary commands on the affected system. ... In the IPS tab, click Protections and find the Xiaomi Miwifi Command Injection (CVE-2018-16130) protection using the Search tool and Edit the protection's ...
</blockquote>
...
<blockquote>
 CVE201814010XiaomiRouterCommandInjectionVulnerability
</blockquote>
<blockquote>
OS command injection in the guest Wi-Fi settings feature in /cgi-bin/luci on Xiaomi R3P before 2.14.5, R3C before 2.12.15, R3 before 2.22.15, and R3D before 2.26.4 devices allows an attacker to execute any command via crafted JSON data. ... Xiaomi Router Command Injection Vulnerability. Overview Public Exploits Vulnerability Timeline ...
</blockquote>
...
* https://www.clouddefense.ai/cve/2018/CVE-2018-14010

<blockquote>
 CVE201814010XiaomiR3SeriesOSCommandInjectionVulnerability
</blockquote>
<blockquote>
Learn about CVE-2018-14010, a critical OS command injection flaw in Xiaomi R3 series routers, allowing attackers to execute unauthorized commands. ... The OS command injection vulnerability poses a significant risk as it enables threat actors to execute malicious commands on affected devices, potentially leading to unauthorized access or control.
</blockquote>
...
<blockquote>
OS command injection in the guest Wi-Fi settings feature in /cgi-bin/luci on Xiaomi R3P before 2.14.5, R3C before 2.12.15, R3 before 2.22.15, and R3D before 2.26.4 devices allows an attacker to execute any command via crafted JSON data. ... Improper Neutralization of Special Elements used in an OS Command ('OS Command Injection')
</blockquote>
...
<blockquote>
 ShowMiTheVulnsExploitingCommandInjectioninMiRouter3
</blockquote>
<blockquote>
How we hacked Xiaomi's popular router with weird tricks. ... In most cases where the router passed untrusted input to the shell, the developers did take steps to prevent command injection attacks — but mistakes were made every now and then. Command Injection in wifi_access Functionality (CVE-2018-13023) ...
</blockquote>
...
* https://devhub.checkmarx.com/cve-details/cve-2018-14010/

<blockquote>
 ImproperNeutralizationofSpecialElementsusedinanOSCommandOS
</blockquote>
<blockquote>
OS command injection in the guest Wi-Fi settings feature in /cgi-bin/luci on Xiaomi R3P before 2.14.5, R3C before 2.12.15, R3 before 2.22.15, and R3D before 2.26.4 devices allows an attacker to execute any command via crafted JSON data.
</blockquote>
...
* https://cve.imfht.com/detail/CVE-2023-26315

<blockquote>
 Xiaomirouterhasacommandinjectionvulnerabilityafterauthorization
</blockquote>
<blockquote>
Xiaomi router has a command injection vulnerability after authorization漏洞 The Xiaomi router AX9000 has a post-authentication command injection vulnerability. This vulnerability is caused by the lack of input filtering, allowing an attacker to exploit it to obtain root access to the device.; ... OS命令中使用的特殊元素转义处理 ...
</blockquote>
...
<blockquote>
The Xiaomi router AX9000 has a post-authentication command injection vulnerability. This vulnerability is caused by the lack of input filtering, allowing an attacker to exploit it to obtain root access to the device. ... OS Command Injection OS Command Injection CAPEC-108: Command Line Execution ...
</blockquote>
...
<blockquote>
As promised in our last article on the Mi Router 3, this blog post will cover the nuances of exploiting two command injection vulnerabilities ISE Labs discovered in the device. These flaws, present in two separate locations of the web app, both allow code execution as root by any attacker authenticated with the web interface. In most cases where the router passed untrusted input to the shell ...
</blockquote>
...
<blockquote>
 CVE201814010OScommandinjectionintheguestWiFisettings
</blockquote>
<blockquote>
OS command injection in the guest Wi-Fi settings feature in /cgi-bin/luci on Xiaomi R3P before 2.14.5, R3C before 2.12.15, R3 before 2.22.15, and R3D before 2.26.4 devices allows an attacker to execute any command via crafted JSON data.
</blockquote>
...
<blockquote>
A vulnerability, which was classified as critical, was found in Xiaomi Router (Router Operating System) (version now known). This affects some unknown processing. The manipulation with an unknown input leads to a command injection vulnerability. CWE is classifying the issue as CWE-77.
</blockquote>
...
<blockquote>
Learn about CVE-2018-14010, a critical OS command injection flaw in Xiaomi R3 series routers, allowing attackers to execute unauthorized commands. Find mitigation steps and firmware updates here.
</blockquote>
...
* https://www.northit.co.uk/cve/2018/14060

<blockquote>
 OSCommandInjectioninXiaomiR3DAPModeSettings
</blockquote>
<blockquote>
...
<blockquote>
 CVE202326317Xiaomiroutershaveanexternalinterfacethatcan
</blockquote>
<blockquote>
Xiaomi routers have an external interface that can lead to command injection. The vulnerability is caused by lax filtering of responses from external interfaces. Attackers can exploit this vulnerability to gain access to the router by hijacking the ISP or upper-layer routing.
</blockquote>
...
* https://github.com/advisories/GHSA-7rfw-27hp-w56j

<blockquote>
 OScommandinjectionintheAPmodesettingsfeatureinGitHub
</blockquote>
<blockquote>
...
# GitHub search -> Xiaomi OS Command injection
# KEV
