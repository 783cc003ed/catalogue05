...
<blockquote>
Tenda GoAhead Embedded Web Server Exploit - Auth Bypass - DK27ss/Tenda-GoAhead-Embedded-Web-Server-Exploit-PoC
</blockquote>
...
<blockquote>
Let's now take a closer look at the Python POC code. The code has a &quot;-p&quot; switch that can be passed as a command line argument. This switch executes the authorization bypass and allows us to obtain the password against the target router's configuration file. ... Tenda N300 Authentication Bypass via Malformed HTTP Request Header. CVE: CVE ...
</blockquote>
...
<blockquote>
On Tenda AC1200 (Model AC6) 15.03.06.51_multi devices, admin, support, user, and nobody have a password of 1234. ... (Multiple Authentication Bypass) Overview Public Exploits Vulnerability Timeline ... CVE-2020-28093 has a 1 public PoC/Exploit available at Github.
</blockquote>
...
* https://github.com/DK27ss/Tenda-GoAhead-Embedded-Web-Server-Exploit-PoC/issues

<blockquote>
 DK27ssTendaGoAheadEmbeddedWebServerExploitPoCGitHub
</blockquote>
<blockquote>
Tenda GoAhead Embedded Web Server Exploit - Auth Bypass - Issues · DK27ss/Tenda-GoAhead-Embedded-Web-Server-Exploit-PoC
</blockquote>
...
<blockquote>
my cve list. Contribute to 21Gun5/my_cve development by creating an account on GitHub.
</blockquote>
...
* https://kb.cert.org/vuls/api/304455/

<blockquote>
 CERTVulnerabilityNotesDatabase
</blockquote>
<blockquote>
The attacker can construct a web request that includes a white-listed keyword in the path, causing the URL to be served directly (rather than blocked or challenged with an authentication prompt).\r\n\r\n&#35;&#35;&#35; Impact\r\nSuccessful exploitation of this vulnerability could grant the attacker access to pages that would otherwise require authentication.
</blockquote>
...
* https://cvefeed.io/vuln/detail/CVE-2021-44971

<blockquote>
 CVE202144971TendaAuthenticationBypassVulnerability
</blockquote>
<blockquote>
...
<blockquote>
 TendaW18ESecurityResearchreddassolutionscom
</blockquote>
<blockquote>
Proposed CVE: initAdminUser Authentication Bypass (CWE-306, CWE-287) An unauthorized actor with access to the web management portal can bypass authentication entirely. The first two curl commands are to show that the device doesn't simply remember my IP and have me logged in already; the third is the exploit, and the fourth shows that the ...
</blockquote>
...
# GitHub search -> Tenda poc Auth Bypass
