...
* https://www.cve.news/cve-2023-36762/

<blockquote>
 CVE202336762UnpackingtheMicrosoftWordRemoteCodeExecution
</blockquote>
<blockquote>
...
<blockquote>
 Injectremotetemplatelinkintoworddocumentforremotetemplate
</blockquote>
<blockquote>
...
* https://systemweakness.com/thm-follina-msdt-8ebd708ff3a5

<blockquote>
 THMFollinaMSDTAwalkthroughontheCVE202230190Medium
</blockquote>
<blockquote>
Task 1: Introduction. Microsoft explains that &quot;a remote code execution vulnerability exists when MSDT is called using the URL protocol from a calling application such as Word. An attacker who successfully exploits this vulnerability can run arbitrary code with the privileges of the calling application.
</blockquote>

---

## DuckDuckgo search -> docx Remote Code Execution overflow
`2025-06-26`

* https://www.zerodayinitiative.com/advisories/ZDI-20-1131/

<blockquote>
 ZDI201131ZeroDayInitiative
</blockquote>
<blockquote>
...
* https://thecyberpost.com/tools/exploits-cve/microsoft-office-word-mshtml-remote-code-execution/

<blockquote>
 MicrosoftOfficeWordMSHTMLRemoteCodeExecution
</blockquote>
<blockquote>
Authored by LockedByte, Ramella Sebastien, thesunRider, klezVirus | Site metasploit.com This Metasploit module creates a malicious docx file that when opened in Word on a vulnerable Windows system will lead to code execution. This vulnerability exists because an attacker can craft a malicious ActiveX control to be used by a Microsoft Office document that hosts the browser rendering engine ...
</blockquote>
...
* https://www.zerodayinitiative.com/advisories/ZDI-23-384/

<blockquote>
 ZDI23384ZeroDayInitiative
</blockquote>
<blockquote>
Microsoft Office Word DOCX File Parsing Out-Of-Bounds Write Remote Code Execution Vulnerability ZDI-23-384 ZDI-CAN-20574. CVE ID: CVE-2023-28311: ... VULNERABILITY DETAILS: This vulnerability allows remote attackers to execute arbitrary code on affected installations of Microsoft Office Word. User interaction is required to exploit this ...
</blockquote>
...
* https://www.infosecinstitute.com/resources/vulnerabilities/follina-microsoft-office-code-execution-vulnerability/

<blockquote>
 FollinaMicrosoftOfficecodeexecutionvulnerability
</blockquote>
<blockquote>
Microsoft tracked as CVE-2022-30190 a new vulnerability, also called &quot;Follina,&quot; that leverages Microsoft Office to lure victims and execute code without their consent. As mentioned by Microsoft, &quot;a remote code execution vulnerability exists when MSDT is called using the URL protocol from a calling application such as Word.&quot; The first campaign in the wild taking advantage of this ...
</blockquote>
...
<blockquote>
On July 11, 2023, Microsoft released a patch aimed at addressing multiple actively exploited Remote Code Execution (RCE) vulnerabilities. This action also shed light on a phishing campaign orchestrated by a threat actor known as Storm-0978, specifically targeting organizations in Europe and North America.
</blockquote>
...
<blockquote>
Microsoft Excel LTSC 2024 - Remote Code Execution (RCE) ... Microsoft Excel LTSC 2024 has a critical vulnerability allowing remote code execution via malicious DOCX files. Show more. 5 of 5 AI Insights are available for you today. Leverage the power of AI to quickly understand vulnerabilities, impacts, and exploitability. Get AI Insights.
</blockquote>
...
* https://gbhackers.com/hackers-exploit-weaponized-word-docs/

<blockquote>
 HackersExploitWeaponizedWordDocstoStealWindowsLoginCredentials
</blockquote>
<blockquote>
This remote code execution flaw allows attackers to execute harmful code on the victim's system, ultimately deploying a new variant of the FormBook information-stealing malware. ... extracted to the %temp% folder, while another exploits CVE-2017-11882 via crafted equation data, triggering a buffer overflow in EQNEDT32.EXE. ... order0087.docx ...
</blockquote>
...
<blockquote>
CVE-2024-43639: Remote Code Execution in Microsoft Windows KDC Proxy March 04, 2025 | Trend Micro Research Team . SUBSCRIBE. In ... An integer overflow has been reported for Microsoft Windows KDC Proxy. The vulnerability is due to a missing check for the length of Kerberos responses.
</blockquote>
...
<blockquote>
 CVE202430104HowMicrosoftOfficeRemoteCodeExecutionWorksWith
</blockquote>
<blockquote>
CVE-2024-30104 is a Remote Code Execution (RCE) vulnerability in several Microsoft Office products, including Word and Excel. Remote code execution means an attacker can make your computer run commands of their choice, if you open a malicious file. ... from docx import Document &#35; Save the macro to a vbaProject.bin (in real scenarios, done via ...
</blockquote>
...
* https://learn.microsoft.com/en-us/security-updates/SecurityBulletins/2014/ms14-023

<blockquote>
 MicrosoftSecurityBulletinMS14023Important
</blockquote>
<blockquote>
A remote code execution vulnerability exists in the way that affected Microsoft Office software handles the loading of dynamic-link library (.dll) files. An attacker who successfully exploited this vulnerability could take complete control of an affected system. ... (such as a .docx file). The file sharing protocol, Server Message Block (SMB ...
</blockquote>
...
<blockquote>
In June 2025, Microsoft published an important security advisory about a Remote Code Execution (RCE) flaw in Microsoft Office, tracked as CVE-2025-21365. ... Here's a rough (and simplified) representation of what might be inside a malicious .docx document (using oletools to inspect): $ olevba malicious.docx VBA MACRO ThisDocument.cls ...
</blockquote>
...
<blockquote>
Microsoft Excel LTSC 2024 - Remote Code Execution (RCE) EDB-ID: 52337 ... The attacker can trick any user into opening and executing their code by sending a malicious DOCX file via email or a streaming server. After the execution of the victim, his machine can be infected or even worse than ever; this could be the end of his Windows machine! ...
</blockquote>
...
* https://msrc-ppe.microsoft.com/update-guide/vulnerability/CVE-2025-24078
...
<blockquote>
CVE-2023-36884 was a remote code execution vulnerability, and CVE-2023-36584 was a security bypass vulnerability that can be used to exploit CVE-2023-36884. CVE-2023-36884 was given a severity rating of 8.8 (High), and CVE-2023-36584's severity rating was 5.4 (Medium). ... An MS-DOCX file is a compressed ZIP archive file that consists of an ...
</blockquote>
...
<blockquote>
CVE-2023-21716 - Microsoft Word Remote Code Execution Vulnerability. March 9, 2023. by Mansi B. Microsoft Word is a popular word-processing program used by millions of people worldwide. Unfortunately, it is also a popular target for attackers due to its wide usage. ...
</blockquote>
...
<blockquote>
Microsoft Word DOCX File Parsing Heap-based Buffer Overflow Remote Code Execution Vulnerability ZDI-20-1131 ZDI-CAN-11242. CVE ID: CVE-2020-1338: ... Crafted data in a DOCX file can trigger an overflow of a heap-based buffer. An attacker can leverage this vulnerability to execute code in the context of the current process.
</blockquote>
...
* https://cybersecurityupdate.net/advisories/zdi-23-384-microsoft-office-word-docx-file-parsing-out-of-bounds-write-remote-code-execution-vulnerability/

<blockquote>
 ZDI23384MicrosoftOfficeWordDOCXFileCyberSecurityNews
</blockquote>
<blockquote>
ZDI-23-384: Microsoft Office Word DOCX File Parsing Out-Of-Bounds Write Remote Code Execution Vulnerability. Advisories. ZDI-23-384: Microsoft Office Word DOCX File Parsing Out-Of-Bounds Write Remote Code Execution Vulnerability . April 11, 2023. Read Time: 12 Second ...
</blockquote>
...
<blockquote>
What is CVE-2024-49065? CVE-2024-49065 is a remote code execution (RCE) vulnerability in Microsoft Office. Simply put, if someone tricks a user into opening a specially-crafted Office document (like a Word or Excel file), the attacker can run their own code as if they were sitting at the victim's computer.
</blockquote>
...
<blockquote>
It contains a bunch of other ways to execute code via MS Protocol in Word, using templates, which still work now. March 10th 2021 — researchers report to Microsoft how to use Microsoft Office URIs to execute code using Microsoft Teams as an example.
</blockquote>
...
<blockquote>
A new attack chain campaign has been discovered, which involves the exploitation of CVE-2023-36884 and CVE-2023-36584. CVE-2023-36884 was a remote code execution vulnerability, and CVE-2023-36584 was a security bypass vulnerability that can be used to exploit CVE-2023-36884. CVE-2023-36884 was given a severity rating of 8.8 (High), and CVE-2023-36584's severity rating was 5.4 (Medium ...
</blockquote>
...
<blockquote>
The What: In this post, I want to talk about and show off a code execution method which was shown to me a little while back. This method allows one to create a DOCX document which will load up and allow a user to execute macros using a remote DOTM template file.
</blockquote>
...
<blockquote>
What is CVE-2022-30190? In late May 2022, the cybersecurity landscape buzzed with the discovery of CVE-2022-30190, also known as &quot;Follina:&quot; a Remote Code Execution (RCE) vulnerability found within the Microsoft Windows Support Diagnostic Tool (MSDT).
</blockquote>
...
<blockquote>
Remote Template Injection Microsoft Word has a feature where a user can create a document with a template. Whenever a Word document with a template is being written/read, this templates are being downloaded/used from the local, or remote machine. Thus, the attackers can host a Word Document Template file (.dotm) with malicious macros on their ...
</blockquote>
...
<blockquote>
 LivingofftheLandTheMechanicsofRemoteTemplateInjectionAttack
</blockquote>
<blockquote>
By crafting a DOCX file that loads a remote DOTM template containing malicious macros, attackers can achieve code execution while potentially evading security controls.
</blockquote>
...
* https://www.cve.news/cve-2025-27831/

<blockquote>
 CVE202527831GhostscriptDOCXWRITETXTWRITEBufferOverflowDeepDive
</blockquote>
<blockquote>
If Ghostscript processes a crafted file (e.g., a text, PDF, or DOCX), an attacker can overflow the buffer and possibly achieve remote code execution. Realistically, the attacker needs the following
</blockquote>
...
<blockquote>
This vulnerability allows remote attackers to execute arbitrary code on affected installations of Microsoft Office Word. User interaction is required to exploit this vulnerability in that the target must visit a malicious page or open a malicious file. Read More
</blockquote>
...
<blockquote>
CVE-2025-47162 involves a heap-based buffer overflow caused by improper bounds checking in Office's file parsing routines (CWE-122). Exploitation can occur simply by previewing a malicious document, without user interaction, allowing attackers to overwrite memory and gain control over system execution.
</blockquote>
...
<blockquote>
January 15th, 2025 Microsoft Office Word DOCX File Parsing Uninitialized Pointer Remote Code Execution Vulnerability ZDI-25-030 ZDI-CAN-25187
</blockquote>
...
* https://windowsforum.com/threads/cve-2024-43576-microsoft-office-remote-code-execution-risk-explained.343547/

<blockquote>
 CVE202443576MicrosoftOfficeRemoteCodeExecutionRiskExplained
</blockquote>
<blockquote>
...
* https://windowsforum.com/threads/microsoft-word-cve-2025-47168-critical-use-after-free-rce-vulnerability-and-security-best-practices.369797/
...
<blockquote>
Microsoft Word 16.72.23040900 - Remote Code Execution (RCE). CVE-2023-28311 . remote exploit for Multiple platform
</blockquote>
...
<blockquote>
There is a Metasploit module for Follina. The source code for it can be found on Packet Storm. This Metasploit module crafts a Microsoft Word document that, once loaded, leverages the remote template feature. By fetching an HTML document, it utilizes the ms-msdt scheme to carry out PowerShell code execution.
</blockquote>
...
<blockquote>
 FollinaMSDTTryHackMeWalkthroughbyHasankaAmarasingheMedium
</blockquote>
<blockquote>
Task 1 Introduction. Microsoft explains that &quot;a remote code execution vulnerability exists when MSDT is called using the URL protocol from a calling application such as Word. An attacker who successfully exploits this vulnerability can run arbitrary code with the privileges of the calling application.
</blockquote>
...
<blockquote>
 MicrosoftWindowsSupportDiagnosticToolMSDTRemoteCodeExecution
</blockquote>
<blockquote>
This remote code execution vulnerability (CVE-2022-30190) exists when MSDT is called using the URL protocol from a calling application such as Word. An attacker who successfully exploits this flaw can execute arbitrary code with the calling application's privileges. ... MS Office docx files may contain external OLE Object references as HTML ...
</blockquote>
...
<blockquote>
Understanding CVE-2024-43576: A Microsoft Office Remote Code Execution Vulnerability ... Attack Vector: This vulnerability typically arises when a user opens a specially crafted document (like .docx, .xls) in an affected version of Office. The document could be delivered via email, shared through cloud storage, or hosted on a malicious website. ...
</blockquote>
...
<blockquote>
 MicrosoftWordRTFRemoteCodeExecutionWindowsremoteExploit
</blockquote>
<blockquote>
Microsoft Word - '.RTF' Remote Code Execution. CVE-2017-0199 . remote exploit for Windows platform
</blockquote>
...
* https://secalerts.co/vulnerability/CVE-2025-47169

<blockquote>
 CVE202547169MicrosoftWordRemoteCodeExecutionVulnerability
</blockquote>
<blockquote>
CVE-2025-47169 is a heap-based buffer overflow vulnerability affecting Microsoft Word that allows for remote code execution. Which Microsoft products are affected by CVE-2025-47169? CVE-2025-47169 affects various versions of Microsoft Office, including Word 2016, Microsoft 365 Apps for Enterprise, and Office LTSC 2024.
</blockquote>
...
<blockquote>
If Ghostscript processes a crafted file (e.g., a text, PDF, or DOCX), an attacker can overflow the buffer and possibly achieve remote code execution. Realistically, the attacker needs the following - The victim must process untrusted files with DOCXWRITE or TXTWRITE ...
</blockquote>
...
<blockquote>
CVE-2023-21716 - Microsoft Word Remote Code Execution Vulnerability. March 9, 2023. by Mansi B. ... This can lead to a buffer overflow condition, which an attacker can then exploit to execute arbitrary code on the victim's computer. Impact of CVE-2023-21716.
</blockquote>
...
<blockquote>
CVE-2025-47957: Microsoft Word Remote Code Execution Vulnerability Description CVE-2025-47957 is a critical &quot;use after free&quot; vulnerability in Microsoft Office Word. It allows an unauthorized attacker to execute code locally on the affected machine.
</blockquote>
...
<blockquote>
PoC exploit code has been shared publicly and on cybercrime forums for a vulnerability tracked as CVE-2023-21716 in Microsoft Word's RTF parser. The Publicly available PoC stops short of launching the Calculator app and theoretically demonstrates remote code execution, but will require modification to make the code fully functional.
</blockquote>
...
<blockquote>
Summary This security update resolves a Microsoft Word remote code execution vulnerability. To learn more about the vulnerability, see Microsoft Common Vulnerabilities and Exposures CVE-2023-21716.
</blockquote>
...
<blockquote>
This metric reflects the context by which vulnerability exploitation is possible. The Base Score increases the more remote (logically, and physically) an attacker can be in order to exploit the vulnerable component. The vulnerable component is not bound to the network stack and the attacker's path is via read/write/execute capabilities.
</blockquote>
...
<blockquote>
Proof of Concept for CVE-2023-21716 a newly discovered Microsoft Word vulnerability that can allow attackers to execute unauthorized code.
</blockquote>
...
<blockquote>
April 11th, 2023 Microsoft Office Word DOCX File Parsing Out-Of-Bounds Write Remote Code Execution Vulnerability ZDI-23-384 ZDI-CAN-20574
</blockquote>
...
<blockquote>
Description CVE-2025-47957 is a critical &quot;use after free&quot; vulnerability in Microsoft Office Word. It allows an unauthorized attacker to execute code locally on the affected machine. The flaw arises when Microsoft Word mistakenly continues to reference memory after it has been released (&quot;freed&quot;).
</blockquote>
...
<blockquote>
CVE-2024-49065 is a remote code execution (RCE) vulnerability in Microsoft Office. Simply put, if someone tricks a user into opening a specially-crafted Office document (like a Word or Excel file), the attacker can run their own code as if they were sitting at the victim's computer. ... Attacker crafts a malicious Office file (usually a DOCX ...
</blockquote>
...
<blockquote>
CVE-2024-30104 is a Remote Code Execution (RCE) vulnerability in several Microsoft Office products, including Word and Excel. Remote code execution means an attacker can make your computer run commands of their choice, if you open a malicious file. ... For example: from docx import Document &#35; Save the macro to a vbaProject.bin (in real ...
</blockquote>
...
<blockquote>
 InjectMacrosfromaRemoteDotmTemplateRedTeamNotes
</blockquote>
<blockquote>
Code Execution Code &amp; Process Injection. Defense Evasion ... Inject Macros from a Remote Dotm Template. This lab shows how it is possible to add a macros payload to a docx file indirectly, which has a good chance of evading some AVs/EDRs. This technique works in the following way:
</blockquote>
...
<blockquote>
DOCX File. Now, create another new document, and select a default template. I used a resume template, but the type of the template does not matter. Save the file as .docx file. Find the settings.xml.rels. cd &lt;document_path&gt; mv &lt;name&gt;.docx &lt;name&gt;.zip expand-archive ./&lt;name&gt;.zip. Depending on the version of the Microsoft Word, the location might ...
</blockquote>
