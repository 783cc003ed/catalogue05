...
<blockquote>
The attacker can trick any user into opening and executing their code by sending a malicious DOCX file via email or a streaming server. After the execution of the victim, his machine can be infected or even worse than ever; this could be the end of his Windows machine!
</blockquote>
...
<blockquote>
CVE-2023-36884 specific recommendations Customers who use Microsoft Defender for Office 365 are protected from attachments that attempt to exploit CVE-2023-36884. In current attack chains, the use of the Block all Office applications from creating child processes attack surface reduction rule prevents the vulnerability from being exploited
</blockquote>
...
<blockquote>
Gamaredon Group has used DOCX files to download malicious DOT document templates and has used RTF template injection to download malicious payloads. ... Monitor and analyze traffic patterns and packet inspection associated to protocol(s) that do not follow the expected protocol standards and traffic flows (e.g extraneous packets that do not ...
</blockquote>
...
* https://www.cloudsek.com/threatintelligence/microsoft-office-zero-day-cve-2023-36884-exploited-in-the-wild

<blockquote>
 MicrosoftOfficeZeroDayCVE202336884ExploitedintheWild
</blockquote>
<blockquote>
...
<blockquote>
 ICT519VulnerabilitydocxCVE202221882Microsoft
</blockquote>
<blockquote>
Search for a PoC exploit for CVE-2022-21882 on platforms like GitHub or a security research site. For example, you might find PoC scripts that demonstrate how to exploit the HTTP Protocol Stack vulnerability.
</blockquote>
...
<blockquote>
Method 2: If you have not deployed any of the mitigations for Follina, opening the Word docx (or previewing it in the Preview Pane) will trigger Word into exploiting the CVE-2022-30190 bug.
</blockquote>
...
<blockquote>
An attacker must request the conversion of the crafted file from DOCT into DOCX format. Using the chain of two other bugs related to improper string handling, an attacker can achieve remote code execution on DocumentServer. ... CVE Dictionary Entry: CVE-2021-25830 NVD Published Date: 03/01/2021 NVD Last Modified: 11/21/2024 Source: MITRE ...
</blockquote>
...
<blockquote>
 CVE202140444MSOfficeZeroDayVulnerabilitySentinelOne
</blockquote>
<blockquote>
Explore CVE-2021-40444, a zero-day vulnerability in Microsoft Office. Learn about its impact, exploitation methods, and mitigation strategies. ... Looking at the .docx document relationships: ... allows the attackers to retrieve encapsulated payload files and avoid using traditional file downloads over the HTTP protocol.
</blockquote>
...
<blockquote>
Notably, two prominent objects are observed within the DOCX files, namely an OLE1 object and a CFB object, both utilized to exploit the &quot;URLMoniker&quot; link process. ‍ OOXML File Structure: - OOXML files, such as DOCX, are inherently structured as ZIP archives, providing a convenient means of packaging and storing various components of the document.
</blockquote>
...
<blockquote>
A new attack chain campaign has been discovered which involves the exploitation of CVE-2023-36884 and CVE-2023-36584. CVE-2023-36884. ... An MS-DOCX file is a compressed ZIP archive file that consists of an XML file at word/document.xml and consists of the document's text and formatting. ... This technique was possible due to the SMB2 ...
</blockquote>
...
<blockquote>
The inetcomm.dll module was responsible for handling requests to this protocol. The HTTP* Protocols in URLProtocolView. Unlike MHTML however, the HTTP protocol is handled by the urlmon.dll module. When I was researching past exploits involving the MHTML protocol, I came across an interesting article all the way back from 2011 about CVE-2011 ...
</blockquote>
...
<blockquote>
 InDepthAnalysisofJuly2023ExploitChainFeaturingCVE202336884
</blockquote>
<blockquote>
To understand how CVE-2023-36884 was exploited by this specific lure, we should first understand Microsoft Word's implementation of the Open XML file format, in this case for MS-DOCX (.docx) files. An MS-DOCX file is a compressed ZIP archive containing multiple specification files used to display the Word document.
</blockquote>
...
<blockquote>
The core of CVE-2022-30190 lies in a flaw within Microsoft's Diagnostic Troubleshooting executable, msdt.exe, specifically in how MSDT processes malformed URIs, typically characterized by an unusual length and ending with '!'. ... This approach allows the attacker to bypass established security protocols like Office's Protected Mode and macro ...
</blockquote>
...
<blockquote>
The DEV-0413 campaign that used CVE-2021-40444 has been smaller and more targeted than other malware campaigns we have identified leveraging DEV-0365 infrastructure. ... Trojan_DOCX_OLEAnomaly_A ... (.cpl) via URL protocol handler path traversal as used in the original attack and public proof of concepts at time of publishing ...
</blockquote>

---

# GitHub search -> docx CVE Protocol
# sqlmap
