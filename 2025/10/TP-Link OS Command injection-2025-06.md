...
* https://jvn.jp/en/vu/JVNVU91401812/index.html

<blockquote>
 JVNVU91401812MultipleTPLinkproductsvulnerabletoOScommand
</blockquote>
<blockquote>
Overview Multiple products provided by TP-LINK contain OS command injection vulnerabilities.
</blockquote>
...
* https://www.sonicwall.com/blog/tp-link-archer-command-injection-vulernability

<blockquote>
 TPLinkArcherCommandInjectionVulnerabilitySonicWall
</blockquote>
<blockquote>
TP-Link Archer AX21 Command Injection | CVE-2023-1389 TP-Link Archer AX21 (AX1800) firmware versions before 1.1.4 contain a command injection vulnerability in the web management interface. The issue resides in the country form of the /cgi-bin/luci;stok&#61;/locale endpoint on the web management interface. Due to inadequate sanitization of the ...
</blockquote>
...
<blockquote>
 TPLinkDistrelecSchweizMehrals75JahreErfahrung
</blockquote>
<blockquote>
Mit mehr als 180.000 Produkten bietet Distrelec die Lösung für jede Herausforderung. Stöbern Sie in unserem umfangreichen TP-Link-Sortiment zu günstigen Preisen.
</blockquote>
...
<blockquote>
 tplinkbeiAmazondeRiesenauswahlSpitzenpreise
</blockquote>
<blockquote>
tp - link &amp; Zubehör. Kostenlose Lieferung möglich
</blockquote>
...
<blockquote>
TP-LINK's Archer AX6000 routers running firmware versions earlier than 'Archer AX6000(JP)_V1_1.3.0 Build 20221208' are impacted by this vulnerability. Exploitation Mechanism. To exploit CVE-2023-40531, an authenticated attacker within the network's vicinity can leverage the OS command injection flaw to execute malicious commands.
</blockquote>
...
* https://securityvulnerability.io/vulnerability/CVE-2023-6437

<blockquote>
 TPLinkVulnerabletoOSCommandInjectionThrough20240328
</blockquote>
<blockquote>
The OS Command Injection vulnerability in various TP-Link networking devices allows attackers to execute arbitrary commands on the affected systems. This issue affects models such as the TP-Link EX20v AX1800, Archer C5v AC1200, TD-W9970, and more, enabling authenticated users to gain unauthorized control over the system.
</blockquote>
...
<blockquote>
Command Injection Vulnerability The vulnerability, tracked as CVE-2023-33538, is a command injection bug with a CVSS score of 8.8. It resides in the /userRpm/WlanNetworkRpm component of TP-Link routers. An attacker can inject and execute arbitrary system commands through the parameter by sending a specially crafted HTTP GET request.
</blockquote>
...
<blockquote>
 TPLinkArcherAX21lucistokCommandInjection
</blockquote>
<blockquote>
Outbreak Alert TP-Link Archer AX21 (AX1800) firmware versions before 1.1.4 contains a command injection vulnerability in the web management interface specifically in the &quot;Country&quot; field. There is no sanitization of this field, so an attacker can exploit it for malicious activities and gain foothold.
</blockquote>
...
* https://cvefeed.io/vuln/detail/CVE-2024-21833

<blockquote>
 CVE202421833TPLINKOSCommandInjectionVulnerability
</blockquote>
<blockquote>
...
<blockquote>
 TPLinkRouterFlawCVE202333538UnderActiveExploitCISAIssues
</blockquote>
<blockquote>
TP-Link and Zyxel router flaws are under active attack, affecting global users and federal systems. ... CVE-2023-28771 refers to another operating system command injection vulnerability that could permit an unauthenticated attacker to execute commands by sending crafted requests to a susceptible device. It was patched by Zyxel in April 2023.
</blockquote>
...
<blockquote>
CISA warns of active exploitation targeting outdated TP-Link routers with command injection flaws. Users and federal agencies must act fast to avoid security breaches. ... Remove all affected TP-Link routers from networks by July 7, 2025. The agency also urges private-sector organizations and consumers to take similar action.
</blockquote>
...
* https://vuldb.com/?id.279236

<blockquote>
 CVE202446486TPLINKTLWDR5620httpProcDataSrvoscommandinjection
</blockquote>
<blockquote>
...
<blockquote>
Fortinet recently published a blog post highlighting the exploitation of a command injection vulnerability in TP-Link Archer routers by hackers in the wild. T. AGoent. One of the botnets actively exploiting CVE-2023-1389 is AGoent, a well-known malware strain that has been observed targeting various IoT devices.
</blockquote>
...
<blockquote>
This CVE record pertains to multiple TP-Link products that are vulnerable to OS command injection, allowing a network-adjacent unauthenticated attacker with access to the product to execute arbitrary OS commands. The affected products and versions include Archer AX3000, Archer AX5400, Archer AXE75, Deco X50, and Deco XE200.
</blockquote>
...
<blockquote>
 CVE202421833OSCommandInjectionvulnerabilityinTpLinkproducts
</blockquote>
<blockquote>
Multiple TP-LINK products allow a network-adjacent unauthenticated attacker with access to the product to execute arbitrary OS commands. ... An adversary can leverage OS command injection in an application to elevate privileges, execute arbitrary commands and compromise the underlying operating system. References. https://jvn.jp/en/vu ...
</blockquote>
...
<blockquote>
 CISAAddsTwoKnownExploitedVulnerabilitiestoCatalog
</blockquote>
<blockquote>
CVE-2023-33538 TP-Link Multiple Routers Command Injection Vulnerability; These types of vulnerabilities are frequent attack vectors for malicious cyber actors and pose significant risks to the federal enterprise. Binding Operational Directive (BOD) 22-01: ...
</blockquote>
...
* https://secalerts.co/vulnerability/CVE-2024-21833

<blockquote>
 CVE202421833OSCommandInjectionSecAlerts
</blockquote>
<blockquote>
Multiple TP-LINK products allow a network-adjacent unauthenticated attacker with access to the product to execute arbitrary OS commands. The affected device, with the initial configuration, allows login only from the LAN port or Wi-Fi. ... CVE-2024-21833: OS Command Injection. First published: Wed Jan 10 2024 (Updated:)
</blockquote>
...
<blockquote>
10.10.2024 - Contacted TP-Link with information about the vulnerability 12.10.2024 - TP-Link forwarded information to person for analysis 30.10.2024 - Requested CVE-ID from MITRE 08.11.2024 - TP-Link acknowledged vulnerability and provided fixed beta firmware version 23.11.2024 - MITRE reserved CVE-ID 2024-53375
</blockquote>
...
<blockquote>
 CVE202421833TPLINKOSCommandInjectionVulnerabilityCVEFeedio
</blockquote>
<blockquote>
Multiple TP-LINK products allow a network-adjacent unauthenticated attacker with access to the product to execute arbitrary OS commands. The affected device, with the initial configuration, allows login only from the LAN port or Wi-Fi. ... TP-LINK OS Command Injection Vulnerability. Overview
</blockquote>
...
<blockquote>
This indicates an attack attempt to exploit an Unauthenticated Command Injection Vulnerability in TP-Link Archer AX21 (AX1800).The vulnerability is... Research. Research Center. Explore latest research and threat reports on emerging cyber threats. ... Affected OS: Linux Affected App: Other Profile Type: Code Injection: Contact Us; Legal ...
</blockquote>
...
<blockquote>
 UrgentSecurityAlertCVE202421833VulnerabilityinTPLinkRouters
</blockquote>
<blockquote>
