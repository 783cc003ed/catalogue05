...
* https://cvefeed.io/vuln/detail/CVE-2025-27831

<blockquote>
 CVE202527831ArtifexGhostscriptTextBufferOverflowVulnerability
</blockquote>
<blockquote>
The following table lists the changes that have been made to the CVE-2025-27831 vulnerability over time. Vulnerability history details can be useful for understanding the evolution of a vulnerability, and for identifying the most recent changes that may impact the vulnerability's severity, exploitability, or other characteristics.
</blockquote>
...
* https://www.cvedetails.com/version/1372443/Python-openxml-Project-Python-docx-0.8.4.html

<blockquote>
 PythonopenxmlProjectPythondocx084securityvulnerabilitiesCVEs
</blockquote>
<blockquote>
Python-openxml Project Python-docx version 0.8.4 security vulnerabilities, CVEs, exploits, vulnerability statistics, CVSS scores and references
</blockquote>
...
<blockquote>
The specific flaw exists within the parsing of DOCX files. Crafted data in a DOCX file can trigger an overflow of a heap-based buffer. An attacker can leverage this vulnerability to execute code in the context of the current process.
</blockquote>
...
<blockquote>
CVE-2025-47957. CVSS score: High 8.4. Due to a &quot;use after release&quot; problem in Word, an unauthenticated attacker can execute code locally. ... This patch fixes a heap-based buffer overflow vulnerability in Word that can execute code on a computer. Affects: Microsoft 365 Apps for Enterprise for 64-bit and 32-bit systems;
</blockquote>
...
<blockquote>
Overview of CVE-2023-38545 CVE-2023-38545 is a vulnerability categorized as a heap buffer overflow. This type of vulnerability typically occurs when a program mistakenly decides to write more data to a block of memory, or buffer, than it is allocated for, leading to potential data corruption and exploitation of the system.
</blockquote>
...
* https://cve.mitre.org/cgi-bin/cvekey.cgi?keyword=Microsoft+Word

<blockquote>
 CVESearchResults
</blockquote>
<blockquote>
Integer overflow in the text converters in Microsoft Office Word 2002 SP3 and 2003 SP3; Works 8.5; Office Converter Pack; and WordPad in Windows 2000 SP4, XP SP2 and SP3, and Server 2003 SP2 allows remote attackers to execute arbitrary code via a DOC file with an invalid number of property names in the DocumentSummaryInformation stream, which ...
</blockquote>
...
<blockquote>
Buffer Copy without Checking Size of Input ('Classic Buffer Overflow') ... CVE Dictionary Entry: CVE-2025-27831 NVD Published Date: 03/25/2025 NVD Last Modified: 04/01/2025 Source: MITRE. X (link is external) facebook (link is external) linkedin (link ...
</blockquote>
...
* https://cve.mitre.org/cgi-bin/cvekey.cgi?keyword=john+the+ripper+破解+docx

<blockquote>
 CVESearchResults
</blockquote>
<blockquote>
The hncbd90 component in Hancom Office 9.6.1.9403 allows a use-after-free via an unknown object in a crafted .docx file. CVE-2019-13358: lib/DocumentToText.php in OpenCats before 0.9.4-3 has XXE that allows remote users to read files on the underlying operating system. The attacker must upload a file in the docx or odt format. CVE-2018-8811
</blockquote>
...
<blockquote>
An attacker can craft a malicious .docx file, and exploit the unzip function to rewrite a binary and remotely execute code on a victim's server. ... CVE Dictionary Entry: CVE-2020-11536 NVD Published Date: 04/15/2020 NVD Last Modified: 11/20/2024 Source: MITRE. X (link is external) facebook (link is external) linkedin (link ...
</blockquote>
...
<blockquote>
CVE-2025-27831 is a buffer overflow found in Ghostscript versions before 10.05.. Specifically, the flaw sits in the way Ghostscript's DOCXWRITE and TXTWRITE output devices handle long UTF-8 text runs.
</blockquote>
...
* https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2025-32717
...
<blockquote>
CVE-2023-21716 stems from how Microsoft Word handles Rich Text Format (RTF) files, particularly the \fonttbl control word, which defines fonts in the document using the \f format.
</blockquote>
...
<blockquote>
 HeapBasedBufferOverflowinMicrosoftOfficeWordCVE202532717
</blockquote>
<blockquote>
Discover key details about the heap-based buffer overflow vulnerability in Microsoft Office Word affecting numerous versions. Learn more about CVE-2025-32717.
</blockquote>
...
* https://news.sophos.com/en-us/2022/05/30/follina-word-doc-taps-previously-unknown-microsoft-office-vulnerability/

<blockquote>
 FollinaWorddoctapspreviouslyunknownMicrosoftOffice
</blockquote>
<blockquote>
As with the CVE-2021-40444 bug, Follina-enabled maldoc builders emerged rapidly. We saw an unusually complex attack emerge this week (June 6th) and thought it was notable to highlight. ... a Follina malicious .docx file, and a Windows shortcut. The shortcut shares the same naming pattern as the parent .zip and .img, but the DLL and .docx do not
</blockquote>
...
<blockquote>
One object is a 64-bit DLL file, &quot;AdobeID.pdf,&quot; extracted to the %temp% folder, while another exploits CVE-2017-11882 via crafted equation data, triggering a buffer overflow in EQNEDT32.EXE. According to the Report, this leads to the execution of the DLL via rundll32.exe, with a crafted WinExec() API call facilitating the process.
</blockquote>
...
<blockquote>
CVE-2025-27831 is a buffer overflow found in Ghostscript versions before 10.05.. Specifically, the flaw sits in the way Ghostscript's DOCXWRITE and TXTWRITE output devices handle long UTF-8 text runs. ... PDF, or DOCX), an attacker can overflow the buffer and possibly achieve remote code execution. Realistically, the attacker needs the ...
</blockquote>
...
<blockquote>
CVE-2023-21716 stems from how Microsoft Word handles Rich Text Format (RTF) files, particularly the \fonttbl control word, which defines fonts in the document using the \f format.The \fonttbl inside the wwlib.dll, is allocated a certain amount of space inside the Heap (This is because heap allocations are typically used for dynamic data, such as parsing large structures like a font table ...
</blockquote>
...
<blockquote>
What is CVE-2025-32717? A heap-based buffer overflow vulnerability in Microsoft Office Word allows unauthorized attackers to execute arbitrary code on affected systems. By crafting a malicious document file, an attacker could exploit this vulnerability, potentially leading to full system compromise.
</blockquote>
...
<blockquote>
Understanding CVE-2025-47167: A Type Confusion Vulnerability At its core, CVE-2025-47167 is categorized as an &quot;access of resource using incompatible type,&quot; more commonly known as type confusion. In programming, type confusion occurs when code assumes that a data object is of one type, when in fact it is another.
</blockquote>
...
* https://vuldb.com/?id.301312

<blockquote>
 CVE202527831ArtifexGhostscriptDOCXWRITETXTWRITEDevicedoccommon
</blockquote>
<blockquote>
The product copies an input buffer to an output buffer without verifying that the size of the input buffer is less than the size of the output buffer, leading to a buffer overflow. As an impact it is known to affect confidentiality, integrity, and availability. CVE summarizes: An issue was discovered in Artifex Ghostscript before 10.05..
</blockquote>
...
<blockquote>
The equation editor's buffer overflow vulnerability allows malicious code to be injected into the program and executed once the user has opened the document, setting the effort for executing the malicious code on the same levels as executing macros. ... Figure 12: Attached Excel document delivering FormBook via CVE-2017-0199 to CVE-2017-11882 ...
</blockquote>

---

# GitHub search -> docx CVE overflow
# MortenSchenkb
