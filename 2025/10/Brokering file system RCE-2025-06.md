## DuckDuckgo search -> Brokering file system RCE
`2025-06-30`

* https://www.zerodayinitiative.com/blog/2024/4/9/the-april-2024-security-updates-review

<blockquote>
 ZeroDayInitiativeTheApril2024SecurityUpdatesReview
</blockquote>
<blockquote>
This is one of seven DNS RCE bugs being patched this month and all are documented identically. These bugs allow RCE on an affected DNS server if the attacker has the privileges to query the DNS server. ... Microsoft Brokering File System Elevation of Privilege Vulnerability: Important: 7.8: No: No: EoP: CVE-2024-28907: Microsoft Brokering File ...
</blockquote>

---

## DuckDuckgo search -> Brokering file system RCE vulnerability
`2025-06-23`
...
<blockquote>
Rapid7's VulnDB is curated repository of vetted computer software exploits and exploitable vulnerabilities. Default description for Twitter sharing. Platform; Services; Resources; Partners; Company; Request Demo. vulnerability. Microsoft Windows: CVE-2024-28904: Microsoft Brokering File System Elevation of Privilege Vulnerability. Try Surface ...
</blockquote>
...
<blockquote>
Critical flaws in Microsoft's Brokering File System (BFS), including race conditions and UAF bugs, expose Windows to privilege escalation. PoC code available. Patch now! ... Tags: AppContainer cybersecurity Exploit Microsoft BFS PoC privilege escalation race condition use after free UWP Vulnerability windows. Continue Reading. Previous: ...
</blockquote>

---

## DuckDuckgo search -> Brokering file system RCE overflow
`2025-06-22`

* https://digital.nhs.uk/cyber-alerts/2025/cc-4607

<blockquote>
 MicrosoftReleasesJanuary2025SecurityUpdatesNHSDigital
</blockquote>
<blockquote>
Microsoft Brokering File System; Microsoft Digest Authentication; Microsoft Edge (Chromium-based) ... unauthenticated attacker to perform RCE. ... CVE-2025-21333 is a 'Heap-based Buffer Overflow' Free' vulnerability in Windows and Windows Server with a CVSSv3 score of 7.8.
</blockquote>
...
<blockquote>
 VeeamfixesanothercriticalRCEbuginBackupReplication
</blockquote>
<blockquote>
...
<blockquote>
He pointed to several RCE vulnerabilities in this round of patches, including: a WebDAV remote code execution vulnerability ( CVE-2025-33053 ), which is already under active exploitation;
</blockquote>
...
<blockquote>
New Veeam RCE flaw lets domain users hack backup servers. ... Microsoft Brokering File System: ... CVE-2025-4096 Heap buffer overflow in HTML: Unknown:
</blockquote>
...
<blockquote>
Use after free in Microsoft Brokering File System allows an authorized attacker to elevate privileges locally. ... high. 7.8. CWE. 416. 13/5/2025. 13/5/2025. 22/5/2025. CVE-2025-29970: Microsoft Brokering File System Elevation of Privilege Vulnerability. First published: Tue May 13 2025 (Updated:) &lt;p&gt;Use after free in Microsoft Brokering File ...
</blockquote>
...
<blockquote>
Summary The file system elevation of privilege vulnerability in Microsoft Brokering allows an attacker to gain elevated privileges, thereby compromising system integrity. This flaw arises from improper validation of file system requests, presenting a serious concern for users and administrators.
</blockquote>
...
* https://msrc-ppe.microsoft.com/update-guide/vulnerability/CVE-2025-29970

<blockquote>
 MicrosoftBrokeringFileSystemElevationofPrivilegeVulnerability
</blockquote>
<blockquote>
Executive Summary Use after free in Microsoft Brokering File System allows an authorized attacker to elevate privileges locally.
</blockquote>
...
<blockquote>
This particular flaw, tracked under CVE-2025-21315, impacts the Brokering File System, a mechanism likely tied to managing file permissions or interactions in Windows.
</blockquote>
...
* https://beyondmachines.net/event_details/microsoft-releases-april-2024-patch-fixing-150-flaws-two-actively-exploited-67-rce-o-b-w-8-8

<blockquote>
 MicrosoftreleasesApril2024Patchfixing150flawstwoactively
</blockquote>
<blockquote>
More than half of the RCE flaws were adressed in Microsoft SQL drivers, indicating a shared underlying vulnerability across these components. ... Microsoft Brokering File System Elevation of Privilege Vulnerability: Important: Microsoft Brokering File System: ... CVE-2024-23594 Stack Buffer Overflow in LenovoBT.efi: Important: Windows Secure Boot:
</blockquote>
...
<blockquote>
This is one of seven DNS RCE bugs being patched this month and all are documented identically. These bugs allow RCE on an affected DNS server if the attacker has the privileges to query the DNS server. ... CVE-2024-23594 Stack Buffer Overflow in LenovoBT.efi: ... Microsoft Brokering File System Elevation of Privilege Vulnerability: Important: 7 ...
</blockquote>
...
<blockquote>
Critical Zero-Day Vulnerabilities Under Active Exploitation. ... Microsoft Brokering File System Elevation of Privilege Vulnerability: Elevation of Privilege: Important: CVE-2025-29973: ... including a critical 0-day RCE flaw. Apple released security updates for iOS, iPadOS, and macOS.
</blockquote>
...
<blockquote>
Use after free in Microsoft Brokering File System allows an authorized attacker to elevate privileges locally. Published 2025-05-13 17:15:58 Updated 2025-05-19 14:20:49 Source Microsoft Corporation. View at NVD, CVE.org. Vulnerability category: Memory Corruption. ...
</blockquote>
...
<blockquote>
The Brokering File System is a core Windows facility, meaning nearly every modern version of Windows — from desktop to server editions — could potentially be exposed. Microsoft's security guidance indicates the flaw affects systems where the component is enabled, and it is not restricted to any single Windows SKU or deployment scenario. ...
</blockquote>
...
* https://cybersecuritynews.com/microsoft-january-2025-patch-tuesday/

<blockquote>
 MicrosoftPatchTuesdayJanuary2025159VulnerabilitiesFixed
</blockquote>
<blockquote>
Three remote code execution (RCE) vulnerabilities in Microsoft Access, tracked as CVE-2025-21186, CVE-2025-21366, and CVE-2025-21395, have been addressed. ... Microsoft Brokering File System Elevation of Privilege Vulnerability: Elevation of Privilege: Important: CVE-2025-21370: Windows Virtualization-Based Security (VBS) Enclave Elevation of ...
</blockquote>
...
# GitHub search -> Brokering file system RCE
