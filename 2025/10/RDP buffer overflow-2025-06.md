## DuckDuckgo search -> RDP buffer overflow
`2025-06-22`
...
* https://www.rapid7.com/db/modules/exploit/windows/fileformat/cain_abel_4918_rdp/

<blockquote>
 CainandAbelRDPBufferOverflowRapid7
</blockquote>
<blockquote>
...
<blockquote>
The Remote Desktop Protocol (RDP), also known as &quot;mstsc&quot; after the Microsoft built-in RDP client, is commonly used by technical users and IT staff to connect to / work on a remote computer. ... CVE 2018-20177: rdesktop versions up to and including v1.8.3 contain an Integer Overflow that leads to a Heap-Based Buffer Overflow in function rdp ...
</blockquote>
...
* https://windowsforum.com/tags/cve-2025-29966/

<blockquote>
 cve202529966WindowsForum
</blockquote>
<blockquote>
The recent disclosure of a heap-based buffer overflow vulnerability in the Windows Remote Desktop Client, tracked as CVE-2025-29966, has sent shockwaves through IT security circles, underscoring once again the delicate balance between connectivity and safety in modern computing environments.
</blockquote>
...
* https://www.syxsense.com/syxsense-securityarticles/remote_desktop/syx-1013-11395.html

<blockquote>
 RemoteDesktopAudit230157BufferOverflowsyxsensecom
</blockquote>
<blockquote>
Remote Desktop Audit 2.3.0.157 suffers from buffer overflow vulnerability. ... By exploiting a buffer overflow vulnerability an attacker can inject into the server process a malicious code, overflow the buffer to reach the return address of the vulnerable function, and overwrite the return address with a pointer to our code, to get it executed. ...
</blockquote>
...
* https://www.cvedetails.com/cve/CVE-2025-29966/

<blockquote>
 CVE202529966HeapbasedbufferoverflowinWindowsRemoteDesktop
</blockquote>
<blockquote>
Heap-based buffer overflow in Windows Remote Desktop allows an unauthorized attacker to execute code over a network. Published 2025-05-13 17:15:57 Updated 2025-05-19 14:21:58 Source Microsoft Corporation. View at NVD, CVE.org. Vulnerability category: Overflow Execute code.
</blockquote>
...
<blockquote>
Introduction. Remote Desktop Protocol (RDP) vulnerabilities continue to plague enterprises, and the recent discovery of CVE-2025-29966—a critical heap-based buffer overflow in the Windows Remote Desktop Client—has once again put organizations on high alert.
</blockquote>
...
* https://gbhackers.com/new-windows-rdp-vulnerability/

<blockquote>
 NewWindowsRDPVulnerabilityEnablesNetworkBasedAttacksGBHackers
</blockquote>
<blockquote>
Designated CVE-2025-29966 and CVE-2025-29967, these heap-based buffer overflow flaws affect the Windows Remote Desktop Protocol (RDP) and Remote Desktop Gateway (RD Gateway) service, respectively. Both vulnerabilities carry a CVSS v3.1 score of 8.8, highlighting their potential to disrupt enterprise networks and cloud environments.
</blockquote>
...
* https://www.ameeba.com/blog/cve-2025-29966-windows-remote-desktop-heap-based-buffer-overflow-vulnerability/

<blockquote>
 CVE202529966WindowsRemoteDesktopHeapBasedBufferOverflow
</blockquote>
<blockquote>
Overview CVE-2025-29966 is a critical vulnerability that affects the Windows Remote Desktop, a widely used feature that allows users to connect and control their systems remotely. This vulnerability, a heap-based buffer overflow, can potentially allow an unauthorized attacker to execute code over a network. It poses a significant threat as it can lead to system
</blockquote>
...
<blockquote>
CVE-2025-29966 and CVE-2025-29967 both involve heap-based buffer overflow vulnerabilities in the Remote Desktop Client and Gateway Service, respectively, allowing unauthorized attackers to execute arbitrary code over a network. &quot;In the case of a Remote Desktop connection, an attacker with control of a Remote Desktop Server could trigger a ...
</blockquote>
...
* https://www.hendryadrian.com/critical-heap-overflow-vulnerabilities-in-windows-rdp-and-rd-gateway-allow-remote-code-execution/

<blockquote>
 CriticalHeapOverflowVulnerabilitiesinWindowsRDPandRDGateway
</blockquote>
<blockquote>
Keypoints. Two heap-based buffer overflow vulnerabilities have been identified in Windows RDP and RD Gateway services. Both vulnerabilities have a high severity score of 8.8 on CVSS v3.1, indicating critical risk potential.
</blockquote>
...
<blockquote>
In the case of CVE-2025-29967, a specially crafted request sent to a vulnerable Remote Desktop Gateway Service can trigger the overflow. While technical details are still sparse pending full disclosure and patch adoption, early investigation by multiple security researchers suggests the vulnerability arises from improper input validation during ...
</blockquote>
...
* https://www.cve.news/cve-2025-27487/

<blockquote>
 CVE202527487HeapBasedBufferOverflowinRemoteDesktopClient
</blockquote>
<blockquote>
A new critical vulnerability, CVE-2025-27487, has shaken the security community this year. It affects Remote Desktop Client (commonly known as RDC), a staple in many organizations for connecting to Windows machines over a network. What makes this dangerous is its nature: a heap-based buffer overflow. If exploited, an attacker could
</blockquote>

---

# GitHub search -> RDP buffer overflow
# MortenSchenkb
