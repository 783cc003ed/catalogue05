...
<blockquote>
ASUS; Modem; RCE; Remote Code Execution; Router; Vulnerability; WiFi; Bill Toulas Bill Toulas is a tech writer and infosec news reporter with over a decade of experience working on various online ...
</blockquote>
...
<blockquote>
ASUS has recently addressed critical Remote Code Execution (RCE) vulnerabilities found in its DriverHub application, which could be exploited through HTTP requests and custom .ini files. These vulnerabilities posed significant security risks, allowing attackers to execute arbitrary code on affected systems. By releasing timely patches and updates, ASUS aims to enhance the security of its ...
</blockquote>
...
<blockquote>
 ASUSDriverHubdrivermanagementtooltargetedbyRCEvulnerability
</blockquote>
<blockquote>
DriverHub, ASUS' official driver management tool, was carrying a critical vulnerability that allowed threat actors to execute malicious code on affected devices, remotely.
</blockquote>
...
<blockquote>
In conclusion, the RCE vulnerabilities in ASUS DriverHub, which can be exploited through HTTP requests and custom .ini files, highlight the critical need for vigilance in software security. ASUS's prompt response to these vulnerabilities reflects a responsible approach to safeguarding user data and system integrity.
</blockquote>
...
<blockquote>
A security researcher discovered a major flaw in ASUS DriverHub The flaw allows users to run malicious code remotely A patch was already released DriverHub, ASUS' official driver management tool ...
</blockquote>
...
* https://parrot-ctfs.com/blog/asus-patches-driverhub-rce-flaws-exploitable-via-http-and-crafted-ini-files-cve-2025-3462-cve-2025-3463/

<blockquote>
 ASUSPatchesDriverHubRCEFlawsExploitableviaHTTPandCraftedini
</blockquote>
<blockquote>
ASUS has recently released patches addressing two critical remote code execution (RCE) vulnerabilities in its DriverHub utility, which could have allowed attackers to execute arbitrary code on affected systems through crafted HTTP requests and malicious .ini files.(cloudindustryreview.com) Vulnerabilities Overview The two vulnerabilities, identified as CVE-2025-3462 and CVE-2025-3463, were ...
</blockquote>
...
* https://socradar.io/cve-2025-3462-cve-2025-3463-asus-driverhub-flaws/

<blockquote>
 CVE20253462CVE20253463ASUSDriverHubFlawsEnableRCE
</blockquote>
<blockquote>
CVE-2025-3462 &amp; CVE-2025-3463: ASUS DriverHub Flaws Enable RCE. ASUS DriverHub, a utility built to simplify driver updates, was found to have two high-risk vulnerabilities: CVE-2025-3462 and CVE-2025-3463. Discovered and reported in April 2025, these issues have since been patched by ASUS, but during the exposure window, attackers could have ...
</blockquote>
...
* https://fieldeffect.com/blog/asus-patches-rce-flaw-in-driverhub-utility

<blockquote>
 ASUSpatchesRCEflawinDriverHubutilityfieldeffectcom
</blockquote>
<blockquote>
...
* https://cyber.vumetric.com/security-news/2025/05/12/asus-patches-driverhub-rce-flaws-exploitable-via-http-and-crafted-ini-files/

<blockquote>
 ASUSPatchesDriverHubRCEFlawsExploitableviaHTTPandCraftedini
</blockquote>
<blockquote>
Security News &gt; 2025 &gt; May &gt; ASUS Patches DriverHub RCE Flaws Exploitable via HTTP and Crafted .ini Files . 2025-05-12 14:03. ASUS has released updates to address two security flaws impacting ASUS DriverHub that, if successfully exploited, could enable an attacker to leverage the software in order to achieve remote code execution. DriverHub is ...
</blockquote>
...
<blockquote>
18/04/2025 - ASUS confirmed the fix was live; 09/05/2025 - CVE-2025-3462 (8.4) and CVE-2025-3463 (9.4) were published; Assessing the Damage. Almost immediately after reporting the RCE to ASUS I wrote a script to track certificate transparency updates on my VPS, so I could see if anyone else had a domain with driverhub.asus.com.* registered ...
</blockquote>
...
<blockquote>
ASUS DriverHub RCE Vulnerabilities: An Overview. ASUS has recently taken significant steps to address critical remote code execution (RCE) vulnerabilities identified in its DriverHub software. These vulnerabilities, which can be exploited through HTTP requests and custom .ini files, pose a serious risk to users who rely on this application for ...
</blockquote>
...
* https://www.rescana.com/post/vulnerabilities-in-asus-driverhub-exposed-cve-2025-3462-and-cve-2025-3463-analysis

<blockquote>
 VulnerabilitiesinASUSDriverHubExposedCVE20253462andCVE2025
</blockquote>
<blockquote>
ASUS DriverHub has been identified with two significant vulnerabilities, posing a high risk to users due to insufficient validation for HTTP requests. CVE-2025-3462 is rated with a CVSSv4 score of 8.4 and originates from improper validation when processing specific HTTP requests, allowing attackers to spoof internal communications and interact with the software's internal features without ...
</blockquote>
...
<blockquote>
An authenticated and remote attacker can execute arbitrary operating system commands by uploading a crafted OVPN profile. Known affected routers include ASUS ExpertWiFi, ASUS RT-AX55, ASUS RT-AX58U, ASUS RT-AC67U, ASUS RT-AC68R, ASUS RT-AC68U, ASUS RT-AX86, ASUS RT-AC86U, ASUS RT-AX88U, and ASUS RT-AX3000.
</blockquote>
...
<blockquote>
ASUS Patches DriverHub RCE Flaws Exploitable via HTTP and Crafted .ini Files May 12, 2025 Ravie Lakshmanan Vulnerability / Endpoint Security ASUS has released updates to address two security flaws impacting ASUS DriverHub that, if successfully exploited, could enable an attacker to leverage the software in order to achieve remote code execution.
</blockquote>
