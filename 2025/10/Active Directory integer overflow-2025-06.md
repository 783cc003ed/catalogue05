## DuckDuckgo search -> Active Directory integer overflow
`2025-06-22`

* https://www.centrel-solutions.com/media/xiaconfiguration/adminguideweb/ActiveDirectoryAttributeValueTyp.html

<blockquote>
 ActiveDirectoryAttributeValueTypes
</blockquote>
<blockquote>
The following Active Directory attributes value types are supported. Boolean; Case Insensitive String; Distinguished Name; DN Binary; IA5-String; Integer; Large Integer / Interval; Numerical String; Object Identifier
</blockquote>
...
* https://www.selfadsi.org/deep-inside/microsoft-integer8-attributes.htm

<blockquote>
 MicrosoftTimestampIntervalAttributeswithInteger8Syntax
</blockquote>
<blockquote>
There are several other tools to convert an Microsoft Large Integer (Integer8) value to a date. LEX - The LDAP Explorer. LEX - The LDAP Explorer (a commercial powerful LDAP browser I developed) has special attribute editors for Large Integer values which have to be interpreted as Timestamps and Intervals: LEX Editor for Microsoft Integer8 ...
</blockquote>
...
* https://www.trendmicro.com/vinfo/no/threat-encyclopedia/vulnerability/2135/microsoft-active-directory-browser-election-buffer-overflow-vulnerability

<blockquote>
 MicrosoftActiveDirectoryBROWSERELECTIONBufferOverflow
</blockquote>
<blockquote>
Integer underflow in the BowserWriteErrorLogEntry function in the Common Internet File System (CIFS) browser service in Mrxsmb.sys or bowser. Business. search close. Solutions. By Challenge. By Challenge. By Challenge. Learn more. Understand, Prioritize &amp; Mitigate Risks.
</blockquote>
...
* https://stackoverflow.com/questions/78987485/kinit-invalid-integer-value-while-getting-initial-credentials

<blockquote>
 activedirectorykinitInvalidintegervaluewhilegettinginitial
</blockquote>
<blockquote>
OK so I get this straight: My Active Directory (AD) EvolvenDBUser is associated with my Service Principle (MSSQLSvc/[email protected]) and is set to run the SQL Service.I created another AD account called DBClientUser and create a new login within the SQL Server database set to Windows Authentication with this user.
</blockquote>
...
<blockquote>
You should keep in mind that Active Directory stores all date and time values internally in the UTC format (Universal Coordinated Time) - this is (almost) the former Greenwich Meantime (GMT). ... Next Else timeShift &#61; timeShiftValue End If 'get the large integer into two long values (high part and low part) i8High &#61; value.HighPart i8Low &#61; value ...
</blockquote>
...
* https://stackoverflow.com/questions/22382819/directoryattribute-value-should-be-integer-instead-of-string

<blockquote>
 DirectoryAttributevalueshouldbeintegerinsteadofstring
</blockquote>
<blockquote>
(The value in the Active Directory is definitely an integer.) In the following code, if I breakpoint at userAccountFlags &#61; (int)attrib[0]; the type of attrib[0] is a string. Why? (I can easily &quot;fix&quot; it by replacing it with int.TryParse((string)attrib[0], out userAccountFlag); but would prefer to know why it's happening than use this work-around.)
</blockquote>
...
* https://www.crowdstrike.com/en-us/blog/cve-2020-1267-integer-overflow-security-advisor/

<blockquote>
 IntegerOverflowinActiveDirectoryCVE20201267CrowdStrike
</blockquote>
<blockquote>
CVE-2020-1267 is an integer overflow that exists in both the NTLM and Kerberos parsing codes. Such an overflow can be used to create a denial-of-service attack. BLOG. ... Microsoft released a patch for CVE-2020-1267, an important vulnerability in the Active Directory (AD) identity store discovered by CrowdStrike ...
</blockquote>
...
* https://stackoverflow.com/questions/42292840/directoryentry-activedirectorysyntax-int64-property-hint-on-how-to-format-as-dat

<blockquote>
 netDirectoryEntryActiveDirectorySyntaxInt64StackOverflow
</blockquote>
<blockquote>
I want to display all properties of an ActiveDirectory user entry like the Attribute Editor in the properties dialog shown when &quot;View&quot;-&gt;&quot;Advanced Features&quot; in &quot;Active Directory Users and Computers&quot; is activated. This is a rather simple task by using DirectorySearcher function FindOne and then iterating through the SearchResult.
</blockquote>
...
* https://www.sqlservercentral.com/forums/topic/manipulating-integer8-active-directory

<blockquote>
 ManipulatingInteger8ActiveDirectorySQLServerCentral
</blockquote>
<blockquote>
...
* https://stackoverflow.com/questions/52784930/problem-handling-custom-active-directory-date-attribute

<blockquote>
 ProblemhandlingcustomActiveDirectorydateattribute
</blockquote>
<blockquote>
I have extended our schema with a new attribute of type large integer/interval to be used as a date. There are issues here. One is that in ADUC, the attribute shows as a number while other dates in the system (with same underlying type) show up as a date. That seems to be ok, actually, since it is integer.
</blockquote>
...
<blockquote>
 MSADTSLDAPRepresentationsMicrosoftLearn
</blockquote>
<blockquote>
* The Integer syntax in Active Directory is restricted to 32-bit integers. The LargeInteger syntax is restricted to 64-bit integers. ** While Active Directory uses the [RFC2252] and [RFC2253] representation of DNs, it can also use alternative forms of the DN representation when it accepts requests and sends responses, if requested by the client.
</blockquote>
...
* https://stackoverflow.com/questions/24905407/acitve-directory-handling-attributes-with-large-integer-integer8-syntax

<blockquote>
 vbnetAcitveDirectoryHandlingattributeswithLARGEINTEGER
</blockquote>
<blockquote>
...
* https://learn.microsoft.com/en-us/windows/win32/adsi/adsi-attribute-syntax

<blockquote>
 ADSIAttributeSyntaxWin32appsMicrosoftLearn
</blockquote>
<blockquote>
For example, integer, string, numeric, and so on. ADSI defines its own syntax that maps to the native directory syntax. This section describes the types of attribute syntaxes in ADSI. ... Active Directory accepts any content for a numeric string; it does not verify that the characters are numeric. UTC Time Syntax Type: ADSTYPE_UTC_TIME
</blockquote>
...
* https://community.fabric.microsoft.com/t5/Desktop/AD-useraccountcontrol-integer-conversion/m-p/437105

<blockquote>
 SolvedADuseraccountcontrolintegerconversionMicrosoftFabric
</blockquote>
<blockquote>
AD useraccountcontrol integer conversion ‎06-11-2018 07:33 AM. Hi all, ... I'm trying to do bitwise operation on the userAccountControl field of Active Directory(AD) user table. I've successfully loaded the AD user table. I'm using this article:
</blockquote>
...
<blockquote>
 Integer8Attributesrlmuellernet
</blockquote>
<blockquote>
...
# GitHub search -> Active Directory integer overflow
# MortenSchenkb
