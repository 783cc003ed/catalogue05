## DuckDuckgo search -> LSAS integer overflow
`2025-06-23`

* https://stackoverflow.com/questions/29235436/why-do-i-get-these-results-with-signed-unsigned-integer-overflow

<blockquote>
 WhydoIgettheseresultswithsignedunsignedintegeroverflow
</blockquote>
<blockquote>
Signed integer overflow is undefined behaviour, while unsigned integer overflow is well-defined; the value wraps around. In other words, the value is modulo divided by 2 bits, where bits is the number of bits in the data type. Since you've a 32-bit int. 4294967295 + 1 &#61; 4294967296 % 2 32 &#61; 0. it results in 0 in the second case.
</blockquote>
...
* https://techcommunity.microsoft.com/blog/microsoft-entra-blog/troubleshooting-a-memory-leak-in-lsass-exe/243146

<blockquote>
 TroubleshootingaMemoryLeakinLsassexeMicrosoftCommunityHub
</blockquote>
<blockquote>
First published on CloudBlogs on Oct, 13 2008 Although we have a team of engineers who are dedicated to troubleshooting general server performance related problems Microsoft Directory Services specialists are expected to be the &quot;go to&quot; people for Active Directory and domain controller related performance issues.
</blockquote>
...
* https://www.tenable.com/plugins/nessus/42115

<blockquote>
 MS09059VulnerabilityinLocalSecurityAuthoritySubsystemTenable
</blockquote>
<blockquote>
Synopsis The remote Windows host is prone to a denial of service attack. Description The version of LSASS running on the remote host has an integer overflow vulnerability.
</blockquote>
...
* https://www.cvedetails.com/microsoft-bulletin/ms09-059/

<blockquote>
 VulnerabilityinLocalSecurityAuthoritySubsystemServiceCouldAllow
</blockquote>
<blockquote>
Integer underflow in the NTLM authentication feature in the Local Security Authority Subsystem Service (LSASS) in Microsoft Windows XP SP2 and SP3, Windows Server 2003 SP2, Windows Vista Gold, SP1, and SP2, Windows Server 2008 Gold, SP2, and R2, and Windows 7 allows remote attackers to cause a denial of service (reboot) via a malformed packet, aka &quot;Local Security Authority Subsystem Service ...
</blockquote>
...
* https://support.huawei.com/enterprise/en/doc/EDOC1100248438/f7686ef6/lsdb-overflow-limit

<blockquote>
 lsdboverflowlimitS12700andS12700EV200R021C10CommandReference
</blockquote>
<blockquote>
The lsdb-overflow-limit command sets the ... Parameter Description Value; number: Specifies the maximum number of external LSAs in an LSDB. The value is an integer ranging from 1 to 1000000. Views. OSPF view. Default Level. 2: Configuration level. Usage Guidelines. Usage Scenario. When the number of external LSAs (Type 5 and Type 7 LSAs ...
</blockquote>
...
* https://www.hkcert.org/security-bulletin/microsoft-windows-local-security-authority-subsystem-service-lsass-integer-overflow-vulnerability-14-october-2009

<blockquote>
 MicrosoftWindowsLocalSecurityAuthoritySubsystemServiceLSASS
</blockquote>
<blockquote>
Microsoft Windows Local Security Authority Subsystem Service (LSASS) Integer Overflow Vulnerability( 14 October 2009 ) Last Update Date: 28 Jan 2011 Release Date: 14 Oct 2009 6271 Views RISK: Medium Risk. Medium Risk. A denial of service vulnerability exists in the Microsoft Windows Local Security Authority Subsystem Service (LSASS) due to its ...
</blockquote>
...
* https://github.com/r-lidar/lidR/issues/272

<blockquote>
 IntegeroverflowafterlastransformIssue272rlidarlidR
</blockquote>
<blockquote>
Integer overflow after lastransform &#35;272. Copy link. Assignees. Labels. Bug A bug in the package A bug in the package Enhancement Not actually a bug but a possible improvement Not actually a bug but a possible improvement. Description. BBranoff. opened on Sep 3, 2019. Issue body actions.
</blockquote>
...
* https://support.huawei.com/enterprise/en/doc/EDOC1100457354/f7686ef6/lsdb-overflow-limit

<blockquote>
 lsdboverflowlimitWLANACV200R024C10CommandReferenceHuawei
</blockquote>
<blockquote>
The lsdb-overflow-limit command sets the ... Parameter Description Value; number: Specifies the maximum number of external LSAs in LSDB. The value is an integer ranging from 1 to 1000000. Views. OSPF view. Default Level. 2: Configuration level. Usage Guidelines. Usage Scenario. When the number of external LSAs (Type 5 and Type 7 LSAs) imported ...
</blockquote>
...
* https://info.support.huawei.com/hedex/api/pages/EDOC1100149308/AEJ0713J/17/resources/cli_vrp/lsdb-overflow-limit.html

<blockquote>
 lsdboverflowlimitHuaweiWirelessNetworkInformationCenter
</blockquote>
<blockquote>
The lsdb-overflow-limit command sets the maximum number of external LSAs in the OSPF Link-State Database (LSDB). ... Value; number: Specifies the maximum number of external LSAs in the LSDB. The value is an integer ranging from 1 to 1000000. Views. OSPF view. Default Level. 2: Configuration level. Usage Guidelines. Usage Scenario.
</blockquote>
...
* https://advisories.checkpoint.com/defense/advisories/public/2013/cpai-2013-1664.html/

<blockquote>
 CPAI20131664CheckPointSoftware
</blockquote>
<blockquote>
In the IPS tab, click Protections and find the Microsoft LSASS Authentication Process Integer Overflow (MS09-059) - High Confidence protection using the Search tool and Edit the protection's settings. Install policy on all Security Gateways. This protection's log will contain the following information:
</blockquote>
...
<blockquote>
Integer Overflow. This is an arithmetic overflow issue where integer is not stored in an allocated area in the memory or buffer. It could provide unexpected results as integers have a specific number of bits in memory and overflow causes inaccurate behavior such as financial manipulations. Unicode Overflow
</blockquote>
...
* https://learn.microsoft.com/en-us/security-updates/SecurityBulletins/2009/ms09-059

<blockquote>
 MicrosoftSecurityBulletinMS09059Important
</blockquote>
<blockquote>
FAQ for Local Security Authority Subsystem Service Integer Overflow Vulnerability - CVE-2009-2524. What is the scope of the vulnerability? This is a denial of service vulnerability. A specially crafted authentication frame may allow an unauthenticated attacker to cause the server-side LSASS process to stop responding and restart the computer.
</blockquote>
...
<blockquote>
 fortiosrouterospfConfigureOSPFinFortinetsFortiOSand
</blockquote>
<blockquote>
integer. Summary default cost of stub or NSSA area. filter_list. list. OSPF area filter-list configuration. direction. string. Choices: in; out; Direction. id. ... database_overflow_max_lsas. integer. Database overflow maximum LSAs. database_overflow_time_to_recover. integer. Database overflow time to recover (sec). default_information_metric.
</blockquote>
...
* https://www.trendmicro.com/vinfo/us/threat-encyclopedia/vulnerability/23/local-security-authority-subsystem-service-integer-overflow-vulnerability

<blockquote>
 LocalSecurityAuthoritySubsystemServiceIntegerOverflow
</blockquote>
<blockquote>
Integer underflow in the NTLM authentication feature in the Local Security Authority Subsystem Service (LSASS) in Microsoft Windows XP SP2 and SP3, Windows Server 2003 SP2, Windows Vista Gold, SP1, and SP2, Windows Server 2008 Gold, SP2, and R2, and Windows 7 allows remote attackers to cause a denial of service (reboot) via a malformed packet, aka &quot;Local Security Authority Subsystem Service ...
</blockquote>
...
<blockquote>
Local Security Authority Subsystem Service Integer Overflow Vulnerability - CVE-2009-2524 A denial of service vulnerability exists in the Microsoft Windows Local Security Authority Subsystem Service (LSASS) due to its improper handling of malformed packets during NTLM authentication.
</blockquote>
...
<blockquote>
This is due to an integer overflow. You can fix it by setting manually an offset into the header
</blockquote>
...
<blockquote>
In the IPS tab, click Protections and find the Microsoft LSASS Authentication Process Integer Overflow (MS09-059) - High Confidence protection using the Search tool and Edit the protection's settings. This protection's log will contain the following information: Attack Name: MS-RPC over CIFS Enforcement Violation.
</blockquote>
...
* https://support.huawei.com/enterprise/en/doc/EDOC1100459463/f7686ef6/lsdb-overflow-limit

<blockquote>
 lsdboverflowlimitS12700andS12700EV200R024C10CommandReference
</blockquote>
<blockquote>
Function The lsdb-overflow-limit command sets the maximum number of external LSAs in an OSPF LSDB.
</blockquote>
...
* https://stackoverflow.com/questions/74368206/nas-produced-by-integer-overflow

<blockquote>
 NAsproducedbyintegeroverflow
</blockquote>
<blockquote>
...
<blockquote>
Function The lsdb-overflow-limit command sets the maximum number of external LSAs in the OSPF Link-State Database (LSDB).
</blockquote>

---

# GitHub search -> LSAS integer overflow
# MortenSchenkb
