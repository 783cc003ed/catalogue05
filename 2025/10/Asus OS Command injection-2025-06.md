...
* https://vuldb.com/?id.244407

<blockquote>
 CVE202341345ASUSRTAX55RTAC86UTokenGeneratedModuleoscommand
</blockquote>
<blockquote>
A vulnerability, which was classified as critical, was found in ASUS RT-AX55 and RT-AC86U 3...4.386.51598. This affects some unknown functionality of the component Token-Generated Module. The manipulation with an unknown input leads to a os command injection vulnerability. CWE is classifying the issue as CWE-78. The product constructs all or ...
</blockquote>
...
* https://www.cve.news/cve-2022-4221/

<blockquote>
 CVE20224221ASUSNASM25OSCommandInjectionVulnerabilityvia
</blockquote>
<blockquote>
...
* https://www.clouddefense.ai/cve/2023/CVE-2023-41346

<blockquote>
 CVE202341346ASUSRTAX55CommandInjectionVulnerabilityOverview
</blockquote>
<blockquote>
The Impact of CVE-2023-41346 The vulnerability, categorized as CAPEC-88 OS Command Injection, poses a high risk with a CVSS base score of 8.8. Attackers can disrupt systems, terminate services, and compromise confidentiality, integrity, and availability.
</blockquote>
...
* https://stack.watch/vuln/CVE-2023-39780/

<blockquote>
 CVE202339780isavulnerabilityinAsusRtAx55Firmware
</blockquote>
<blockquote>
ASUS RT-AX55 devices contain a OS command injection vulnerability that could allow a remote, authenticated attacker to execute arbitrary commands. The following remediation steps are recommended / required by June 23, 2025: Apply mitigations per vendor instructions, follow applicable BOD 22-01 guidance for cloud services, or discontinue use of ...
</blockquote>
...
* https://cyber.vumetric.com/vulns/CVE-2023-39780/os-command-injection-vulnerability-in-asus-rt-ax55-firmware-3-0-0-4-386-51598/

<blockquote>
 CVE202339780OSCommandInjectionvulnerabilityinAsusRtAx55
</blockquote>
<blockquote>
On ASUS RT-AX55 3...4.386.51598 devices, authenticated attackers can perform OS command injection via the /start_apply.htm qos_bw_rulelist parameter. NOTE: for the similar &quot;token-generated module&quot; issue, see CVE-2023-41345; for the similar &quot;token-refresh module&quot; issue, see CVE-2023-41346; for the similar &quot;check token module&quot; issue, see CVE-2023-41347; and for the similar &quot;code-authentication ...
</blockquote>
...
* https://vuldb.com/?id.244405

<blockquote>
 CVE202341348ASUSRTAX55RTAC86UCodeAuthenticationModuleos
</blockquote>
<blockquote>
...
<blockquote>
 ASUSWiFiRoutersVulnerabletoOSCommandInjectionAttacks
</blockquote>
<blockquote>
...
<blockquote>
The vulnerability, categorized as CAPEC-88 OS Command Injection, poses a high risk with a CVSS base score of 8.8. Attackers can disrupt systems, terminate services, and compromise confidentiality, integrity, and availability. Technical Details of CVE-2023-41346 Explore the technical aspects and affected systems of the CVE-2023-41346 vulnerability.
</blockquote>
...
* https://github.com/advisories/GHSA-gfr5-jh8m-r2xx

<blockquote>
 CertainASUSWiFiroutersmodelshasanOSCommandGitHub
</blockquote>
<blockquote>
Certain ASUS WiFi routers models has an OS Command Injection vulnerability, allowing an authenticated remote attacker to execute arbitrary system commands by sending a specially crafted request.
</blockquote>
...
* https://www.scyscan.com/cve-2023-39780/asus-rt-ax55-routers-os-command-injection-vulnerability/

<blockquote>
 CVE202339780ASUSRTAX55RoutersOSCommandInjection
</blockquote>
<blockquote>
ASUS RT-AX55 Routers OS Command Injection Vulnerability. Description. ASUS RT-AX55 devices contain a OS command injection vulnerability that could allow a remote, authenticated attacker to execute arbitrary commands. Known To Be Used in Ransomware Campaigns? Unknown. Action.
</blockquote>
...
<blockquote>
ASUS RT-AX55 Routers OS Command Injection Vulnerability. Description. ASUS RT-AX55 devices contain an OS command injection vulnerability that could allow a remote, authenticated attacker to execute arbitrary commands. As represented by CVE-2023-41346. Known To Be Used in Ransomware Campaigns?
</blockquote>
...
* https://cve.imfht.com/detail/CVE-2024-1655

<blockquote>
 ASUSWiFiRouterOSCommandInjection漏洞信息CVE20241655by漏洞平台
</blockquote>
<blockquote>
ASUS WiFi Router - OS Command Injection漏洞 Certain ASUS WiFi routers models has an OS Command Injection vulnerability, allowing an authenticated remote attacker to execute arbitrary system commands by sending a specially crafted request.; NG Vuln Platform - by AI.
</blockquote>
...
* https://jangto.tistory.com/entry/DVWA-Command-Injection-LowHigh-PHP

<blockquote>
 DVWACommandInjectionLowHighPHP
</blockquote>
<blockquote>
DVWA(Damn Vulnerable Web Application)는 웹 애플리케이션 보안 실습을 위한 플랫폼입니다.이번 글에서는 Command Injection 취약점 중 Low ~ high 보안 등급에서의 동작을 살펴보고 실제 공격 시나리오와 취약점 원인을 PHP 코드로 분석합니다.Command Injection 이란?사용자 입력값이 서버의 명령어 실행 함수에 그대로 ...
</blockquote>
...
* https://www.twcert.org.tw/en/cp-139-7736-e423d-2.html

<blockquote>
 ASUSWiFiRouterOSCommandInjectiontwcertorgtw
</blockquote>
<blockquote>
Certain ASUS WiFi routers models has an OS Command Injection vulnerability, allowing an authenticated remote attacker to execute arbitrary system commands by sending a specially crafted request. Solution: Update ExpertWiFi EBM63 firmware to 3.0.0.6.102_32645 or later version Update ExpertWiFi EBM68 firmware to 3.0.0.6.102_44384 or later version
</blockquote>
...
* https://vuldb.com/?id.260640

<blockquote>
 CVE20241655AsusExpertWiFiEBM63ExpertWiFiEBM68RTAX57GoVulDB
</blockquote>
<blockquote>
A vulnerability classified as critical has been found in Asus ExpertWiFi EBM63, ExpertWiFi EBM68 and RT-AX57 Go. Affected is some unknown functionality of the component Request Handler. The manipulation with an unknown input leads to a os command injection vulnerability. CWE is classifying the issue as CWE-78. The product constructs all or part ...
</blockquote>
...
* https://cvefeed.io/vuln/detail/CVE-2024-1655

<blockquote>
 CVE20241655ASUSWiFiRouterCommandInjectionVulnerability
</blockquote>
<blockquote>
Certain ASUS WiFi routers models has an OS Command Injection vulnerability, allowing an authenticated remote attacker to execute arbitrary system commands by sending a specially crafted request.
</blockquote>
...
<blockquote>
 CVE202339780OnASUSRTAX55300438651598devices
</blockquote>
<blockquote>
ASUS RT-AX55 Routers OS Command Injection Vulnerability CISA required action: Apply mitigations per vendor instructions, follow applicable BOD 22-01 guidance for cloud services, or discontinue use of the product if mitigations are unavailable. CISA description: ASUS RT-AX55 devices contain a OS command injection vulnerability that could allow a ...
</blockquote>
...
<blockquote>
Summary. Certain ASUS WiFi routers models has an OS Command Injection vulnerability, allowing an authenticated remote attacker to execute arbitrary system commands by sending a specially crafted request.
</blockquote>
...
<blockquote>
ASUS RT-AX55 Routers OS Command Injection Vulnerability CISA required action: Apply mitigations per vendor instructions, follow applicable BOD 22-01 guidance for cloud services, or discontinue use of the product if mitigations are unavailable. CISA description: ASUS RT-AX55 devices contain an OS command injection vulnerability that could allow ...
</blockquote>
...
<blockquote>
Certain ASUS WiFi routers models has an OS Command... High severity Unreviewed Published Apr 15, 2024 to the GitHub Advisory Database ... Patched versions. Unknown. Description. Certain ASUS WiFi routers models has an OS Command Injection vulnerability, allowing an authenticated remote attacker to execute arbitrary system commands by sending a ...
</blockquote>
...
<blockquote>
 CVE20241655CertainASUSWiFiroutersmodelshasanOSCommand
</blockquote>
<blockquote>
...
* https://cve.circl.lu/cve/CVE-2024-1655

<blockquote>
 CVE20241655CertainASUSWiFiroutersmodelshasanOSCommand
</blockquote>
<blockquote>
Certain ASUS WiFi routers models has an OS Command Injection vulnerability, allowing an authenticated remote attacker to execute arbitrary system commands by sending a specially crafted request. ... As with other injection attacks, the attacker uses the command delimiter payload as an entry point to tunnel through the application and activate ...
</blockquote>
...
* https://undercodenews.com/critical-os-command-injection-flaw-discovered-in-asus-rt-ax55-firmware/

<blockquote>
 CriticalOSCommandInjectionFlawDiscoveredinASUSRTAX55Firmware
</blockquote>
<blockquote>
A serious security vulnerability has been identified in ASUS RT-AX55 routers running firmware version 3...4.386.51598. This issue allows authenticated
</blockquote>
...
<blockquote>
ASUS RT-AX55 Routers OS Command Injection Vulnerability: 06/02/2025: 06/23/2025: Apply mitigations per vendor instructions, follow applicable BOD 22-01 guidance for cloud services, or discontinue use of the product if mitigations are unavailable. ... CWE-78: Improper Neutralization of Special Elements used in an OS Command ('OS Command Injection')
</blockquote>
...
<blockquote>
Certain ASUS WiFi routers models has an OS Command Injection vulnerability, allowing an authenticated remote attacker to execute arbitrary system commands by sending a specially crafted request. ... Improper Neutralization of Special Elements used in an OS Command ('OS Command Injection')
</blockquote>
