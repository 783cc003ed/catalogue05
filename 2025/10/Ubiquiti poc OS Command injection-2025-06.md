...
* https://medium.com/@mehaksyeda3/portswigger-os-command-injection-writeup-6204799da0c1

<blockquote>
 PortSwiggerOScommandinjectionwriteupMedium
</blockquote>
<blockquote>
Lab2: Blind OS command injection with time delays Description. This lab contains a blind OS command injection vulnerability in the feedback function. The application executes a shell command ...
</blockquote>
...
* https://www.morphisec.com/blog/log4j-exploit-targets-vulnerable-unifi-network-applications/

<blockquote>
 Log4jExploitTargetsVulnerableUnifiNetworkApplicationUbiquiti
</blockquote>
<blockquote>
Not surprisingly, a POC for the exploitation of Unifi Network was released a month prior (24th of December), and we, therefore, expected to see this type of targeted exploitation in the wild. ... Ubiquiti normal execution command line:-Dfile.encoding&#61;UTF-8-Djava.awt.headless&#61;true-Dapple.awt.UIElement&#61;true-Dunifi.core.enabled&#61;false-Xmx1024M-Xrs
</blockquote>
...
<blockquote>
POC script requirement SecureCode sqeakr Course Course [Protected] 10. Guacamole Lite Prototype Pollution [Protected] 11. Dolibarr Eval Filter Bypass RCE [Protected] 12. RudderStack SQLi and Coraza WAF Bypass [Protected] 3. ManageEngine Applications Manager AMUserResourcesSyncServlet SQL Injection RCE [Protected] 4.
</blockquote>
...
<blockquote>
 UbiquitiAdministrationPortalRemoteCommandExecutionviaCross
</blockquote>
<blockquote>
...
<blockquote>
 ExpertsreleasedPoCexploitforUbiquitiEdgeRouterflaw
</blockquote>
<blockquote>
Cisco warns of a command injection escalation flaw in its IMC. PoC publicly available | Linux variant of Cerber ransomware targets Atlassian servers | Ivanti fixed two critical flaws in its Avalanche MDM | Researchers released exploit code for actively exploited Palo Alto PAN-OS bug |
</blockquote>
...
<blockquote>
You can use Burp to test for OS command injection vulnerabilities: Professional Use Burp Scanner to automatically flag potential OS command injection vulnerabilities. Use Burp Repeater to manually test for OS command injection vulnerabilities. Steps. You can follow this process using the lab OS command injection, simple case.
</blockquote>
...
* https://infosecwriteups.com/blind-os-command-injection-with-output-redirection-1d08c3793ff1

<blockquote>
 BlindOSCommandInjectionwithOutputRedirection
</blockquote>
<blockquote>
...
<blockquote>
Type: CWE-78: Improper Neutralization of Special Elements used in an OS Command ('OS Command Injection') CVSSv2.0 Base Score: 7.5; CVSSv3.x Base Score: 9.8; Vendor: Ubiquiti; Product: UniFi Security Gateway; Affected versions: v4.4.51 and below ... The POC targets the MIPS32 architecture and drops a root shell after sending a single IKE ...
</blockquote>
...
* https://www.youtube.com/watch?v=FjYZMcj30pw

<blockquote>
 OSCommandInjectionPOCBugBountyCambridgeYouTube
</blockquote>
<blockquote>
This video demonstrates a proof of concept for an OS command injection vulnerability that was fixed in a bug bounty program.
</blockquote>
...
* https://medium.com/@muzamail-ashraf/portswigger-os-command-injection-515a1a19748e

<blockquote>
 OScommandinjectionWriteupbyMuzamalAshrafMedium
</blockquote>
<blockquote>
Lab 2: Blind OS command injection with time delays. This lab contains a blind OS command injection vulnerability in the feedback function. The application executes a shell command containing the ...
</blockquote>
...
<blockquote>
Overview CVE: CVE-2015-3991 Type: CWE-78: Improper Neutralization of Special Elements used in an OS Command ('OS Command Injection') CVSSv2.0 Base Score: 7.5 CVSSv3.x Base Score: 9.8 Vendor: Ubiquiti Product: UniFi Security Gateway Affected versions: v4.4.51 and below Patched version: v4.4.52 Introduction Discovered by an independent security researcher in 2015, CVE-2015-3991 was ...
</blockquote>
...
<blockquote>
 AuthenticatedcommandinjectioninmultipleUbiquitiNetworksproducts
</blockquote>
<blockquote>
...
<blockquote>
 GitHubcommixprojectcommixAutomatedAllinOneOSCommand
</blockquote>
<blockquote>
...
* https://medium.com/@punamyaana08/os-command-injection-and-the-way-ive-solved-portswigger-lab-8b5146b83d84

<blockquote>
 OSCommandInjectionandthewayIvesolvedPortswiggerLab
</blockquote>
<blockquote>
How to prevent OS command injection OS command injection is a security vulnerability that occurs when an application allows an attacker to execute arbitrary commands on the host operating system.
</blockquote>
...
* https://cxsecurity.com/issue/WLB-2017030162

<blockquote>
 UbiquitiNetworksCommandInjectionCXSecuritycom
</blockquote>
<blockquote>
...
* https://jaypomal.medium.com/blind-os-command-injection-with-time-delays-43f6e11687ae

<blockquote>
 BlindOScommandinjectionwithTimeDelaysMedium
</blockquote>
<blockquote>
So what is blind OS command injection? well as i have already discussed about OS command injection in my previous blog, blind OS command injection works the same but instead of getting output back to web app in blind OS command injection we don't get output. So how do we know that our if there exists a blind OS command injection. well one technique is with time delay. An OS command that can ...
</blockquote>
...
<blockquote>
OS command injection is a vulnerability that enables an attacker to execute arbitrary operating system (OS) commands on the server that is running an application.
</blockquote>
...
* https://cvefeed.io/vuln/detail/CVE-2010-5330

<blockquote>
 CVE20105330UbiquitiAirOSCommandInjectionVulnerability
</blockquote>
<blockquote>
...
* https://medium.com/@DhruxMan/hola-hackers-im-dhruv-singh-a-cybersecurity-enthusiast-passionate-about-exploring-the-depths-834a9d140115

<blockquote>
 BlindOSCommandInjectionwithtimedelaysfMedium
</blockquote>
<blockquote>
This blog will walk you through an actual instance of Blind OS Command Injection with a time delay, detailing how it was discovered, tested, and confirmed through a Proof of Concept (POC).
</blockquote>
...
* https://securityvulnerability.io/vulnerability/CVE-2025-6102

<blockquote>
 OSCommandInjectionVulnerabilityinWifisoftUniBoxControllerCVE
</blockquote>
<blockquote>
Discover the OS Command Injection vulnerability affecting Wifi-soft UniBox Controller, highlighting the risks and available solutions.
</blockquote>

---

# GitHub search -> Ubiquiti poc OS Command injection
# KEV
