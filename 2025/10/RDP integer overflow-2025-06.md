## DuckDuckgo search -> RDP integer overflow
`2025-06-23`

* https://istrosec.com/blog/rdp/

<blockquote>
 RemoteDesktopProtocolvulnerabilitiesexploitationIstroSec
</blockquote>
<blockquote>
Heap buffer overflow Very similar vulnerability as the BlueKeep mentioned before. The CVE-2021-34535 also refers to Remote Desktop Services Remote Code Execution Vulnerability. The vulnerability is an integer overflow due to an attacker-controllable payload size field, which ultimately leads to a heap buffer overflow during memory allocation.
</blockquote>
...
* https://www.anvilogic.com/threat-reports/cve-2021-34535-remote-exec-vuln

<blockquote>
 CVE202134535RemoteCodeVulnerabilityinWindowsRDPAnvilogic
</blockquote>
<blockquote>
CVE-2021-34535 is a remote code execution vulnerability in the Windows Remote Desktop client due to an integer overflow. Learn how this vulnerability impacts systems and the patch provided by Microsoft.
</blockquote>
...
<blockquote>
CVE-2025-29966 affects the Remote Desktop Client. If a user connects to a malicious RDP server, the attacker can exploit this flaw to execute arbitrary code on the client system. CVE-2025-29967 affects the Remote Desktop Gateway Service, exposing systems to similar RCE risks when improperly secured endpoints interact with crafted requests.
</blockquote>
...
<blockquote>
CVE-2021-34535 is a remote code execution vulnerability in the Windows Remote Desktop client due to an integer overflow. Learn how this vulnerability impacts systems and the patch provided by Microsoft. ... The specific issue is an integer overflow in which Staggs says, &quot;specifying a buffer size just slightly below that upper limit, an integer ...
</blockquote>
...
* https://security.snyk.io/vuln/SNYK-ALPINE322-XRDP-10283909

<blockquote>
 IntegerOverfloworWraparoundinxrdpCVE202223484Snyk
</blockquote>
<blockquote>
...
* https://www.snort.org/rule_docs/1-57997

<blockquote>
 SnortRuleDocs
</blockquote>
<blockquote>
Alert Message OS-WINDOWS Microsoft Windows Remote Desktop client integer overflow attempt Rule Explanation This rule detects an attempt to exploit CVE-2021-34535 in Windows RDP . What To Look For This rule detects an attempt to exploit CVE-2021-34535 in Windows RDP .
</blockquote>
...
* https://westoahu.hawaii.edu/cyber/vulnerability-research/vulnerabilities-weekly-summaries/popular-rdp-client-vulnerabilities-allows-a-remote-system-to-be-compromised/

<blockquote>
 PopularRDPclientvulnerabilitiesallowsaremotesystemtobe
</blockquote>
<blockquote>
From Check Point Research: Integer-overflow found in bitmap updates in bmpdata variable From Check Point Research: the same vulnerability in rdesktop found in FreeRDP; CVE 2018-8787 Clipboard path traversal On the side of Microsoft, there is a feature that allows for a client to copy a file and paste it onto his/her desktop.
</blockquote>
...
* https://www.cve.news/cve-2024-32039/

<blockquote>
 CVE202432039CriticalVulnerabilityinFreeRDPAllowsInteger
</blockquote>
<blockquote>
In conclusion, CVE-2024-32039 is a critical vulnerability within the FreeRDP implementation of the Remote Desktop Protocol that can allow potential attackers to cause integer overflow and out-of-bounds writes.
</blockquote>
...
<blockquote>
 PDFHeSaidSheSaidPoisonedRDPOffenseandDefense
</blockquote>
<blockquote>
Figure 5: Integer-Overflow when processing bitmap updates. Although width and height are only 16 bits each, by multiplying them together with bits-per-pixel), we decompression will process our input and break on any decompression error, giving us a controllable heap-based buffer-overflow.
</blockquote>
...
<blockquote>
 IntegerOverflowleadingtoHeapOverflowinfreerdpbitmapplanar
</blockquote>
<blockquote>
Reallocation size (context-&gt;maxPlaneSize) is calculated by multiplying context-&gt;maxWidth, and context-&gt;maxHeight, and integer overflow is not considered in this calculation. Setting the multiplied value bigger than (1&lt;&lt;32) leads to integer overflow. This realloced buffer is used to store plane-buffers, so it finally leads to heap buffer ...
</blockquote>
...
* https://www.fortiguard.com/encyclopedia/ips/49340

<blockquote>
 IntrusionPreventionFortiGuardLabs
</blockquote>
<blockquote>
This indicates an attack attempt to exploit an Integer Overflow Vulnerability in Microsoft Remote Desktop Client.The vulnerability is caused by an ...
</blockquote>
...
<blockquote>
MS.Windows.RDP.Client.TSMF.Channel.Integer.Overflow Description This indicates an attack attempt to exploit an Integer Overflow Vulnerability in Microsoft Remote Desktop Client.
</blockquote>
...
<blockquote>
 DejaBlueAnalyzingaRDPHeapOverflowMarcusHutchins
</blockquote>
<blockquote>
The assumption here would be that if we can overflow v11, it'd cause the allocation to be smaller than the decompressed data, leading to a heap overflow. Some Reversing Required To get a better understanding of how to exploit the integer overflow, I needed to know what values I control and how to call the vulnerable function.
</blockquote>
...
* https://cvefeed.io/vuln/detail/CVE-2024-32039

<blockquote>
 CVE202432039FreeRDPIntegerOverflowandOutofBoundsWrite
</blockquote>
<blockquote>
FreeRDP is a free implementation of the Remote Desktop Protocol. FreeRDP based clients using a version of FreeRDP prior to 3.5.0 or 2.11.6 are vulnerable to integer overflow and out-of-bounds write. Versions 3.5.0 and 2.11.6 patch the issue. As a workaround, do not use `/gfx` options (e.g. deactivate with `/bpp:32` …
</blockquote>
...
* https://blog.thalium.re/posts/rdpegfx/

<blockquote>
 FuzzingRDPEGFXwithwhatthefuzz
</blockquote>
<blockquote>
Microsoft's Remote Desktop Protocol (RDP) client was fuzzed by various teams in the past few years, it thus seemed like a good target to try a recent snapshot fuzzer: what the fuzz (wtf) (of which we are only users). ... We cannot get an integer overflow for left and right in our RDP context as we can only pass 16 bits, ...
</blockquote>
...
<blockquote>
 RDPClientsExposedtoReverseRDPAttacksbyMajorProtocolIssues
</blockquote>
<blockquote>
CVE 2018-20177: rdesktop versions up to and including v1.8.3 contain an Integer Overflow that leads to a Heap-Based Buffer Overflow in function rdp_in_unistr() and results in a memory corruption ...
</blockquote>
...
<blockquote>
On February 5, 2019 researchers at Check Point Research disclosed 25 vulnerabilities in 3 popular Remote Desktop Protocol (RDP) clients: mstsc.exe, FreeRDP, and rdesktop. ... An Integer-underflow, similar to a Integer-overflow, occurs when a variable is smaller than the smallest allowable integer. To represent this value takes a lot of memory ...
</blockquote>
...
<blockquote>
Reallocation size (context-&gt;maxPlaneSize) is calculated by multiplying context-&gt;maxWidth, and context-&gt;maxHeight, and integer overflow is not considered in this calculation. Setting the multiplied value bigger than (1&lt;&lt;32) leads to integer overflow. This realloced buffer is used to store plane-buffers, so it finally leads to heap buffer overflow.
</blockquote>
...
<blockquote>
 PDFHeSaidSheSaidPoisonedRDPOffenseandDefenseBlackHatBriefings
</blockquote>
<blockquote>
Figure 6: Same Integer-Overflow when processing bitmap updates. Remote Code Execution -CVE 2018-8786 Figure 7: Integer-Truncation when processing bitmap updates. As can be seen in Figure 7, there is an Integer-Truncation when trying to calculate the required capacity for the bitmap updates array. Later, rectangle structs will be parsed
</blockquote>
...
<blockquote>
The Remote Desktop Protocol (RDP), also known as &quot;mstsc&quot; after the Microsoft built-in RDP client, is commonly used by technical users and IT staff to connect to / work on a remote computer. ... This leads to an Integer-Underflow when calculating &quot;pkglen&quot;, and to an additional Integer-Overflow when allocating &quot;xmalloc(pkglen + 1 ...
</blockquote>
...
<blockquote>
OS-WINDOWS Microsoft Windows Remote Desktop client integer overflow attempt. Rule Explanation. This rule detects an attempt to exploit CVE-2021-34535 in Windows RDP . What To Look For. This rule detects an attempt to exploit CVE-2021-34535 in Windows RDP . Known Usage. No public information. False Positives.
</blockquote>
...
* https://securityvulnerability.io/vulnerability/CVE-2024-32039

<blockquote>
 FreeRDPVulnerabilityIntegerOverflowandOutofBoundsWrite
</blockquote>
<blockquote>
The vulnerability affects FreeRDP, an open-source implementation of the Remote Desktop Protocol, specifically impacting clients running versions prior to 3.5.0 and 2.11.6. This issue arises from an integer overflow and an out-of-bounds write, which could potentially allow attackers to execute arbitrary code or disrupt service.
</blockquote>
...
<blockquote>
CVE-2024-32039 - Critical Vulnerability in FreeRDP Allows Integer Overflow and Out-Of-Bounds Write, Exploitation Details and Mitigation Steps. FreeRDP is a widely used open-source implementation of Microsoft's Remote Desktop Protocol (RDP), enabling users to remotely access other devices via RDP. Unfortunately, a critical vulnerability has been ...
</blockquote>
...
# GitHub search -> RDP integer overflow
# MortenSchenkb
