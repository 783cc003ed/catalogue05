...
<blockquote>
A PoC exploit for CVE-2024-3273 - D-Link Remote Code Execution RCE - K3ysTr0K3R/CVE-2024-3273-EXPLOIT. Skip to content. Navigation Menu Toggle navigation. Sign in ... It allows for command injection through manipulation of the system argument, posing a significant security risk. The exploit can be initiated remotely, making it particularly ...
</blockquote>
...
* https://www.ishack.org/topic/9725.html/

<blockquote>
 DLinkDIRCVE202325280DLinkDIR820RouterOSCommandInjection
</blockquote>
<blockquote>
OS Command injection vulnerability in D-Link DIR820LA1_FW105B03 allows attackers to escalate privileges to root via a crafted payload with the ping_addr parameter to ping.ccp. Solution(s) dlink-retire-device
</blockquote>
...
<blockquote>
 DLinkIPCamerasMultipleVulnerabilitiesHardwarewebappsExploit
</blockquote>
<blockquote>
D-Link IP Cameras - Multiple Vulnerabilities. ... The PoC was made by Martin Rocha with help of Juan Cotta from Core QA Team. ... *OS Command Injection* [CVE-2013-1599] A security issue located in '/var/www/cgi-bin/rtpd.cgi' allows an unauthenticated remote attacker to execute arbitrary commands through the camera's web interface. The OS ...
</blockquote>
...
<blockquote>
 DIR802OSCommandInjection混元霹雳手
</blockquote>
<blockquote>
D-LINK DIR-802 命令注入漏洞 ... 漏洞类型. CWE-78: Improper Neutralization of Special Elements used in an OS Command ('OS Command Injection') ... 共享的POC将打开端口8089上的telnet服务。 ...
</blockquote>
...
<blockquote>
D-Link DIR-820 Router OS Command Injection Vulnerability: 09/30/2024: 10/21/2024: The impacted product is end-of-life (EoL) and/or end-of-service (EoS). Users should discontinue utilization of the product. Weakness Enumeration. CWE-ID CWE Name Source; CWE-78: Improper Neutralization of Special Elements used in an OS Command ('OS Command Injection')
</blockquote>
...
<blockquote>
 CVE202325280OSCommandinjectionvulnerabilityinDLinkDIR820LA1
</blockquote>
<blockquote>
D-Link DIR-820 Router OS Command Injection Vulnerability CISA required action: The impacted product is end-of-life (EoL) and/or end-of-service (EoS). Users should discontinue utilization of the product. CISA description: D-Link DIR-820 routers contain an OS command injection vulnerability that allows a remote, unauthenticated attacker to ...
</blockquote>
...
* https://dailycve.com/d-link-dir-880l-command-injection-cve-2025-4341-critical/

<blockquote>
 DLinkDIR880LCommandInjectionCVE20254341Critical
</blockquote>
<blockquote>
D-Link DIR-880L, Command Injection, CVE-2025-4341 (Critical) - &quot;DailyCVE.com - The advanced vulnerability database with modern testing, patching tutorials, and up-to-date security insights.
</blockquote>
...
<blockquote>
 DLinkDWL2600APMultipleOSCommandInjection
</blockquote>
<blockquote>
...
<blockquote>
CVE-2024-10914 has a 32 public PoC/Exploit available at Github. Go to the Public Exploits tab to see the list.
</blockquote>
...
<blockquote>
A significant OS command injection vulnerability has been discovered in the D-Link DAR-7000, which could allow attackers to execute arbitrary commands on the host system.
</blockquote>
...
* https://sploitus.com/exploit?id=AF394C47-87C9-5F09-8E3D-FEDAFFDFFBB0

<blockquote>
 ExploitforOSCommandInjectioninDlinkDns320FirmwareCVE202410914
</blockquote>
<blockquote>
The manipulation of the argument name leads to os command injection. The attack can be launched remotely. The complexity of an attack is rather high. The exploitation appears to be difficult. The exploit has been disclosed to the public and may be used. &#35; Affected Devices - DNS-320 Version 1.00 - DNS-320LW Version 1.01.0914.2012
</blockquote>
...
<blockquote>
 DLINKCommandInjection1DLINKCommandinjectionmdatmainGitHub
</blockquote>
<blockquote>
Contribute to doudoudedi/D-LINK_Command_Injection1 development by creating an account on GitHub.
</blockquote>
...
* https://www.jaspreet.net/2024/12/01/2881/understanding-and-exploiting-cve-2024-10914-a-critical-vulnerability-in-d-link-nas-devices/

<blockquote>
 UnderstandingandExploitingCVE202410914ACriticalVulnerability
</blockquote>
<blockquote>
Introduction CVE-2024-10914 is a critical command injection vulnerability affecting legacy D-Link NAS devices. This flaw allows unauthenticated attackers to execute arbitrary commands remotely by exploiting improper input validation in the cgi_user_add endpoint. This blog post provides: Manual exploitation steps to understand the attack. A Python script to automate exploitation. Logs, examples ...
</blockquote>
...
* https://dev.to/verylazytech/poc-cve-2024-10914-command-injection-vulnerability-in-name-parameter-for-d-link-nas-4f8p
...
<blockquote>
TWCERTCC has published advisories for four more high-severity OS command injection vulnerabilities that impact the same D-Link device. The bugs are tracked as CVE-2024-11062 , CVE-2024-11063 , CVE ...
</blockquote>
...
* https://github.com/doudoudedi/D-LINK_Command_Injection1

<blockquote>
 doudoudediDLINKCommandInjection1GitHub
</blockquote>
<blockquote>
Router firmware such as D-Link dir-820l &quot;callback_ccp_mydlink_api&quot; function in ncc2 binary file for command injection, which can cause arbitrary command execution Detail There is a &quot;callback_ccp_mydlink_api&quot; function in the ncc2 binary file, as shown below in IDA，api_page parameter accepted Only need to use single quotes to close the ...
</blockquote>
...
<blockquote>
D-Link US recommends retiring and replacing D-Link devices that have reached EOL/EOS. Please get in touch with your regional office for recommendations (LINK). ... Command Injection: CWE-77. The vulnerability is localized to the account_mgr CGI script, particularly when handling the cgi_user_add command. ...
</blockquote>
...
* https://securityvulnerability.io/vulnerability/CVE-2025-5573

<blockquote>
 OSCommandInjectionVulnerabilityinDLinkDCS932LbyDLink
</blockquote>
<blockquote>
A vulnerability in the D-Link DCS-932L, specifically in the setSystemWizard and setSystemControl functions, allows an attacker to manipulate the AdminID argument, leading to OS command injection. This security flaw can be exploited remotely, presenting significant risks, particularly for devices that are no longer supported by the vendor.
</blockquote>
...
* https://tomorrowisnew.com/posts/hacking-the-dlink-dir-615-for-fun-and-no-profit-part-2-cve-2020-10215/

<blockquote>
 HackingthedlinkDIR615forfunandnoprofitPart2CVE202010215
</blockquote>
<blockquote>
So in this writeup, we found a os command injection and a reflected xss. After googling it, i found out that the os command injection is already a cve for dir-825. CVE-2020-10215, so we cant get a cve from it :sad: . The other bug, xss, cve.mitre.org dont accept xss except for stored xss on their cve so we cant get a cve from that too.
</blockquote>
...
<blockquote>
 AkamaiBlogCommandInjectiononaDLinkRouter
</blockquote>
<blockquote>
Command Injection on a D-Link Router. Written by. Assaf Vilmovski. February 09, 2021. ... In this example, the ping utility is in the OS and runs under a higher privileged account when compared to 'user'. This is a simple example of privilege escalation. In the same scenario, a malicious user would be able to implement a persistent backdoor ...
</blockquote>
...
* https://www.infosecmatter.com/metasploit-module-library/?mm=exploit/linux/upnp/dlink_upnp_msearch_exec

<blockquote>
 DLinkUnauthenticatedUPnPMSEARCHMulticastCommandInjection
</blockquote>
<blockquote>
Different D-Link Routers are vulnerable to OS command injection via UPnP Multicast requests. This module has been tested on DIR-300 and DIR-645 devices. Zachary Cutlip has initially reported the DIR-815 vulnerable. Probably there are other devices also affected. Module Ranking and Traits
</blockquote>
...
<blockquote>
Improper Neutralization of Special Elements used in an OS Command ('OS Command Injection') VulDB CWE-74: Improper Neutralization of Special Elements in Output Used by a Downstream Component ('Injection') VulDB
</blockquote>
...
<blockquote>
POC - CVE-2024-10914- Command Injection Vulnerability in `name` parameter for D-Link NAS , and Dark Web Informer - Cyber Threat Intelligence November 11, 2024 . 2:14 AM
</blockquote>
...
<blockquote>
 DLinkDSL3782SecAdvisoryOSCommandInjectionandStoredXSS
</blockquote>
<blockquote>
OS Command Injection. OS command injection (also known as shell injection) is a web security vulnerability that allows an attacker to execute arbitrary operating system (OS) commands on the server that is running an application, and it usually fully compromises the application and all its data. Discovery
</blockquote>
...
<blockquote>
POC - CVE-2024-10914- Command Injection Vulnerability in name parameter for D-Link NAS . Overview A vulnerability was found in D-Link DNS-320, DNS-320LW, DNS-325 and DNS-340L up to 20241028.
</blockquote>
...
<blockquote>
The manipulation of the argument name leads to os command injection. The attack can be launched remotely. ... D-Link DNS-320/320LW/325/340L OS Command Injection Vulnerability. Overview Public Exploits Newsroom ... A PoC exploit for CVE-2024-10914 - D-Link Remote Code Execution (RCE) Go
</blockquote>
...
<blockquote>
D-Link DWL-2600AP - Multiple OS Command Injection. CVE-2019-20499CVE-2019-20500CVE-2019-20501 . webapps exploit for Hardware platform ... D-Link DWL-2600AP - Multiple OS Command Injection EDB-ID: 46841 ... (PoC): &#61;&#61;&#61;&#61;&#61; The security vulnerability can be exploited by local authenticated attackers. there is no input validation on the POST Form ...
</blockquote>
...
<blockquote>
A significant OS command injection vulnerability has been discovered in the D-Link DAR-7000, which could allow attackers to execute arbitrary commands on the host system. This issue arises from improper validation of user-supplied input through the Backup_Server_commit.php file.
</blockquote>
...
<blockquote>
D-Link DIR-880L, Command Injection, CVE-2025-4341 (Critical) - &quot;DailyCVE.com - The advanced vulnerability database with modern testing, patching tutorials, and up-to-date security insights. ... An attacker can craft malicious HTTP requests containing OS commands in these headers, which are then executed with root privileges due to ...
</blockquote>
...
<blockquote>
与cve-2020-15893相似，在固件版本v-1.00b05之前的d-link dir-802 a1上发现了一个问题。默认情况下，端口1900上启用了通用即插即用（upnp）。攻击者可以通过将有效负载注入ssdp m-search发现数据包的&quot;搜索目标&quot;（st）字段来执行命令注入。 poc
</blockquote>
...
<blockquote>
A vulnerability impacting D-Link DNS-320, DNS-320LW, DNS-325, and DNS-340L allows remote OS command injection through cgi_user_add. CVE-2024-10914 highlights critical security risks associated with these products.
</blockquote>

---

# GitHub search -> D-Link poc OS Command injection
# TOP
...
<tr><td>Owner: <code>yashz0007</code></td>
    ...
    <td>Latest: <code>2025-10-07 14:59:47+05:30</code></td></tr>
<tr><td>Commits: <code>39</code></td>
    <td>Stargazers: <code>0</code></td>
    <td>Watchers: <code>0</code></td>
    <td>Forks: <code>0</code></td></tr>
</table>
Keywords: Microsoft remote code execution exploit, Microsoft remote code execution, Microsoft remote code execution poc
...
<tr><td>Commits: <code>257</code></td>
    <td>Stargazers: <code>13895</code></td>
    <td>Watchers: <code>13895</code></td>
    <td>Forks: <code>2423</code></td></tr>
</table>
...
<tr><td>Owner: <code>avU8989</code></td>
    ...
    <td>Latest: <code>2025-10-05 12:42:23+02:00</code></td></tr>
...
<tr><td>Owner: <code>imosudi</code></td>
    ...
    <td>Latest: <code>2025-09-26 01:00:04+02:00</code></td></tr>
<tr><td>Commits: <code>23</code></td>
    <td>Stargazers: <code>0</code></td>
    <td>Watchers: <code>0</code></td>
    <td>Forks: <code>0</code></td></tr>
...
<tr><td>Owner: <code>SnailSploit</code></td>
    ...
    <td>Latest: <code>2025-09-13 09:26:28+03:00</code></td></tr>
<tr><td>Commits: <code>1</code></td>
    <td>Stargazers: <code>0</code></td>
    <td>Watchers: <code>0</code></td>
    <td>Forks: <code>0</code></td></tr>
...
<tr><td>Commits: <code>120</code></td>
    <td>Stargazers: <code>3349</code></td>
    <td>Watchers: <code>3349</code></td>
...
<table><tr>
<tr><td>Owner: <code>Acorzo1983</code></td>
    <td>Language: <code>HTML</code></td>
    <td>Started: <code>2024-11-11 08:49:06+00:00</code></td>
    <td>Latest: <code>2024-11-14 12:52:11+01:00</code></td></tr>
<tr><td>Commits: <code>28</code></td>
...
# GitHub search -> D-Link poc OS Command injection
# incident-report-for-sql-injection-exercise-project

https://github.com/breatheco-de/incident-report-for-sql-injection-exercise-project
<blockquote>
<no description>
</blockquote>
...
<tr><td>Owner: <code>breatheco-de</code></td>
    <td>Language: <code>None</code></td>
    <td>Started: <code>2024-06-14 16:49:04+00:00</code></td>
    <td>Latest: <code>2024-11-05 16:38:39-05:00</code></td></tr>
<tr><td>Commits: <code>21</code></td>
    <td>Stargazers: <code>0</code></td>
    <td>Watchers: <code>0</code></td>
...
<tr><td>Commits: <code>111</code></td>
    <td>Stargazers: <code>2435</code></td>
    <td>Watchers: <code>2435</code></td>
...
Keywords: remote code execution vulnerability, remote code execution exploit, rce exploitation, remote code execution poc
...
<table><tr>
<tr><td>Owner: <code>dldygnl</code></td>
    <td>Language: <code>Python</code></td>
...
<tr><td>Commits: <code>33</code></td>
    <td>Stargazers: <code>3206</code></td>
    <td>Watchers: <code>3206</code></td>
...
<tr><td>Commits: <code>71</code></td>
    <td>Stargazers: <code>4275</code></td>
    <td>Watchers: <code>4275</code></td>
...
<table><tr>
<tr><td>Owner: <code>ShivamRai2003</code></td>
    <td>Language: <code>None</code></td>
    <td>Started: <code>2021-07-13 08:51:11+00:00</code></td>
    <td>Latest: <code>2021-07-13 14:29:10+05:30</code></td></tr>
<tr><td>Commits: <code>5</code></td>
...
https://github.com/abdullah-test/0days
<blockquote>
Vulnerabilities I Found
</blockquote>

<table><tr>
<tr><td>Owner: <code>abdullah-test</code></td>
    <td>Language: <code>None</code></td>
    <td>Started: <code>2015-09-22 04:06:33+00:00</code></td>
    <td>Latest: <code>2015-09-22 07:07:30+03:00</code></td></tr>
<tr><td>Commits: <code>17</code></td>
    <td>Stargazers: <code>0</code></td>
    <td>Watchers: <code>0</code></td>
    <td>Forks: <code>0</code></td></tr>
