...
* https://medium.com/@Arsenelupin12/command-injections-a-practical-guide-to-htb-academys-module-a219873f40c3

<blockquote>
 CommandInjectionsAPracticalGuidetoHTBAcademysModule
</blockquote>
<blockquote>
The app's IP input field is vulnerable to command chaining. Use a semicolon ( ; ) to terminate the ping command and append cat /flag.txt . 127.0.0.1; cat /flag.txt
</blockquote>
...
* https://www.securityspace.com/smysecure/catid.html?id=1.3.6.1.4.1.25623.1.0.145191

<blockquote>
 HuaweiHuaweiDataCommunicationCommandInjectionVulnerabilityin
</blockquote>
<blockquote>
Huawei Data Communication: Command Injection Vulnerability in Some Huawei Products (huawei-sa-20201111-02-injection);Some Huawei products have a command injection vulnerability. ... An attacker may exploit the vulnerability to cause command injection. Affected Software/OS: NIP6300 versions V500R001C30 V500R001C60
</blockquote>
...
* https://jvn.jp/en/jp/JVN41646618/index.html

<blockquote>
 JVN41646618HuaweiEchoLifeHG8045QvulnerabletoOScommandinjection
</blockquote>
<blockquote>
EchoLife HG8045Q provided by Huawei contains an OS command injection vulnerability. Products Affected. Hardware model: HG8045Q Software version: V300R016C00SPC110; ... When the command line interface is enabled, an administrator user may execute a certain set of OS commands on the device. Solution.
</blockquote>
...
<blockquote>
CVE-2022-32203 is a *command injection* vulnerability in certain Huawei terminal printer devices. It's officially referenced as HWPSIRT-2022-51773 by Huawei themselves. ... - Various Huawei terminal printers (model numbers and OS versions vary; consult Huawei's official alert for a full list).
</blockquote>
...
<blockquote>
CVE-2022-48616: Command Injection in OPS Script Assistant File Name. Introduction. Huawei uses a general network operating system called Versatile Routing Platform (VRP) for their enterprise-grade routers. ... is that that Huawei's VRP act as a guest OS which runs on top of the Host OS (Linux) and utilizes some of its functionalities. So the ...
</blockquote>
...
<blockquote>
 KöpHuaweiochtillbehörSmartenkeltochhållbart
</blockquote>
<blockquote>
Upptäck och köp tusentals produkter i begagnat eller nytt skick från välkända varumärken. Handla smart, enkelt och hållbart på Tradera - bra för både plånboken och planeten.
</blockquote>
...
* https://vuldb.com/?id.247509

<blockquote>
 CVE202248616HuaweiAR6000oscommandinjectionVulDB
</blockquote>
<blockquote>
A Huawei data communication product has a command injection vulnerability. Successful exploitation of this vulnerability may allow attackers to gain higher privileges. The weakness was shared 12/12/2023. The advisory is shared at wr3nchsr.github.io. This vulnerability is uniquely identified as CVE-2022-48616 since 12/12/2023. Neither technical ...
</blockquote>
...
* https://vuldb.com/?id.259618

<blockquote>
 HuaweiHarmonyOSEMUIAccountManagerModuleoscommandinjection
</blockquote>
<blockquote>
A vulnerability has been found in Huawei HarmonyOS and EMUI (affected version not known) and classified as problematic. This vulnerability affects some unknown functionality of the component AccountManager Module. The manipulation with an unknown input leads to a os command injection vulnerability. The CWE definition for the vulnerability is ...
</blockquote>
...
* https://www.cvedetails.com/cve/CVE-2022-48616/

<blockquote>
 CVE202248616AHuaweidatacommunicationproducthasacommand
</blockquote>
<blockquote>
CVE-2022-48616 : A Huawei data communication product has a command injection vulnerability. Successful exploitation of this vulnerability may allow attackers to gain h ... The product constructs all or part of an OS command using externally-influenced input from an upstream component, but it does not neutralize or incorrectly neutralizes ...
</blockquote>
...
* https://cyber.vumetric.com/vulns/CVE-2024-30414/os-command-injection-vulnerability-in-huawei-emui-and-harmonyos/

<blockquote>
 CVE202430414OSCommandInjectionvulnerabilityinHuaweiEmuiand
</blockquote>
<blockquote>
...
* https://www.huaweicomputers.com/en/huawei-desktop/os-command-injection-vulnerability-in-huawei-optical-network-terminal/

<blockquote>
 OScommandinjectionvulnerabilityinHuaweiopticalnetworkterminal
</blockquote>
<blockquote>
JPCERT Coordination Center (JPCERT / CC: Japan Computer Emergency Response Team Coordination Center) announced on August 17th, &quot;JVN &#35; 41466618: Huawei EchoLife HG8045Q OS Command Injection Vulnerability&quot;, Huawei's optical network terminal &quot;EchoLife HG8045Q&quot; I told you that there is a vulnerability in. Exploitation of this vulnerability could lead to the execution of some OS commands on a ...
</blockquote>
...
* https://cvefeed.io/vuln/detail/CVE-2020-9127

<blockquote>
 CVE20209127HuaweiCommandInjectionVulnerability
</blockquote>
<blockquote>
Some Huawei products have a command injection vulnerability. Due to insufficient input validation, an attacker with high privilege may inject some malicious codes in some files of the affected products. Successful exploit may cause command injection.Affected product versions include:NIP6300 versions V500R001C30,V500R001C60;NIP6600 versions V500R001C30,V500R001C60;Secospace USG6300 versions ...
</blockquote>
...
<blockquote>
A Huawei data communication product has a command injection vulnerability. Successful exploitation of this vulnerability may allow attackers to gain higher privileges. Metrics ... Improper Neutralization of Special Elements used in an OS Command ('OS Command Injection')
</blockquote>
...
* https://www.clouddefense.ai/cve/2022/CVE-2022-48616

<blockquote>
 CVE202248616HuaweiCommandInjectionVulnerabilityOverview
</blockquote>
<blockquote>
The vulnerability involves improper neutralization of special elements used in an OS command ('OS Command Injection') within Huawei data communication products. Affected Systems and Versions. The affected product is the Huawei AR6000, specifically versions: AR6000 V300R019C10SPC300, AR6000 V300R019C13SPC200, AR6000 V300R021C00SPC200, and AR6000 ...
</blockquote>
...
<blockquote>
 HuaweiHG532nCommandInjectionMetasploitHardwareremoteExploit
</blockquote>
<blockquote>
