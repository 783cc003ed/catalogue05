...
<blockquote>
I. Overview GitLab has officially disclosed a major remote code execution vulnerability in all GitLab CE/EE versions since version 13.2. Attackers who have not been authenticated can exploit this vulnerability to execute arbitrary code on servers. If you are a GitLab user, check your system and implement timely security hardening.
</blockquote>
...
<blockquote>
 PDFExploitationOfAModernSmartphoneBasebandBlackHatBriefings
</blockquote>
<blockquote>
3 Huawei Baseband Remote Code Execution: A Case Study In this section we will showcase the remote code execution vulnerability we exploited at Mobile Pwn2own 2017, gaining remote access to a fully updated Huawei device baseband.
</blockquote>
...
<blockquote>
Recent findings by security researcher Neil Mark Ochea reveal critical vulnerabilities in Huawei Mobile devices, including Remote Code Execution (RCE) and arbitrary file access exploits.
</blockquote>
