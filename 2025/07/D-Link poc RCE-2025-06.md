...
<blockquote>
 Cr0n1cdlinkshellpocDlink615815shellPoCGitHub
</blockquote>
<blockquote>
Contribute to Cr0n1c/dlink_shell_poc development by creating an account on GitHub. Dlink 615/815 shell PoC. Contribute to Cr0n1c/dlink_shell_poc development by creating an account on GitHub. ... [-h] [-p PASSWORD] -u URL [-x] D-Link Service.cgi RCE optional arguments: -h, --help show this help message and exit -p PASSWORD, --password PASSWORD ...
</blockquote>
...
* https://blog.csdn.net/KKleeeaa/article/details/137617625

<blockquote>
 漏洞复现DLink未授权RCE漏洞复现CVE20243273CSDN博客
</blockquote>
<blockquote>
文章浏览阅读1.3k次。本文揭示了D-LinkNAS设备中的命令执行漏洞，攻击者可通过硬编码帐户和系统参数注入执行命令。提供了POC示例，强调了未经授权访问可能导致的安全风险和用户责任。
</blockquote>
...
<blockquote>
 dlinkshellpocdlinkauthrceatmasterCr0n1cdlinkshellpocGitHub
</blockquote>
<blockquote>
...
* https://nic.seu.edu.cn/info/1055/2277.htm

<blockquote>
 关于DLinkNAS设备命令注入漏洞CVE20243273的安全预警东南大学网络与信息中心
</blockquote>
<blockquote>
关于 d-link nas 设备命令注入漏洞（ cve-2024-3273 ）的安全预警 一、 基本情况 多款 d-link 网络附加存储 (nas) 设备型号中存在硬编码帐户后门漏洞（ cve-2024-3272 ， cvss 评分 9.8 ）和命令注入漏洞（ cve-2024-3273 ， cvss 评分 7.3 ），目前这些漏洞的详情及 poc/exp 已公开，且已发现被利用。. 二、 漏洞描述
</blockquote>
...
<blockquote>
文章浏览阅读1.2k次。本文揭示了D-LinkNAS设备中的命令执行漏洞，攻击者可通过硬编码帐户和系统参数注入执行命令。提供了POC示例，强调了未经授权访问可能导致的安全风险和用户责任。
</blockquote>
...
<blockquote>
D-Link NAS 设备中发现一个关键漏洞（CVE-2024-10914），对全球 61,000 多个系统构成严重威胁。该漏洞是 `account_mgr.cgi` 脚本中的命令注入漏洞，允许远程攻击者通过特制的 HTTP GET 请求执行任意命令。此问题影响多个 D-Link NAS 型号，包括 DNS-320、DNS-320LW、DNS-325 和 DNS-340L，CVSSv4 得分为 9.2，表明严重程度较高。
</blockquote>
...
<blockquote>
Attackers with access to the HNAP port may be able to take over the D-Link EXO AX4800 (DIR-X4860) router entirely through remote, unauthenticated command execution. With speeds of up to 4800 Mbps and cutting-edge features like OFDMA, MU-MIMO, and BSS Coloring that improve efficiency and lessen interference, the D-Link DIR-X4860 router is a high ...
</blockquote>
...
<blockquote>
d-link dir-3040 libcli 命令注入漏洞(cve-2021-21819) d-link dir-3040 zebra ip 路由管理器信息泄露漏洞(cve-2021-21817) d-link dir-3040 服务组件使用默认密码（cve-2021-21818） d-link dir-3060 授权rce漏洞（cve-2021-28144） d-link dva-2800和dsl-2888a 身份验证绕过漏洞（cve-2020-27863） d-link dva-2800 和 ...
</blockquote>
...
<blockquote>
研究人员近期发布了针对 D-Link 路由器系列中的0day漏洞，攻击者可以利用该漏洞接管设备并以 root 权限执行命令。 根据 5 月 14 日发布的博客文章，SSD Secure Disclosure 的研究团队针对D-Link DIR-X4860路由器中HNAP登录请求处理相关的漏洞发布了相关PoC。
</blockquote>

---

# GitHub search -> D-Link poc RCE
# TOP
