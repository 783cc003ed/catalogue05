...
<blockquote>
In a previous blog post I had presented a creative method to resurrect a bricked device, in this post I will go over an authentication bypass vulnerability discovered within the running firmware. ... CVE-2021-32030: ASUS GT-AC2900 Authentication Bypass. May 6. Written By Chris Bellows.
</blockquote>
...
* https://broadbandbulletin.com/d/2466-asus-warns-of-critical-auth-bypass-flaw-in-routers-using-aicloud

<blockquote>
 ASUSwarnsofcriticalauthbypassflawinroutersusingAiCloud
</blockquote>
<blockquote>
ASUS warns of critical auth bypass flaw in routers using AiCloud. The vulnerability discovered in AiCloud impacts a broad range of models, with ASUS releasing fixes for multiple firmware branches, including 3.0.0.4_382 series, 3.0.0.4_386 series, 3.0.0.4_388 series, and 3.0.0.6_102 series.
</blockquote>
...
<blockquote>
ASUS warns of an authentication bypass flaw in routers that could allow unauthorized execution of functions on the device. ... Authentication bypass CVE-2025-22230 impacts VMware Windows Tools | Android malware campaigns use .NET MAUI to evade detection | Astral Foods, South Africa's largest poultry producer, lost over $1M due to a ...
</blockquote>
...
* https://cybersecurefox.com/en/asus-router-aicloud-authentication-bypass-vulnerability/

<blockquote>
 CriticalAuthenticationBypassVulnerabilityInASUSRoutersAiCloud
</blockquote>
<blockquote>
ASUS has released an urgent security patch addressing a severe authentication bypass vulnerability in their routers' AiCloud service. The security flaw, tracked as CVE-2025-2492, received a critical CVSS score of 9.2, highlighting its significant potential impact on network security.
</blockquote>
...
* https://capalearning.com/2025/05/05/asus-fixed-critical-auth-bypass-vulnerability-in-aicloud-routers/

<blockquote>
 ASUSFixedCriticalAuthBypassVulnerabilityInAiCloudRouters
</blockquote>
<blockquote>
Security Vulnerability Impacting ASUS Routers with AiCloud ASUS routers were found to have a critical security vulnerability that posed a risk to users' security. According to a recent advisory by ASUS, a critical authentication bypass vulnerability in routers with AiCloud enabled was patched.
</blockquote>
...
* https://github.com/advisories/GHSA-6c6m-p94j-g86j

<blockquote>
 CertainASUSroutermodelshaveauthenticationbypassGitHub
</blockquote>
<blockquote>
Certain ASUS router models have authentication bypass... Critical severity Unreviewed Published on Jun 13, 2024 to the GitHub Advisory Database • Updated on Jun 13, 2024
</blockquote>
...
<blockquote>
 AkeyAsusWindowstoolhasaworryingsecurityflawTechRadar
</blockquote>
<blockquote>
...
<blockquote>
 SevenASUSroutersimpactedbycriticalauthenticationbypassflaw
</blockquote>
<blockquote>
ASUS has issued a product security advisory warning customers to update the security firmware to address a critical vulnerability affecting seven of its router models. The vulnerability, CVE-2024-3080, is a critical authentication bypass flaw that allows remote attackers to take control of the device without authentication.
</blockquote>
...
* https://malwaretips.com/threads/asus-warns-of-critical-remote-authentication-bypass-on-7-routers.131587/

<blockquote>
 SecurityNewsASUSwarnsofcriticalremoteauthenticationbypasson
</blockquote>
<blockquote>
ASUS warns of critical remote authentication bypass on 7 routers ASUS has released a new firmware update that addresses a vulnerability impacting seven router models that allow remote attackers to log in to devices.
</blockquote>
...
<blockquote>
The flaw, tracked as CVE-2024-3080, is an authentication bypass vulnerability allowing unauthenticated, remote attackers to take control of the device. The flaw impacts multiple ASUS router models, but not all will be getting security updates due to them having reached their end-of-life.
</blockquote>
...
<blockquote>
ASUS routers with AiCloud vulnerable to auth bypass exploit U.S. CISA adds Apple products and Microsoft Windows NTLM flaws to its Known Exploited Vulnerabilities catalog Entertainment venue management firm Legends International disclosed a data breach
</blockquote>
...
* https://itsecuritynewsbox.com/index.php/2025/04/18/asus-routers-with-aicloud-vulnerable-to-auth-bypass-exploit/
...
<blockquote>
The administrator application on ASUS GT-AC2900 devices before 3...4.386.42643 and Lyra Mini before 3.0.0.4_384_46630 allows authentication bypass when processing remote input from an unauthenticated user, leading to unauthorized access to the administrator interface.
</blockquote>
...
<blockquote>
According to a recent advisory by ASUS, a critical authentication bypass vulnerability in routers with AiCloud enabled was patched. The vulnerability, identified as CVE-2025-2492, was rated with a CVSS score of 9.2. ASUS described the issue in their advisory, stating that the vulnerability stemmed from improper authentication control. An ...
</blockquote>
...
<blockquote>
Asus released a patch for CVE-2025-3464, a high-severity authentication bypass flaw The issue affects Armoury Crate, a centralized hub for managing ASUS and ROG hardware The flaw could possibly ...
</blockquote>

---

# GitHub search -> Asus Auth Bypass
