## DuckDuckgo search -> Active Directory RCE
`2025-06-23`

* https://learn.microsoft.com/en-us/services-hub/unified/health/getting-started-ad

<blockquote>
 GettingStartedwithActiveDirectoryOnDemandAssessment
</blockquote>
<blockquote>
The Active Directory Assessment provides you with an assessment of your Active Directory Environment with domain controllers running on-premises, on Azure VMs, or on Amazon Web Services (AWS) VMs.
</blockquote>
...
<blockquote>
 Top16ActiveDirectoryVulnerabilitiesInfosecMatter
</blockquote>
<blockquote>
But as any other similar technology, Active Directory is very complex and securing it requires significant effort and years of experience. This article provides practical information on how to pentest Active Directory environments using a list of 16 most common AD vulnerabilities and mis-configurations.
</blockquote>
...
<blockquote>
 NewVeeamRCEflawletsdomainusershackbackupserversBleepingComputer
</blockquote>
<blockquote>
Unfortunately, many companies have joined their backup servers to a Windows domain, ignoring Veeam's best practices, which advise admins to use a separate Active Directory Forest and protect the ...
</blockquote>
...
* https://dec-solutions.com/cve-2025-23120-microsoft-active-directory-rce-risk/

<blockquote>
 CVE202523120MicrosoftActiveDirectoryRCERisk
</blockquote>
<blockquote>
CVE-2025-23120: Microsoft Active Directory RCE Risk The cybersecurity landscape constantly evolves, bringing new threats to organizations worldwide. One significant concern is the recently discovered CVE-2025-23120, a remote code execution vulnerability in Microsoft Active Directory.
</blockquote>
...
<blockquote>
 ExploitingMicrosoftsActiveDirectorybyAleksaZatezalo
</blockquote>
<blockquote>
Active Directory (AD) is a database and set of services that provide users with access to the appropriate network resources they need to get their work done. The directory contains critical ...
</blockquote>
...
<blockquote>
Active Directory Exploitation Cheat Sheet This cheat sheet contains common enumeration and attack methods for Windows Active Directory. This cheat sheet is inspired by the PayloadAllTheThings repo.
</blockquote>
...
<blockquote>
Introduction In our previous article, we covered an engagement where it was necessary to execute the ESC7 attack to escalate privileges by abusing the Active Directory Certificate Services (AD CS).
</blockquote>
...
<blockquote>
On February 11, 2025, the Microsoft Security Response Center (MSRC) published details regarding a new vulnerability identified as CVE-2025-21376. This vulnerability, affecting the Windows Lightweight Directory Access Protocol (LDAP) implementation, poses a remote code execution (RCE) risk—a critical concern for enterprises and Windows users alike.
</blockquote>
...
<blockquote>
 CriticalWindowsLDAPflawcouldleadtocrashedserversRCEattacks
</blockquote>
<blockquote>
...
<blockquote>
The RCE vulnerability was assigned as CVE-2024-49112 and was given the CVSS severity score of 9.8 out of 10; the DOS vulnerability was assigned CVE-2024-49113. However, a public exploit or blogpost explaining the vulnerability or exploitation path was not published anywhere for either. ... Referrals allow an Active Directory tree to be ...
</blockquote>
...
* https://cybersrcc.com/2025/01/02/critical-vulnerability-in-windows-ldap-cve-2024-49112/

<blockquote>
 CriticalVulnerabilityinWindowsLDAPCVE202449112
</blockquote>
<blockquote>
On December 11, 2024, Microsoft disclosed a critical vulnerability in the Windows Lightweight Directory Access Protocol (LDAP), identified as CVE-2024-49112.This remote code execution (RCE) flaw carries a high CVSS score of 9.8 out of 10, marking it as a critical concern for enterprise environments, particularly those relying on Domain Controllers (DCs).
</blockquote>
...
<blockquote>
A critical Active Directory vulnerability, tracked as CVE-2024-49113, was recently patched by Microsoft, along with another severe flaw, CVE-2024-49112. CVE-2024-49113 was initially identified as a denial-of-service (DoS) attack vector, but further analysis revealed it could be exploited to remotely execute code (RCE) and crash multiple ...
</blockquote>
...
<blockquote>
This critical Windows Server vulnerability poses a significant threat to enterprise networks, especially those relying on Active Directory (AD) for authentication and management. The exploit enables Remote Code Execution (RCE) without authentication using weaknesses in Lightweight Directory Access Protocol (LDAP) communications.
</blockquote>
...
<blockquote>
 ActiveDirectoryFlawCanCrashAnyMicrosoftServer
</blockquote>
<blockquote>
This vulnerability, along with a similar remote control execution (RCE) bug, tracked as CVE-2024-49112, with a CVSS score of 9.8, was discovered in Active Directory's Lightweight Directory Access ...
</blockquote>
...
<blockquote>
 ExploitableCriticalRCEVulnerabilityTruesec
</blockquote>
<blockquote>
Exploitable Critical RCE Vulnerability Allows Regular Users to Fully Compromise Active Directory - PrintNightmare CVE-2021-1675 and CVE-2021-34527. Fabio Viggiani; 2021-06-30 ... In practice, this means that an attacker with a regular domain account can take over the entire Active Directory in a simple step. For example, if a user is ...
</blockquote>
...
<blockquote>
Active Directory Rights Management Services (AD RMS) is a software for information rights management. It uses encryption and a form of selective functionality denial to limit access to files.
</blockquote>
...
<blockquote>
LDAP is a critical protocol used to interact with directory services, such as Microsoft's Active Directory. It essentially underpins much of the authentication and network access control processes in enterprise environments. ... Remote code execution (RCE) vulnerabilities are among the most dangerous because they allow an attacker to run ...
</blockquote>
