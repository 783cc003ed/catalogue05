...
* https://cvefeed.io/vuln/detail/CVE-2024-3080

<blockquote>
 CVE20243080ASUSRouterAuthenticationBypassVulnerability
</blockquote>
<blockquote>
Certain ASUS router models have authentication bypass vulnerability, allowing unauthenticated remote attackers to log in the device. INFO Published Date : June 14, 2024, 3:15 a.m. Last Modified : Nov. 21, 2024, 9:28 a.m. Source : [email protected] Remotely Exploitable : Yes ! Impact Score : 5.9 ...
</blockquote>
...
<blockquote>
ASUS has released patches for a critical flaw in multiple router models that allows threat actors to remotely take control of the devices. The vulnerability, CVE-2024-3080, allows hackers to circumvent authentication procedures without any input from the end users.
</blockquote>
...
<blockquote>
This vulnerability allows malicious actors to bypass authentication mechanisms and gain unauthorized access to affected devices remotely. Understanding the Technical Impact Security researchers have identified a critical flaw in the AiCloud service's authentication management system.
</blockquote>
...
* https://wilayah.com.my/asus-urges-immediate-action-on-critical-authentication-bypass-flaw-in-aicloud-routers/

<blockquote>
 ASUSUrgesImmediateActiononCriticalAuthenticationBypassFlawin
</blockquote>
<blockquote>
KUALA LUMPUR, April 19, 2025 — ASUS has issued an urgent security advisory over a critical authentication bypass vulnerability affecting multiple router models equipped with the AiCloud feature. The flaw, designated CVE-2025-2492, allows remote attackers to execute functions on affected devices without requiring any authentication, posing a major risk to users. Rated critical with a CVSS v4 ...
</blockquote>
...
<blockquote>
 CVE20243080CertainASUSroutermodelshaveauthenticationbypass
</blockquote>
<blockquote>
...
<blockquote>
Anyway, we are publishing our PoC exploit code and the Qiling emulator script in our poc repository on GitHub. If you know about an (un)fixed authentication-bypass (😉) in Asus devices drop us a message on X (formerly Twitter) or BlueSky.
</blockquote>
...
* https://securityvulnerability.io/vulnerability/CVE-2025-2492

<blockquote>
 ImproperAuthenticationControlinAiCloudbyASUS
</blockquote>
<blockquote>
...
<blockquote>
ASUS warns of an authentication bypass flaw in routers that could allow unauthorized execution of functions on the device. ... Samsung MagicINFO flaw exploited days after PoC exploit publication | Experts warn of a second wave of attacks targeting SAP NetWeaver bug CVE-2025-31324 |
</blockquote>
...
<blockquote>
CVE-2024-3080 is a vulnerability found in certain ASUS router models that allows unauthorized access due to an authentication bypass issue. This flaw permits unauthenticated remote attackers to log into the device, which can lead to a range of security breaches.
</blockquote>
...
<blockquote>
Certain ASUS router models have authentication bypass... Critical severity Unreviewed Published Jun 14, 2024 to the GitHub Advisory Database • Updated Jun 14, 2024. Package. No package listed — Suggest a package. Affected versions. Unknown. Patched versions. Unknown ...
</blockquote>
...
# GitHub search -> Asus poc Auth Bypass
