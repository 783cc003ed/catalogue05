...
<blockquote>
Join this channel to get access to the perks:https://www.youtube.com/channel/UC9IAh1JN4lhSVz193GvZVZg/joinReferences:https://www.cobalt.io/blog/introduction-...
</blockquote>
...
<blockquote>
The GitHub PoC demonstrates successful exploitation by sending a specially crafted HTTP POST request to /goform/WifiExtraSet with an oversized mac parameter exceeding 128 bytes 3. Mitigation Strategies. Tenda has not released an official patch as of April 18, 2025. ... Critical Authentication Bypass in Seclore v3.27.5. (CVE-2024-53591)
</blockquote>
...
<blockquote>
Enterprise-Grade Advanced Security Tools for IAM, 2FA, and SSO. Free Trial - Free&lt;25 Users. Enhance security with OpenOTP's flexible and adaptive MFA solutions.
</blockquote>
...
<blockquote>
 TendaD301v2ModemRouterPersistentCrossSiteScripting
</blockquote>
<blockquote>
...
<blockquote>
Besides CVE-2021-20090, the threat actor is also said to have carried out attacks leveraging a number of other vulnerabilities, such as - CVE-2020-29557 (Pre-authentication remote code execution in D-Link DIR-825 R1 devices); CVE-2021-1497 and CVE-2021-1498 (Command injection vulnerabilities in Cisco HyperFlex HX); CVE-2021-31755 (Stack buffer overflow vulnerability in Tenda AC11 leading to ...
</blockquote>
...
* https://cvefeed.io/vuln/detail/CVE-2020-35391

<blockquote>
 CVE202035391TendaN300F3InformationDisclosure
</blockquote>
<blockquote>
CVE-2020-35391 has a 3 public PoC/Exploit available at Github. Go to the Public Exploits tab to see the list.
</blockquote>
...
<blockquote>
 AuthenticationBypassinTendaN300WirelessNVDSL2ModemRouter
</blockquote>
<blockquote>
...
<blockquote>
About Tenda N300 Authentication Bypass via Malformed HTTP Request Header
</blockquote>
...
<blockquote>
Subscribed 65 14K views 8 years ago Tenda Router Authentication Bypass POC References : ...more
</blockquote>
...
* https://cvefeed.io/vuln/detail/CVE-2024-30634

<blockquote>
 CVE202430634TendaF1202AuthenticationBypassStackOverflow
</blockquote>
<blockquote>
CVE-2024-30634 has a 2 public PoC/Exploit available at Github. Go to the Public Exploits tab to see the list.
</blockquote>
...
<blockquote>
The Tenda AC1200 V-W15Ev2 router is affected by improper authorization/improper session management. The software does not perform or incorrectly perform an authorization check when a user attempts to access a resource or perform an action.
</blockquote>
...
<blockquote>
A tool to bypass 2 factor authentication. one_fa_demo.mp4. Usage. Installation. python3 -m pip install onefactorauth. Setup. Go to https://receivesms.cc/sms/ and choose a phone number; Run 1fa config -p &lt;phone_number&gt; (ex: 1fa config -p 31616099881) Register the phone number under your account for 2 factor authentication;
</blockquote>
...
<blockquote>
Tenda N300 Authentication Bypass via Malformed HTTP Request Header - CVE-2020-35391-POC/README.md at main · dumitory-dev/CVE-2020-35391-POC
</blockquote>
...
<blockquote>
Tenda F1202 v1.2.0.20(408) has a stack overflow vulnerability via the mitInterface parameter in the fromAddressNat function. ... Tenda F1202 Authentication Bypass Stack Overflow Vulnerability. ... bugbountytips dlink exploitation exploitation-framework iot-platform poc tutorials vulnerability-detection. Updated: 3 weeks, 5 days ago . 11 stars 4 ...
</blockquote>

---

# GitHub search -> Tenda poc Authentication Bypass
