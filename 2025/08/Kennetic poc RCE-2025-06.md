...
* https://socradar.io/apache-tomcat-rce-cve-2025-24813-exploitation/

<blockquote>
 ApacheTomcatRCEVulnerabilityCVE202524813UnderActive
</blockquote>
<blockquote>
At its core, CVE-2025-24813 (CVSS 5.5) is an unauthenticated Remote Code Execution (RCE) vulnerability that abuses Tomcat's handling of PUT and GET requests. Vulnerability card of CVE-2025-24813 (SOCRadar Vulnerability Intelligence) ... was available. Shortly after disclosure, PoC exploits surfaced on GitHub, making it easier for attackers to ...
</blockquote>
...
<blockquote>
CVE-2025-20281 &amp; CVE-2025-20282: Maximum Severity Unauthenticated RCE Vulnerabilities in Cisco ISE and ISE-PIC. June 25, 2025. CVE-2025-5777: Critical Information Disclosure Vulnerability &quot;Citrix Bleed 2&quot; in Citrix NetScaler ADC and Gateway. ... (PoC) exploit. However, given the level of access these vulnerabilities provide and the ...
</blockquote>
...
* https://blog.csdn.net/Dalock/article/details/146425886

<blockquote>
 TomcatRCECVE202524813复现CSDN博客
</blockquote>
<blockquote>
也可以使用以下poc直接触发： GET / HTTP/1.1 Host: localhost:9000 Cookie: JSESSIONID&#61;.poc. 防御措施. 打补丁; 升级到无漏洞版本; Apache Tomcat RCE漏洞复现（CVE-2025-24813） - smileleooo - 博客园 【漏洞复现】Tomcat最新RCE漏洞CVE-2025-24813复现_哔哩哔哩_bilibili; 奇安信攻防社区-全网首发!
</blockquote>
...
<blockquote>
Theoretically, this functionality could be available to us via the XSS, and thus, we have a potential path to RCE. Once again, we would like to highlight that Kentico was a pleasure to work with and incredibly professional—as indicated in the speed at which Kentico has resolved issues highlighted to them. ... For the sake of a simple PoC, we ...
</blockquote>
...
* https://blog.csdn.net/2303_80022567/article/details/148773352

<blockquote>
 CVE202524813源码分析与漏洞复现Tomcat路径等效漏洞与反序列化RCECSDN博客
</blockquote>
<blockquote>
文章浏览阅读1k次，点赞27次，收藏16次。CVE-2025-24813为Tomcat高危漏洞（CVSS 9.8），影响9.0.0.M1至11.0.2版本。该漏洞组合了路径遍历和反序列化缺陷：在非默认配置下，攻击者可利用partial PUT请求将恶意文件（含反序列化payload）写入会话目录，触发RCE。漏洞需同时满足启用文件写入、会话持久化及存在反 ...
</blockquote>
...
<blockquote>
Apache OFBIZ Path traversal leading to RCE POC[CVE-2024-32113 &amp; CVE-2024-36104] apache poc rce cve ofbiz rce-exploit cve-2024 cve-2024-32113 cve-2024-36104. Updated Jun 3, 2024; ZephrFish / CVE-2024-4577-PHP-RCE. Sponsor Star 26. Code Issues Pull requests PHP RCE PoC for CVE-2024-4577 written in bash, go, python and a nuclei template ...
</blockquote>
...
<blockquote>
文章浏览阅读957次，点赞25次，收藏10次。CVE-2025-24813为Tomcat高危漏洞（CVSS 9.8），影响9.0.0.M1至11.0.2版本。该漏洞组合了路径遍历和反序列化缺陷：在非默认配置下，攻击者可利用partial PUT请求将恶意文件（含反序列化payload）写入会话目录，触发RCE。漏洞需同时满足启用文件写入、会话持久化及存在 ...
</blockquote>
...
<blockquote>
This PoC vulnerability could: Compromise your app, leaking user data. Let attackers run commands, turning servers into attack hubs. Trigger costly breaches or ransomware. The Nuclei PoC below proves how easy it is to test—and exploit. CVE-2025-24813 PoC could let hackers hijack your Tomcat server 4. Testing CVE-2025-24813: Nuclei PoC and ...
</blockquote>
...
<blockquote>
 POCBikehelmetsYourshopforBikehelmets
</blockquote>
<blockquote>
Great selection of the best outdoor brands. Get your POC Bike helmets now!
</blockquote>
...
<blockquote>
 3tternpCVE202321554GitHub
</blockquote>
<blockquote>
CVE-2023-21554 Windows MessageQueuing PoC， The sign of Poc success is the crash of the mqsvc.exe process, and there is no pop-up message, which needs to be seen in a process monitor-like program. Execute command in windows terminal or command prompt **python poc.py ** Enter IP address of the victim PC and hit enter
</blockquote>
...
<blockquote>
 JakobTheDevcve202432002pocrceGitHub
</blockquote>
<blockquote>
The name of the submodule (&quot;rce/notexists&quot;) matters, it wil come into play when placing our hook in the submodule. &quot;rce&quot; must match the last segment of the Submodule's path. &quot;notexists&quot; must match the name of the directory containing hooks/post-checkout in the submodule directory. See cve-2024-32002-poc-rce.
</blockquote>
...
<blockquote>
Alarmingly, a Proof of Concept (PoC) exploit has already been published online, accelerating the urgency for organizations to respond. - Advertisement - Zero-Click Attack Vector. Unlike traditional RCE exploits that require users to click on malicious links or open infected files, CVE-2025-21298 operates without direct user action. ...
</blockquote>
...
<blockquote>
 CVE202532756FortinetRCEPoCGitHub
</blockquote>
<blockquote>
CVE-2025-32756: Fortinet RCE PoC. A proof-of-concept for the critical stack-based buffer overflow vulnerability (CVE-2025-32756) affecting Fortinet products. Vulnerability. ... (PoC) is designed for educational and security research purposes only. Please note the following:
</blockquote>
...
<blockquote>
 KineticocomKineticoWaterSystems
</blockquote>
<blockquote>
...
<blockquote>
 Roundcube1610PostAuthRCEviaPHPObjectYouTube
</blockquote>
<blockquote>
Roundcube ≤ 1.6.10 Post-Auth RCE via PHP Object Deserialization.There may be some confusion, as MITRE, for some reason, published a second CVE-2025-49113 for...
</blockquote>
...
<blockquote>
Kinetic Universe is NOT hosting an after party this year, but Halvorsen Park WILL be open for spectators to come view the carnage. Day 2 - May 25th, 2025: Sculptures enter the water at the Wharfinger Boat Ramp in Eureka between 9:53am and 11:53pm and exit under the Samoa Bridge. Day 3 - May 26th, 2025:
</blockquote>
...
<blockquote>
⚠️ Critical RCE in Ingress-NGINX via Configuration Injection (CVE-2025-1974 and more) This repository contains a proof-of-concept (PoC) exploit for CVE-2025-1974, a Critical (CVSS 9.8) vulnerability in the Ingress-NGINX controller for Kubernetes.This flaw allows unauthenticated remote code execution via unsafe configuration injection when using the Validating Admission Controller.
</blockquote>
...
* https://securityonline.info/critical-versa-director-flaw-rce-possible-via-ha-ports-poc-available/

<blockquote>
 CriticalVersaDirectorFlawRCEPossibleviaHAPortsPoCAvailable
</blockquote>
<blockquote>
...
<blockquote>
 n1sh1thCVEPOCThisiscollectionoflatestCVEPOCsGitHub
</blockquote>
<blockquote>
Contribute to n1sh1th/CVE-POC development by creating an account on GitHub. This is collection of latest CVE POCs. . Contribute to n1sh1th/CVE-POC development by creating an account on GitHub. ... CVE-2021-42342 - RCE in GoAhead 4.x and 5.x before 5.1.5 Mr-xn/CVE-2021-42342; CVE-2021-43798. CVE-2021-43798 - Path traversal vulnerability in ...
</blockquote>
...
<blockquote>
Spring4Shell-POC (CVE-2022-22965) Spring4Shell (CVE-2022-22965) Proof Of Concept/Information + A vulnerable Tomcat server with a vulnerable spring4shell application. Early this morning, multiple sources has informed of a possible RCE exploit in the popular java framework spring.
</blockquote>
...
<blockquote>
渗透测试有关的POC、EXP、脚本、提权、小工具等---About penetration-testing python-script poc getshell csrf xss cms php-getshell domainmod-xss csrf-webshell cobub-razor cve rce sql sql-poc poc-exp bypass oa-getshell cve-cms ... poc rce cve exp vulnerability-scanner redteam getshell poc-bomber. Updated Jun 9, 2023; Python; gquere ...
</blockquote>
...
<blockquote>
 KineticEnergyPhysicsBookgatechedu
</blockquote>
<blockquote>
Kinetic energy does not have a direction and is a scalar value. It is not a vector quantity but is rather a magnitude. Kinetic energy can be also be transferred into other types of energy, such as potential energy or chemical energy. In order to gain kinetic energy, a force must be applied, which causes work to be done on an object.
</blockquote>
...
<blockquote>
 VeeamPatchesCVE202523121CriticalRCEBugRated99CVSSinBackup
</blockquote>
<blockquote>
&quot;A vulnerability allowing remote code execution (RCE) on the Backup Server by an authenticated domain user,&quot; the company said in an advisory. CVE-2025-23121 impacts all earlier version 12 builds, including 12.3.1.1139. It has been addressed in version 12.3.2 (build 12.3.2.3617). Security researchers at CODE WHITE GmbH and watchTowr have been ...
</blockquote>
...
<blockquote>
This Gist provides a Proof-of-Concept (POC) for CVE-2023-41892, a Craft CMS vulnerability that allows Remote Code Execution (RCE). Overview CVE-2023-41892 is a security vulnerability discovered in Craft CMS, a popular content management system.
</blockquote>
...
<blockquote>
An issue was discovered in Kentico before 12.0.15. Due to a failure to validate security headers, it was possible for a specially crafted request to the staging service to bypass the initial authentication and proceed to deserialize user-controlled .NET object input.
</blockquote>
...
<blockquote>
 smgorelikWindowsRCEexploitsGitHub
</blockquote>
<blockquote>
The exploit samples database is a repository for RCE (remote code execution) exploits and Proof-of-Concepts for WINDOWS, the samples are uploaded for education purposes for red and blue teams. Proof of Concepts are alwayes idetified by &#35;PoC&#35; in the name of the relevant exploit folder, and those ...
</blockquote>
...
Keywords: remote code execution vulnerability, rce vulnerability, remote code execution exploit, remote code execution poc, remote code execution exploitation
...
<table><tr>
<tr><td>Owner: <code>B4l3rI0n</code></td>
    <td>Language: <code>Python</code></td>
...
Keywords: zero-day vulnerability, path traversal vulnerability, 0day vulnerability, zero-day exploit, 0day exploit
...
https://github.com/Lay0us/Poc_Exp
<blockquote>
...
<table><tr>
<tr><td>Owner: <code>s4eio</code></td>
    <td>Language: <code>HTML</code></td>
