...
* https://cvefeed.io/vuln/detail/CVE-2018-7949

<blockquote>
 CVE20187949HuaweiiBMCAuthBypassPrivilegeEscalationVulnerability
</blockquote>
<blockquote>
...
<blockquote>
 Huaweidg8045AuthenticationBypassCXSecuritycom
</blockquote>
<blockquote>
...
<blockquote>
 HuaweiSA2025032501PCen
</blockquote>
<blockquote>
Huawei PCs have a vulnerability that allows low-privilege users to bypass SDDL permission checks. Successful exploitation this vulnerability could lead to termination of some system processes.(Vulnerability ID:HWPSIRT-2023-15366) This vulnerability has been assigned a (CVE)ID:CVE-2023-52972
</blockquote>
...
<blockquote>
Deploying Wireless MAC Address and Portal Authentication Bypass In wireless Portal authentication or multi-mode authentication including Portal authentication, VLAN authorization before authentication or upon an authentication failure is not supported.
</blockquote>
...
<blockquote>
On the Wireless Authentication tab page, click in the row where dumb resides. Scroll the page to the bottom, set Bypass policy, and click OK. Modify the bypass policy for other authentication profiles by referring to this example.
</blockquote>
...
<blockquote>
Configure a bypass policy.Configure a default permit rule.Cancel the device authentication configuration with one click.Set Access permission after an identity authentication failure to Not send response packets in an authentication rule (PAP or CHAP). Configure a bypass policy. Configure a default permit rule.
</blockquote>
...
* https://vulners.com/vulnerlab/VULNERABLE:2010

<blockquote>
 HuaweiFlyboxB660RouterAuthBypassVulnerability
</blockquote>
<blockquote>
...
<blockquote>
This guide explains MAC Address Bypass Authentication configuration for Huawei switches, including mechanisms, procedures, and examples for user access and authentication.
</blockquote>
...
* https://nwpc-ch.org/exploits/huawei-dg8045-authentication-bypass-packet-storm

<blockquote>
 HuaweiDG8045AuthenticationBypassPacketStorm
</blockquote>
<blockquote>
Roger Wilco Exploits 24 juin 2021 Affichages : 411 &#35; Title: Huawei dg8045 - Authentication Bypass &#35; Date: 2020-06-24 &#35; Author: Abdalrahman Gamal &#35; Vendor Homepage: www.huawei.com &#35; Version: dg8045 &#35; Hardware Version: VER.A &#35;POC: The default password of this router is the last 8 characters of the
</blockquote>
...
* https://www.huaweicloud.com/intl/en-us/notice/20220525184036758.html

<blockquote>
 SpringSecurityAuthorizationBypassVulnerabilityCVE202222978
</blockquote>
<blockquote>
Applications using RegexRequestMatcher with a dot (.) in the regular expression allow attackers to construct malicious data packets to bypass identity authentication. Currently, the details and POC of this vulnerability have been disclosed and the risk is high.
</blockquote>
...
<blockquote>
Bypass solution. Wired authentication bypass through the local device. Configure a bypass policy. Configure a default permit rule. Set Access permission after an identity authentication failure to Not send response packets in an authentication rule (PAP or CHAP). Bypass through the controller. Configure bypass for an AD/LDAP data source.
</blockquote>
...
* https://www.huaweicloud.com/intl/en-us/notice/20241030155518080.html

<blockquote>
 ApacheSolrAuthenticationBypassVulnerabilityCVE202445216
</blockquote>
<blockquote>
This vulnerability allows attackers to bypass authentication by appending a fake path to the end of a Solr API URL, potentially exposing sensitive data or enabling malicious operations. The POC has been disclosed and the risk is high. Apache Solr is a scalable, deployable, storage-optimized, and text-centric full-text search platform.
</blockquote>
...
* https://pwnwiki.com/pwn_wiki/archives/11691.html

<blockquote>
 Huawei华为dg8045身份验证绕过漏洞PwnWiki
</blockquote>
<blockquote>
POC &#35; Title: Huawei dg8045 - Authentication Bypass &#35; Date: 2020-06-24 &#35; Author: Abdalrahman Gamal &#35; Vendor Homepage: www.huawei.com &#35; Version: dg8045 &#35; Hardware Version: VER.A &#35;POC: The default password of this router is the last 8 characters of the device's serial number which exist in the back of the device.
</blockquote>
...
<blockquote>
When iMaster NCE-Campus is faulty or a device fails to communicate with iMaster NCE-Campus due to a network fault, users cannot be authenticated and do not have any network access rights. Authentication bypass can resolve this problem. With authentication bypass enabled, if a device detects a communication failure with iMaster NCE-Campus, it grants specific network access rights to users ...
</blockquote>
...
<blockquote>
High severity remote auth bypass in Huawei Flybox B660 3g/4g router. Get Ai insights Show more. Code. Copy. ... (PoC): &#61;&#61;&#61;&#61;&#61; The vulnerability can be exploited by remote attackers without privileged user account or user interaction. For security demonstration or to reproduce the vulnerability follow the provided information and steps below to ...
</blockquote>

---

# GitHub search -> Huawei poc Auth Bypass
