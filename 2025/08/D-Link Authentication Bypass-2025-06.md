...
<blockquote>
- CVE-2020-27865: ZDI-CAN-10894: uhttpd Authentication Bypass Remote Code Execution Vulnerability - Affects DAP-1860 Hardware Revision Ax using firmware v1.04b03 &amp; Below - Authentication on device is a broken, if the request contains the string `unauth.cgi` or `securityquestions.cgi`, authentication is bypassed, allowing remote unauthenticated
</blockquote>
...
<blockquote>
D-Link Routers - Authentication Bypass (2) EDB-ID: 11101 ... Multiple D-­Link routers suffer from insecure implementations of the Home Network Administration Protocol which allow un­authenticated and/or un­privileged users to view and configure administrative settings on the router.
</blockquote>
...
* https://pentest-tools.com/vulnerabilities-exploits/d-link-dir-600m-authentication-bypass_2208

<blockquote>
 DLinkDIR600MAuthenticationBypassCVE201913101
</blockquote>
<blockquote>
An attacker can bypass authentication and gain unauthorized access to the router's settings, potentially leading to further compromise of the network. ... D-Link DIR-600M - Authentication Bypass CVE-2019-13101. Severity. Critical (9.8) Vulnerability description Not available N/A. Risk description Not available N/A ...
</blockquote>
...
<blockquote>
Overview The cyber realm is facing a new challenge as the vulnerability identified as CVE-2025-44083 has just been discovered. This security flaw affects the D-Link DI-8100 16.07.26A1 and allows a remote attacker to bypass the administrator login authentication. The vulnerability is particularly critical due to its potential to allow unauthorized access to sensitive data and
</blockquote>
...
* https://advisories.checkpoint.com/defense/advisories/public/2025/cpai-2025-0415.html

<blockquote>
 CPAI20250415CheckPointSoftware
</blockquote>
<blockquote>
In the IPS tab, click Protections and find the D-Link DI-7003G Authentication Bypass (CVE-2025-4755) protection using the Search tool and Edit the protection's settings. Install policy on all Security Gateways. This protection's log will contain the following information: Attack Name: Application Servers Protection Violation.
</blockquote>
...
<blockquote>
The vulnerability in D-Link network devices arises from an authentication bypass flaw that can be exploited through capture-replay attacks. This issue allows unauthorized access to sensitive data, thereby compromising the integrity and confidentiality of the affected systems.
</blockquote>
...
<blockquote>
Learn about the authentication bypass vulnerability in D-Link DI-8100 router that allows unauthorized access. CVE-2025-44083. ... A security issue in the D-Link DI-8100 Router version 16.07.26A1 allows a remote attacker to bypass the administrator login, potentially leading to unauthorized access to the router's settings and controls. ...
</blockquote>
...
* https://www.clouddefense.ai/cve/2020/CVE-2020-8863

<blockquote>
 CVE20208863DLinkRouterAuthenticationBypassVulnerability
</blockquote>
<blockquote>
A vulnerability in D-Link routers allows network-adjacent attackers to bypass authentication, potentially leading to privilege escalation and code execution. Understanding CVE-2020-8863. This CVE involves a flaw in the authentication mechanism of certain D-Link routers, enabling attackers to exploit the issue without requiring authentication.
</blockquote>
...
<blockquote>
It is possible to bypass the WPA authentication of the D-Link DIR-850L wlan router. An attacker can join the network without the required credentials. The D-Link DIR-850 wlan router will communicate to client that have not completed full a WPA handshake. The client can communicate with the router with IP packets on Data Frames without encryption.
</blockquote>
...
<blockquote>
An issue in D-Link DI-8100 16.07.26A1 allows a remote attacker to bypass administrator login authentication CVE ID, Product, Vendor ... Defualt (light mode) Dark Auto (system defualt)
</blockquote>
...
* https://supportannouncement.us.dlink.com/announcement/publication.aspx?name=SAP10115

<blockquote>
 DLinkTechnicalSupport
</blockquote>
<blockquote>
Overview . In April 30, 2019, D-Link becamea aware of a 3rd Party security researcher that accused the DIR-600m Hardware Rev. Cx of a Authentication bypass and Cross-Site Scripting (XSS) security vulnerabilities in the web-GUI.
</blockquote>
...
<blockquote>
D-Link DIR-600 - Authentication Bypass. CVE-2017-12943 . webapps exploit for Hardware platform Exploit Database Exploits. GHDB. Papers. Shellcodes. Search EDB. ... D-Link DIR-600 Rev Bx devices with v2.x firmware allow remote attackers to read passwords via a model/__show_info.php?REQUIRE_FILE&#61; absolute path traversal attack, as demonstrated by ...
</blockquote>

---

# GitHub search -> D-Link Authentication Bypass
