# DuckDuckgo search -> 0_click_poc_RCE
`2024-10-17`
...
<blockquote>
This script presents a proof of concept (PoC) for CVE-2024-21413, a significant security vulnerability discovered in Microsoft Outlook with a CVSS of 9.8. ... Confirmed and managed 0-click NTLM Leak (thanks to JT!) Not yet published [18. February 2024] - Added 1-click RCE. Managed &amp; confirmed Microsoft Outlook Remote Code Execution (RCE) Not ...
</blockquote>
...
<blockquote>
Windows 10 Version 1809 &lt; 10..17763.6293. Windows Server 2019 &lt; 10..17763.6293. Windows Server 2019 (Server Core installation) &lt; 10..17763.6293. ... PoC Exploit for Zero-Click Vulnerability Made Available to the Masses. The exploit can be accessed on GitHub and makes it easier for the flaw to be exploited by threat actors.
</blockquote>
...
* https://vulns.leetcybersecurity.com/2024/08/20/windows-remote-desktop-licensing-service-madlicense-0-clickrce-affecting-all-windows-servers-2000-2025-cve-2024-38077/

<blockquote>
CVE-2024-38077, also known as &quot;MadLicense,&quot; is a critical 0-click remote code execution (RCE) vulnerability in the Windows Remote Desktop Licensing Service (RDL). It affects all versions of ... Exploitable PoC Released for CVE-2024-38077: 0-Click RCE Threatens All Windows Servers (securityonline.info) August 12, 2024 Advisory: Windows ...
</blockquote>
...
<blockquote>
The result is a terrifying attack vector for getting RCE through opening malicious docx files (without using macros). Here are the steps to build a Proof-of-Concept docx: Open Word (used up-to-date 2019 Pro, 16..10386.20017), create a dummy document, insert an (OLE) object (as a Bitmap Image), save it in docx.
</blockquote>
...
<blockquote>
He writes that a 0-click RCE has been published for CVE-2024-38077, which threatens all Windows server systems that are not patched. Advertising Security Online has taken up the matter in this blog post after three security researchers managed to create code for a proof-of-concept (PoC) exploit for the critical vulnerability CVE-2024-38077 ...
</blockquote>
...
<blockquote>
We will not give technical explanations in detail now, nor will give a full POC. ... how a preauth RCE exploitation of CVE-2024-38077 on Windows Server 2025 can bypass all modern mitigations to achieve 0-click RCE on the latest Windows Server. Yes, you heard me right, just by leveraging one vulnerability, you can achieve this without any user ...
</blockquote>
...
* https://threatnote.com/infosec-news/from-cyber-security-news-poc-released-for-0-click-rce-flaw-impacting-windows-server-madlicense/

<blockquote>
From Cyber Security News - PoC Released for 0-click RCE Flaw Impacting Windows Server - MadLicense Posted by August 9, 2024 No Comments [[{&quot;value&quot;:&quot;PoC exploit released for critical 0-click remote code execution (RCE) vulnerability affecting Windows Server. This flaw impacts Windows Server versions from 2000 to the latest 2025 preview.
</blockquote>
